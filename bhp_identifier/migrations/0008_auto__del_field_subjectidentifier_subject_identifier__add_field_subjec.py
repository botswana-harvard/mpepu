...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubjectIdentifier.subject_identifier'
        db.rename_column('bhp_identifier_subjectidentifier', 'subject_identifier', 'identifier')

        # Adding field 'SubjectIdentifier.padding'
        db.add_column('bhp_identifier_subjectidentifier', 'padding',
