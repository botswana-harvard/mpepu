...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('bhp_lab_core_receive', 'datetime_drawn', 'drawn_datetime')

    def backwards(self, orm):
        
        db.rename_column('bhp_lab_core_receive', 'drawn_datetime', 'datetime_drawn')
    ...
    models = {
        ...
        'lab_receive.receive': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_research_protocol.Protocol']"}),
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 15, 9, 3, 24, 928009)', 'db_index': 'True'}),
