...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Receive.receive_condition'
        db.add_column('bhp_lab_core_receive', 'receive_condition', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'Receive.dmis_panel_name'
        db.add_column('bhp_lab_core_receive', 'dmis_panel_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Receive.receive_condition'
        db.delete_column('bhp_lab_core_receive', 'receive_condition')

        # Deleting field 'Receive.dmis_panel_name'
        db.delete_column('bhp_lab_core_receive', 'dmis_panel_name')
    ...
    models = {
        ...
        'lab_receive.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 6, 8, 26, 6, 183565)', 'db_index': 'True'}),
