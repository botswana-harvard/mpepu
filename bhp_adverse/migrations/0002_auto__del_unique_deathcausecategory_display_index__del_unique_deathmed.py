...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'AdverseEventStudyRelation', fields ['display_index']
        db.delete_unique('bhp_adverse_adverseeventstudyrelation', ['display_index'])

        # Removing unique constraint on 'AdverseEventReportType', fields ['display_index']
        db.delete_unique('bhp_adverse_adverseeventreporttype', ['display_index'])

        # Removing unique constraint on 'DeathReasonHospitalized', fields ['display_index']
        db.delete_unique('bhp_adverse_deathreasonhospitalized', ['display_index'])

        # Removing unique constraint on 'Ae010AdverseStudyRel', fields ['display_index']
        db.delete_unique('bhp_adverse_ae010adversestudyrel', ['display_index'])

        # Removing unique constraint on 'DeathCauseInfo', fields ['display_index']
        db.delete_unique('bhp_adverse_deathcauseinfo', ['display_index'])

        # Removing unique constraint on 'Ae010ReportType', fields ['display_index']
        db.delete_unique('bhp_adverse_ae010reporttype', ['display_index'])

        # Removing unique constraint on 'DeathMedicalResponsibility', fields ['display_index']
        db.delete_unique('bhp_adverse_deathmedicalresponsibility', ['display_index'])

        # Removing unique constraint on 'DeathCauseCategory', fields ['display_index']
        db.delete_unique('bhp_adverse_deathcausecategory', ['display_index'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'DeathCauseCategory', fields ['display_index']
        db.create_unique('bhp_adverse_deathcausecategory', ['display_index'])

        # Adding unique constraint on 'DeathMedicalResponsibility', fields ['display_index']
        db.create_unique('bhp_adverse_deathmedicalresponsibility', ['display_index'])

        # Adding unique constraint on 'Ae010ReportType', fields ['display_index']
        db.create_unique('bhp_adverse_ae010reporttype', ['display_index'])

        # Adding unique constraint on 'DeathCauseInfo', fields ['display_index']
        db.create_unique('bhp_adverse_deathcauseinfo', ['display_index'])

        # Adding unique constraint on 'Ae010AdverseStudyRel', fields ['display_index']
        db.create_unique('bhp_adverse_ae010adversestudyrel', ['display_index'])

        # Adding unique constraint on 'DeathReasonHospitalized', fields ['display_index']
        db.create_unique('bhp_adverse_deathreasonhospitalized', ['display_index'])

        # Adding unique constraint on 'AdverseEventReportType', fields ['display_index']
        db.create_unique('bhp_adverse_adverseeventreporttype', ['display_index'])

        # Adding unique constraint on 'AdverseEventStudyRelation', fields ['display_index']
        db.create_unique('bhp_adverse_adverseeventstudyrelation', ['display_index'])
