...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestLabel.identifier'
        db.alter_column('lab_barcode_testlabel', 'identifier', self.gf('django.db.models.fields.CharField')(default='1', max_length=50))


    def backwards(self, orm):
        
        # Changing field 'TestLabel.identifier'
        db.alter_column('lab_barcode_testlabel', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
