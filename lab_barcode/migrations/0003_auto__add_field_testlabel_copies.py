...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestLabel.copies'
        db.add_column('lab_barcode_testlabel', 'copies', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TestLabel.copies'
        db.delete_column('lab_barcode_testlabel', 'copies')
