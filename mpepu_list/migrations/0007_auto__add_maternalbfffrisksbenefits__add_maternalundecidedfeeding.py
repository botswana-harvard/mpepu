...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MaternalBfFfRisksBenefits'
        db.create_table('mpepu_list_maternalbfffrisksbenefits', (
        ...
        db.send_create_signal('mpepu_list', ['MaternalBfFfRisksBenefits'])

        # Adding model 'MaternalUndecidedFeeding'
        db.create_table('mpepu_list_maternalundecidedfeeding', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('mpepu_list', ['MaternalUndecidedFeeding'])


    def backwards(self, orm):
        # Deleting model 'MaternalBfFfRisksBenefits'
        db.delete_table('mpepu_list_maternalbfffrisksbenefits')

        # Deleting model 'MaternalUndecidedFeeding'
        db.delete_table('mpepu_list_maternalundecidedfeeding')
