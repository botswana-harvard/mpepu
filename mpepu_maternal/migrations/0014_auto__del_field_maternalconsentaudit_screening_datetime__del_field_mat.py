...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MaternalConsentAudit.screening_datetime'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'screening_datetime')

        # Deleting field 'MaternalConsentAudit.registration_datetime'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'registration_datetime')

        # Deleting field 'MaternalConsentAudit.registration_status'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'registration_status')

        # Deleting field 'MaternalConsentAudit.randomization_datetime'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'randomization_datetime')

        # Adding field 'MaternalConsentAudit.confirm_identity'
        db.add_column('mpepu_maternal_maternalconsent_audit', 'confirm_identity',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True),
                      keep_default=False)


        # Changing field 'MaternalConsentAudit.subject_type'
        db.alter_column('mpepu_maternal_maternalconsent_audit', 'subject_type', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'MaternalLocatorAudit.mail_address'
        db.alter_column('mpepu_maternal_maternallocator_audit', 'mail_address', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
        # Deleting field 'MaternalConsent.screening_datetime'
        db.delete_column('mpepu_maternal_maternalconsent', 'screening_datetime')

        # Deleting field 'MaternalConsent.registration_datetime'
        db.delete_column('mpepu_maternal_maternalconsent', 'registration_datetime')

        # Deleting field 'MaternalConsent.registration_status'
        db.delete_column('mpepu_maternal_maternalconsent', 'registration_status')

        # Deleting field 'MaternalConsent.randomization_datetime'
        db.delete_column('mpepu_maternal_maternalconsent', 'randomization_datetime')

        # Adding field 'MaternalConsent.confirm_identity'
        db.add_column('mpepu_maternal_maternalconsent', 'confirm_identity',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True),
                      keep_default=False)


        # Changing field 'MaternalConsent.subject_type'
        db.alter_column('mpepu_maternal_maternalconsent', 'subject_type', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'MaternalLocator.mail_address'
        db.alter_column('mpepu_maternal_maternallocator', 'mail_address', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'confirm_identity')


        # Changing field 'MaternalConsentAudit.subject_type'
        db.alter_column('mpepu_maternal_maternalconsent_audit', 'subject_type', self.gf('django.db.models.fields.CharField')(max_length=25))

        # User chose to not deal with backwards NULL issues for 'MaternalLocatorAudit.mail_address'
        raise RuntimeError("Cannot reverse this migration. 'MaternalLocatorAudit.mail_address' and its values cannot be restored.")
        ...
        db.delete_column('mpepu_maternal_maternalconsent', 'confirm_identity')


        # Changing field 'MaternalConsent.subject_type'
        db.alter_column('mpepu_maternal_maternalconsent', 'subject_type', self.gf('django.db.models.fields.CharField')(max_length=25))

        # User chose to not deal with backwards NULL issues for 'MaternalLocator.mail_address'
        raise RuntimeError("Cannot reverse this migration. 'MaternalLocator.mail_address' and its values cannot be restored.")
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 7, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 7, 0, 0)'}),
