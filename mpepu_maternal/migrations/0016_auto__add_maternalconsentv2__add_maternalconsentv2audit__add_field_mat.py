...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaternalLocatorAudit.registered_subject'
        db.add_column('mpepu_maternal_maternallocator_audit', 'registered_subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_maternallocator', null=True, to=orm['bhp_registration.RegisteredSubject']),
                      keep_default=False)

        # Adding field 'MaternalLocator.registered_subject'
        db.add_column('mpepu_maternal_maternallocator', 'registered_subject',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MaternalLocatorAudit.registered_subject'
        db.delete_column('mpepu_maternal_maternallocator_audit', 'registered_subject_id')

        # Deleting field 'MaternalLocator.registered_subject'
        db.delete_column('mpepu_maternal_maternallocator', 'registered_subject_id')
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 18, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 0, 0)'}),
