...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mpepu_maternal_maternalpostreg', 'registered_subject_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bhp_registration.RegisteredSubject'], unique=True))

        # Adding unique constraint on 'MaternalPostReg', fields ['registered_subject']
        db.create_unique('mpepu_maternal_maternalpostreg', ['registered_subject_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MaternalPostReg', fields ['registered_subject']
        db.delete_unique('mpepu_maternal_maternalpostreg', ['registered_subject_id'])

        # Changing field 'MaternalPostReg.registered_subject'
        db.alter_column('mpepu_maternal_maternalpostreg', 'registered_subject_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_registration.RegisteredSubject']))
