...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mpepu_maternal_maternallocator_audit', 'contact_physical_address', self.gf('django.db.models.fields.TextField')(max_length=350, null=True))

        # Changing field 'MaternalLocatorAudit.physical_address'
        db.alter_column('mpepu_maternal_maternallocator_audit', 'physical_address', self.gf('django.db.models.fields.TextField')(max_length=350, null=True))

        # Adding field 'MaternalLabDelAudit.has_ga'
        db.add_column('mpepu_maternal_maternallabdel_audit', 'has_ga', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'MaternalLabDelAudit.ga'
        db.add_column('mpepu_maternal_maternallabdel_audit', 'ga', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'MaternalLocator.contact_physical_address'
        db.alter_column('mpepu_maternal_maternallocator', 'contact_physical_address', self.gf('django.db.models.fields.TextField')(max_length=350, null=True))

        # Changing field 'MaternalLocator.physical_address'
        db.alter_column('mpepu_maternal_maternallocator', 'physical_address', self.gf('django.db.models.fields.TextField')(max_length=350, null=True))

        # Adding field 'MaternalLabDel.has_ga'
        db.add_column('mpepu_maternal_maternallabdel', 'has_ga', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'MaternalLabDel.ga'
        db.add_column('mpepu_maternal_maternallabdel', 'ga', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MaternalLocatorAudit.contact_physical_address'
        raise RuntimeError("Cannot reverse this migration. 'MaternalLocatorAudit.contact_physical_address' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MaternalLocatorAudit.physical_address'
        raise RuntimeError("Cannot reverse this migration. 'MaternalLocatorAudit.physical_address' and its values cannot be restored.")

        # Deleting field 'MaternalLabDelAudit.has_ga'
        db.delete_column('mpepu_maternal_maternallabdel_audit', 'has_ga')

        # Deleting field 'MaternalLabDelAudit.ga'
        db.delete_column('mpepu_maternal_maternallabdel_audit', 'ga')

        # User chose to not deal with backwards NULL issues for 'MaternalLocator.contact_physical_address'
        raise RuntimeError("Cannot reverse this migration. 'MaternalLocator.contact_physical_address' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MaternalLocator.physical_address'
        raise RuntimeError("Cannot reverse this migration. 'MaternalLocator.physical_address' and its values cannot be restored.")

        # Deleting field 'MaternalLabDel.has_ga'
        db.delete_column('mpepu_maternal_maternallabdel', 'has_ga')

        # Deleting field 'MaternalLabDel.ga'
        db.delete_column('mpepu_maternal_maternallabdel', 'ga')
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 2, 21)'}),
