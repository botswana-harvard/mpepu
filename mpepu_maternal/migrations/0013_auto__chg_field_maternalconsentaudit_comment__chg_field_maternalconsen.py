...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MaternalConsentAudit.comment'
        db.alter_column('mpepu_maternal_maternalconsent_audit', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'MaternalConsent.comment'
        db.alter_column('mpepu_maternal_maternalconsent', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'MaternalConsentAudit.comment'
        db.alter_column('mpepu_maternal_maternalconsent_audit', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'MaternalConsent.comment'
        db.alter_column('mpepu_maternal_maternalconsent', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 14, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 14, 0, 0)'}),
