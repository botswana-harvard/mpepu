...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'MaternalConsentV2Audit'
        db.delete_table('mpepu_maternal_maternalconsentv2_audit')

        # Deleting model 'MaternalConsentV2'
        db.delete_table('mpepu_maternal_maternalconsentv2')

        # Adding model 'MaternalConsentUpdate'
        db.create_table('mpepu_maternal_maternalconsentupdate', (
            ...
            ('consent_version', self.gf('django.db.models.fields.IntegerField')()),
            ('maternal_consent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_maternal.MaternalConsent'])),
        ))
        db.send_create_signal('mpepu_maternal', ['MaternalConsentUpdate'])

        # Adding unique constraint on 'MaternalConsentUpdate', fields ['maternal_consent', 'consent_version']
        db.create_unique('mpepu_maternal_maternalconsentupdate', ['maternal_consent_id', 'consent_version'])

        # Adding unique constraint on 'MaternalConsentUpdate', fields ['maternal_consent', 'consent_datetime']
        db.create_unique('mpepu_maternal_maternalconsentupdate', ['maternal_consent_id', 'consent_datetime'])

        # Adding field 'MaternalConsentAudit.consent_version_on_entry'
        db.add_column('mpepu_maternal_maternalconsent_audit', 'consent_version_on_entry',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'MaternalConsentAudit.consent_version_recent'
        db.add_column('mpepu_maternal_maternalconsent_audit', 'consent_version_recent',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'MaternalConsentAudit.is_incarcerated'
        db.add_column('mpepu_maternal_maternalconsent_audit', 'is_incarcerated',
                      self.gf('django.db.models.fields.CharField')(default='No', max_length=3),
                      keep_default=False)

        # Adding field 'MaternalConsent.consent_version_on_entry'
        db.add_column('mpepu_maternal_maternalconsent', 'consent_version_on_entry',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'MaternalConsent.consent_version_recent'
        db.add_column('mpepu_maternal_maternalconsent', 'consent_version_recent',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'MaternalConsent.is_incarcerated'
        db.add_column('mpepu_maternal_maternalconsent', 'is_incarcerated',
                      self.gf('django.db.models.fields.CharField')(default='No', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'MaternalConsentUpdate', fields ['maternal_consent', 'consent_datetime']
        db.delete_unique('mpepu_maternal_maternalconsentupdate', ['maternal_consent_id', 'consent_datetime'])

        # Removing unique constraint on 'MaternalConsentUpdate', fields ['maternal_consent', 'consent_version']
        db.delete_unique('mpepu_maternal_maternalconsentupdate', ['maternal_consent_id', 'consent_version'])

        # Adding model 'MaternalConsentV2Audit'
        db.create_table('mpepu_maternal_maternalconsentv2_audit', (
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ...
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('study_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_maternalconsentv2', to=orm['bhp_variables.StudySite'])),
        ...
        db.send_create_signal('mpepu_maternal', ['MaternalConsentV2Audit'])

        # Adding model 'MaternalConsentV2'
        db.create_table('mpepu_maternal_maternalconsentv2', (
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('confirm_identity', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True)),
            ('hostname_created', self.gf('django.db.models.fields.CharField')(default='melissa', max_length=50, blank=True, db_index=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True)),
        ...
        db.send_create_signal('mpepu_maternal', ['MaternalConsentV2'])

        # Deleting model 'MaternalConsentUpdate'
        db.delete_table('mpepu_maternal_maternalconsentupdate')

        # Deleting field 'MaternalConsentAudit.consent_version_on_entry'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'consent_version_on_entry')

        # Deleting field 'MaternalConsentAudit.consent_version_recent'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'consent_version_recent')

        # Deleting field 'MaternalConsentAudit.is_incarcerated'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'is_incarcerated')

        # Deleting field 'MaternalConsent.consent_version_on_entry'
        db.delete_column('mpepu_maternal_maternalconsent', 'consent_version_on_entry')

        # Deleting field 'MaternalConsent.consent_version_recent'
        db.delete_column('mpepu_maternal_maternalconsent', 'consent_version_recent')

        # Deleting field 'MaternalConsent.is_incarcerated'
        db.delete_column('mpepu_maternal_maternalconsent', 'is_incarcerated')
    ...
    models = {
        ...
        'mpepu_maternal.maternalconsentupdate': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'consent_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'consent_version': ('django.db.models.fields.IntegerField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'guardian_name': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)'}),
