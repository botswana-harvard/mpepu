...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('bhp_content_type_map', ['ContentTypeMap'])

        # Adding unique constraint on 'ContentTypeMap', fields ['app_label', 'model']
        db.create_unique('bhp_common_contenttypemap', ['app_label', 'model'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ContentTypeMap', fields ['app_label', 'model']
        db.delete_unique('bhp_common_contenttypemap', ['app_label', 'model'])
