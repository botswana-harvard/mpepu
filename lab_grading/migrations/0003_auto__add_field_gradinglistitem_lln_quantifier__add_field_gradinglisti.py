...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lab_grading_gradinglistitem', 'lln_quantifier',
                      self.gf('django.db.models.fields.CharField')(default='>=', max_length=10),
                      keep_default=False)

        # Adding field 'GradingListItem.uln_quantifier'
        db.add_column('lab_grading_gradinglistitem', 'uln_quantifier',
                      self.gf('django.db.models.fields.CharField')(default='<=', max_length=10),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lab_grading_gradinglistitem', 'lln_quantifier')

        # Deleting field 'GradingListItem.uln_quantifier'
        db.delete_column('lab_grading_gradinglistitem', 'uln_quantifier')
