...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResultItemAudit._audit_subject_identifier'
        db.add_column('bhp_lab_core_resultitem_audit', '_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Adding field 'ResultItemAudit.grade_range'
        db.add_column('bhp_lab_core_resultitem_audit', 'grade_range', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'ResultItemAudit.grade_flag'
        db.add_column('bhp_lab_core_resultitem_audit', 'grade_flag', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'ResultItemAudit.reference_flag'
        db.add_column('bhp_lab_core_resultitem_audit', 'reference_flag', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'ResultItemAudit.reference_range'
        db.add_column('bhp_lab_core_resultitem_audit', 'reference_range', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'ResultItem.grade_range'
        db.add_column('bhp_lab_core_resultitem', 'grade_range', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'ResultItem.grade_flag'
        db.add_column('bhp_lab_core_resultitem', 'grade_flag', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'ResultItem.reference_flag'
        db.add_column('bhp_lab_core_resultitem', 'reference_flag', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'ResultItem.reference_range'
        db.add_column('bhp_lab_core_resultitem', 'reference_range', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResultItemAudit._audit_subject_identifier'
        db.delete_column('bhp_lab_core_resultitem_audit', '_audit_subject_identifier')

        # Deleting field 'ResultItemAudit.grade_range'
        db.delete_column('bhp_lab_core_resultitem_audit', 'grade_range')

        # Deleting field 'ResultItemAudit.grade_flag'
        db.delete_column('bhp_lab_core_resultitem_audit', 'grade_flag')

        # Deleting field 'ResultItemAudit.reference_flag'
        db.delete_column('bhp_lab_core_resultitem_audit', 'reference_flag')

        # Deleting field 'ResultItemAudit.reference_range'
        db.delete_column('bhp_lab_core_resultitem_audit', 'reference_range')

        # Deleting field 'ResultItem.grade_range'
        db.delete_column('bhp_lab_core_resultitem', 'grade_range')

        # Deleting field 'ResultItem.grade_flag'
        db.delete_column('bhp_lab_core_resultitem', 'grade_flag')

        # Deleting field 'ResultItem.reference_flag'
        db.delete_column('bhp_lab_core_resultitem', 'reference_flag')

        # Deleting field 'ResultItem.reference_range'
        db.delete_column('bhp_lab_core_resultitem', 'reference_range')
    ...
    models = {
        ...
        'lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 9, 8, 1, 26, 500176)'}),
        ...
        'lab_receive.receive': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_research_protocol.Protocol']"}),
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 9, 8, 1, 26, 478844)', 'db_index': 'True'}),
