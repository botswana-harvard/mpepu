...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bhp_lab_core_resultitem', 'receive_identifier')

        # Deleting field 'ResultItem.import_datetime'
        db.delete_column('bhp_lab_core_resultitem', 'import_datetime')
