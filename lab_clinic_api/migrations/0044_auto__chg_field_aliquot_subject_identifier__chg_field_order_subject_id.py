...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lab_clinic_api_aliquot', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Order.subject_identifier'
        db.alter_column('lab_clinic_api_order', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Result.subject_identifier'
        db.alter_column('lab_clinic_api_result', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ResultItem.subject_identifier'
        db.alter_column('lab_clinic_api_resultitem', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Aliquot.subject_identifier'
        db.alter_column('lab_clinic_api_aliquot', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Order.subject_identifier'
        db.alter_column('lab_clinic_api_order', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Result.subject_identifier'
        db.alter_column('lab_clinic_api_result', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ResultItem.subject_identifier'
        db.alter_column('lab_clinic_api_resultitem', 'subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 0, 0)', 'db_index': 'True'}),
