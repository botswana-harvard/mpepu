...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Receive.registered_subject'
        db.alter_column('lab_clinic_api_receive', 'registered_subject_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_registration.RegisteredSubject'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Receive.registered_subject'
        raise RuntimeError("Cannot reverse this migration. 'Receive.registered_subject' and its values cannot be restored.")
