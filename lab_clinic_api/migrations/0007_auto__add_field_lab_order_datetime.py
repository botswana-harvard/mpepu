...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lab.order_datetime'
        db.add_column('lab_clinic_api_lab', 'order_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lab.order_datetime'
        db.delete_column('lab_clinic_api_lab', 'order_datetime')
