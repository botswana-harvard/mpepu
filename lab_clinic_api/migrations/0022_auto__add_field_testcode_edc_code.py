...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCode.edc_code'
        db.add_column('lab_clinic_api_testcode', 'edc_code',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCode.edc_code'
        db.delete_column('lab_clinic_api_testcode', 'edc_code')
