...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lab.condition'
        db.alter_column('lab_clinic_api_lab', 'condition', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))


    def backwards(self, orm):
        
        # Changing field 'Lab.condition'
        db.alter_column('lab_clinic_api_lab', 'condition', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
