...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('lab_clinic_api_aliquot', 'parent_identifier_id')


    def backwards(self, orm):
        # Adding field 'Aliquot.parent_identifier'
        db.add_column('lab_clinic_api_aliquot', 'parent_identifier',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.Aliquot'], to_field='aliquot_identifier', null=True, blank=True),
                      keep_default=False)
