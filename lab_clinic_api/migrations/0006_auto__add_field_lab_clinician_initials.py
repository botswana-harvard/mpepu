...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lab.clinician_initials'
        db.add_column('lab_clinic_api_lab', 'clinician_initials', self.gf('django.db.models.fields.CharField')(default='XX', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lab.clinician_initials'
        db.delete_column('lab_clinic_api_lab', 'clinician_initials')
