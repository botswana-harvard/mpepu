...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lab_clinic_api_testcodegroup', (
        ...
        db.send_create_signal('lab_clinic_api', ['TestCodeGroup'])

        # Adding field 'TestCode.test_code_group'
        db.add_column('lab_clinic_api_testcode', 'test_code_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.TestCodeGroup'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TestCodeGroup'
        db.delete_table('lab_clinic_api_testcodegroup')

        # Deleting field 'TestCode.test_code_group'
        db.delete_column('lab_clinic_api_testcode', 'test_code_group_id')
