...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.title'
        db.alter_column('lab_clinic_api_review', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        db.create_table('lab_clinic_api_lab', (
            ...
            ('result_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ...
            ('order_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('protocol_identifier', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('order_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('condition', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ...
        # Changing field 'Review.title'
        db.alter_column('lab_clinic_api_review', 'title', self.gf('django.db.models.fields.CharField')(max_length=25))
