...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.comment'
        db.add_column('lab_clinic_api_review', 'comment', self.gf('django.db.models.fields.TextField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Review.clinician_initials'
        db.add_column('lab_clinic_api_review', 'clinician_initials', self.gf('django.db.models.fields.CharField')(default='XX', max_length=3), keep_default=False)

        # Adding field 'Lab.protocol_identifier'
        db.add_column('lab_clinic_api_lab', 'protocol_identifier', self.gf('django.db.models.fields.CharField')(default=0, max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.comment'
        db.delete_column('lab_clinic_api_review', 'comment')

        # Deleting field 'Review.clinician_initials'
        db.delete_column('lab_clinic_api_review', 'clinician_initials')

        # Deleting field 'Lab.protocol_identifier'
        db.delete_column('lab_clinic_api_lab', 'protocol_identifier')
