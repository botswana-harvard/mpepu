...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('lab_clinic_api_resultitem', ['result_item_datetime', 'subject_identifier', 'grade_flag'], unique=False)
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)', 'db_index': 'True'}),
