...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lab_clinic_api_panel_aliquot_type', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panel', models.ForeignKey(orm['lab_clinic_api.panel'], null=False)),
            ('aliquottype', models.ForeignKey(orm['lab_clinic_api.aliquottype'], null=False))
        ))
        db.create_unique('lab_clinic_api_panel_aliquot_type', ['panel_id', 'aliquottype_id'])


    def backwards(self, orm):
        # Removing M2M table for field aliquot_type on 'Panel'
        db.delete_table('lab_clinic_api_panel_aliquot_type')
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 29, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 29, 0, 0)', 'db_index': 'True'}),
