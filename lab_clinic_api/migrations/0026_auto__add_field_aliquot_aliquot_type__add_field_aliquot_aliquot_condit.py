...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aliquot.aliquot_type'
        db.add_column('lab_clinic_api_aliquot', 'aliquot_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.AliquotType'], null=True),
                      keep_default=False)

        # Adding field 'Aliquot.aliquot_condition'
        db.add_column('lab_clinic_api_aliquot', 'aliquot_condition',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.AliquotCondition'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aliquot.aliquot_type'
        db.delete_column('lab_clinic_api_aliquot', 'aliquot_type_id')

        # Deleting field 'Aliquot.aliquot_condition'
        db.delete_column('lab_clinic_api_aliquot', 'aliquot_condition_id')
