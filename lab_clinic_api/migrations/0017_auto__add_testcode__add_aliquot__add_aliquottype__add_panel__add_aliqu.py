...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lab_clinic_api_testcode', (
        ...
        db.send_create_signal('lab_clinic_api', ['TestCode'])

        # Adding model 'Aliquot'
        db.create_table('lab_clinic_api_aliquot', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('aliquot_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 8, 0, 0))),
            ('count', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('parent_identifier', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.Aliquot'], to_field='aliquot_identifier', null=True, blank=True)),
            ...
            ('receive', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.Receive'])),
        ))
        db.send_create_signal('lab_clinic_api', ['Aliquot'])

        # Adding model 'AliquotType'
        db.create_table('lab_clinic_api_aliquottype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('lab_clinic_api', ['AliquotType'])

        # Adding model 'Panel'
        db.create_table('lab_clinic_api_panel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('lab_clinic_api', ['Panel'])

        # Adding model 'AliquotCondition'
        db.create_table('lab_clinic_api_aliquotcondition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('lab_clinic_api', ['AliquotCondition'])

        # Adding model 'Order'
        db.create_table('lab_clinic_api_order', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('aliquot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.Aliquot'])),
            ('panel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.Panel'])),
        ))
        db.send_create_signal('lab_clinic_api', ['Order'])

        # Deleting field 'Result.lab'
        db.delete_column('lab_clinic_api_result', 'lab_id')

        # Adding field 'Result.order'
        db.add_column('lab_clinic_api_result', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['lab_clinic_api.Order']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TestCode'
        db.delete_table('lab_clinic_api_testcode')

        # Deleting model 'Aliquot'
        db.delete_table('lab_clinic_api_aliquot')

        # Deleting model 'AliquotType'
        db.delete_table('lab_clinic_api_aliquottype')

        # Deleting model 'Panel'
        db.delete_table('lab_clinic_api_panel')

        # Deleting model 'AliquotCondition'
        db.delete_table('lab_clinic_api_aliquotcondition')

        # Deleting model 'Order'
        db.delete_table('lab_clinic_api_order')


        # User chose to not deal with backwards NULL issues for 'Result.lab'
        raise RuntimeError("Cannot reverse this migration. 'Result.lab' and its values cannot be restored.")
        # Deleting field 'Result.order'
        db.delete_column('lab_clinic_api_result', 'order_id')
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 8, 0, 0)'}),
            ...
            'parent_identifier': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab_clinic_api.Aliquot']", 'to_field': "'aliquot_identifier'", 'null': 'True', 'blank': 'True'}),
        ...
        'lab_clinic_api.importhistorymodel': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 8, 0, 0)'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        'lab_clinic_api.lab': {
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 8, 0, 0)', 'db_index': 'True'}),
        ...
        'lab_clinic_api.resultitem': {
            ...
            'test_code': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['lab_test_code.TestCode']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
