...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCode.edc_name'
        db.add_column('lab_clinic_api_testcode', 'edc_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCode.edc_name'
        db.delete_column('lab_clinic_api_testcode', 'edc_name')
