...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Review.clinician_initials'
        db.delete_column('lab_clinic_api_review', 'clinician_initials')


        # Changing field 'Review.comment'
        db.alter_column('lab_clinic_api_review', 'comment', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Review.lab'
        raise RuntimeError("Cannot reverse this migration. 'Review.lab' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Review.clinician_initials'
        raise RuntimeError("Cannot reverse this migration. 'Review.clinician_initials' and its values cannot be restored.")

        # Changing field 'Review.comment'
        db.alter_column('lab_clinic_api_review', 'comment', self.gf('django.db.models.fields.TextField')(max_length=50, null=True))
