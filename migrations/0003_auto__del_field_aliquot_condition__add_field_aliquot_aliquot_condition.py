...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aliquot.condition'
        db.delete_column('bhp_lab_core_aliquot', 'condition_id')

        # Adding field 'Aliquot.aliquot_condition'
        db.add_column('bhp_lab_core_aliquot', 'aliquot_condition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10, related_name='+', null=True, to=orm['lab_aliquot_list.AliquotCondition']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Aliquot.condition'
        db.add_column('bhp_lab_core_aliquot', 'condition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10, to=orm['lab_aliquot_list.AliquotCondition'], null=True),
                      keep_default=False)

        # Deleting field 'Aliquot.aliquot_condition'
        db.delete_column('bhp_lab_core_aliquot', 'aliquot_condition_id')
    ...
    models = {
        ...
        'lab_aliquot.aliquot': {
            ...
            'aliquot_condition': ('django.db.models.fields.related.ForeignKey', [], {'default': '10', 'related_name': "'+'", 'null': 'True', 'to': "orm['lab_aliquot_list.AliquotCondition']"}),
            ...
            'aliquot_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['lab_aliquot_list.AliquotType']"}),
