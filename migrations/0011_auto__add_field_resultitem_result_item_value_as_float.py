...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lab_clinic_api_resultitem', 'result_item_value_as_float', self.gf('django.db.models.fields.FloatField')(null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResultItem.result_item_value_as_float'
        db.delete_column('lab_clinic_api_resultitem', 'result_item_value_as_float')
