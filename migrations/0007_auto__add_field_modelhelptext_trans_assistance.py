...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelHelpText.trans_assistance'
        db.add_column('bhp_data_manager_modelhelptext', 'trans_assistance',
                      self.gf('django.db.models.fields.TextField')(default='-', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelHelpText.trans_assistance'
        db.delete_column('bhp_data_manager_modelhelptext', 'trans_assistance')
