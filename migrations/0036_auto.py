...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TestCode', fields ['edc_code']
        db.create_index('lab_clinic_api_testcode', ['edc_code'])


    def backwards(self, orm):
        # Removing index on 'TestCode', fields ['edc_code']
        db.delete_index('lab_clinic_api_testcode', ['edc_code'])
