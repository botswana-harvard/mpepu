...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaternalConsentAudit.subject_identifier_as_pk'
        db.add_column('mpepu_maternal_maternalconsent_audit', 'subject_identifier_as_pk',
        ...
        db.alter_column('mpepu_maternal_maternalconsent_audit', 'subject_identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'MaternalDeathAudit.death_cause'
        db.alter_column('mpepu_maternal_maternaldeath_audit', 'death_cause', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

        # Changing field 'MaternalOffStudy.reason'
        db.alter_column('mpepu_maternal_maternaloffstudy', 'reason', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MaternalOffStudyAudit.reason'
        db.alter_column('mpepu_maternal_maternaloffstudy_audit', 'reason', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'MaternalDeath.death_cause'
        db.alter_column('mpepu_maternal_maternaldeath', 'death_cause', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))
        # Adding field 'MaternalConsent.subject_identifier_as_pk'
        db.add_column('mpepu_maternal_maternalconsent', 'subject_identifier_as_pk',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True),
                      keep_default=False)


        # Changing field 'MaternalConsent.subject_identifier'
        db.alter_column('mpepu_maternal_maternalconsent', 'subject_identifier', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=50))
        # Adding unique constraint on 'MaternalConsent', fields ['subject_identifier']
        db.create_unique('mpepu_maternal_maternalconsent', ['subject_identifier'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MaternalConsentAudit.subject_identifier_as_pk'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'subject_identifier_as_pk')
        ...
        # User chose to not deal with backwards NULL issues for 'MaternalDeathAudit.death_cause'
        raise RuntimeError("Cannot reverse this migration. 'MaternalDeathAudit.death_cause' and its values cannot be restored.")

        # Changing field 'MaternalOffStudy.reason'
        db.alter_column('mpepu_maternal_maternaloffstudy', 'reason', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MaternalOffStudyAudit.reason'
        db.alter_column('mpepu_maternal_maternaloffstudy_audit', 'reason', self.gf('django.db.models.fields.CharField')(max_length=25))

        # User chose to not deal with backwards NULL issues for 'MaternalDeath.death_cause'
        raise RuntimeError("Cannot reverse this migration. 'MaternalDeath.death_cause' and its values cannot be restored.")
        # Deleting field 'MaternalConsent.subject_identifier_as_pk'
        db.delete_column('mpepu_maternal_maternalconsent', 'subject_identifier_as_pk')
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 28, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 28, 0, 0)'}),
