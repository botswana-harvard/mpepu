...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaternalConsentUpdate.consent_catalogue'
        db.add_column('mpepu_maternal_maternalconsentupdate', 'consent_catalogue',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['bhp_consent.ConsentCatalogue']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MaternalConsentUpdate.consent_catalogue'
        db.delete_column('mpepu_maternal_maternalconsentupdate', 'consent_catalogue_id')
    ...
    models = {
        ...
        'bhp_consent.consentcatalogue': {
            'Meta': {'unique_together': "(('name', 'version', 'consent_type', 'start_datetime', 'end_datetime'),)", 'object_name': 'ConsentCatalogue'},
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)'}),
