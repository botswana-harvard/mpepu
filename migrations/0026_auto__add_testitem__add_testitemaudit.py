...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bhp_sync_testitem', (
        ...
        db.send_create_signal('bhp_sync', ['TestItem'])

        # Adding model 'TestItemAudit'
        db.create_table(u'bhp_sync_testitem_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bhp_sync', ['TestItemAudit'])


    def backwards(self, orm):
        # Deleting model 'TestItem'
        db.delete_table(u'bhp_sync_testitem')

        # Deleting model 'TestItemAudit'
        db.delete_table(u'bhp_sync_testitem_audit')
    ...
    models = {
        'bhp_sync.incomingtransaction': {
            ...
            'producer': ('django.db.models.fields.CharField', [], {'default': "'mac.local-bhp041_c2'", 'max_length': '25', 'db_index': 'True'}),
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 13, 0, 0)'}),
        ...
        'bhp_sync.syncimporthistorymodel': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 13, 0, 0)'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'bhp_sync.testitemaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'TestItemAudit', 'db_table': "u'bhp_sync_testitem_audit'"},
