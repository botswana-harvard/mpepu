...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_appointment_configuration', (
            ...
            ('allowed_iso_weekdays', self.gf('django.db.models.fields.IntegerField')(default=12345)),
            ('use_same_weekday', self.gf('django.db.models.fields.CharField')(default='YES', max_length=3)),
        ))
        db.send_create_signal('bhp_appointment', ['Configuration'])


    def backwards(self, orm):
        
        # Deleting model 'Configuration'
        db.delete_table('bhp_appointment_configuration')
    ...
    models = {
        ...
        'bhp_appointment.configuration': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'use_same_weekday': ('django.db.models.fields.CharField', [], {'default': "'YES'", 'max_length': '3'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
