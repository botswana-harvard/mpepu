...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactLogItem.appointment'
        db.add_column('bhp_appointment_contactlogitem', 'appointment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['bhp_appointment.Appointment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactLogItem.appointment'
        db.delete_column('bhp_appointment_contactlogitem', 'appointment_id')
