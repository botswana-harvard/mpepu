...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceRangeListItemAudit.active'
        db.add_column('lab_clinic_reference_referencerangelistitem_audit', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ReferenceRangeListItem.active'
        db.add_column('lab_clinic_reference_referencerangelistitem', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'GradingListItem.active'
        db.add_column('lab_clinic_reference_gradinglistitem', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferenceRangeListItemAudit.active'
        db.delete_column('lab_clinic_reference_referencerangelistitem_audit', 'active')

        # Deleting field 'ReferenceRangeListItem.active'
        db.delete_column('lab_clinic_reference_referencerangelistitem', 'active')

        # Deleting field 'GradingListItem.active'
        db.delete_column('lab_clinic_reference_gradinglistitem', 'active')
