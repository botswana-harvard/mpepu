...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bhp_lab_core_order', 'receive_identifier')

        # Deleting field 'Order.import_datetime'
        db.delete_column('bhp_lab_core_order', 'import_datetime')

        # Deleting field 'Order.subject_identifier'
        db.delete_column('bhp_lab_core_order', 'subject_identifier')
