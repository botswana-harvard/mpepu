...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultItem.grade_message'
        db.add_column('bhp_lab_core_resultitem', 'grade_message',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ResultItem.grade_warn'
        db.add_column('bhp_lab_core_resultitem', 'grade_warn',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultItem.grade_message'
        db.delete_column('bhp_lab_core_resultitem', 'grade_message')

        # Deleting field 'ResultItem.grade_warn'
        db.delete_column('bhp_lab_core_resultitem', 'grade_warn')
    ...
    models = {
        ...
        'lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 0, 0)'}),
        ...
        'lab_receive.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 0, 0)', 'db_index': 'True'}),
