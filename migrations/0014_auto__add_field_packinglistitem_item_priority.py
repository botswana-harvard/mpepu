...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PackingListItem.item_priority'
        db.add_column('mpepu_lab_packinglistitem', 'item_priority', self.gf('django.db.models.fields.CharField')(max_length=35, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PackingListItem.item_priority'
        db.delete_column('mpepu_lab_packinglistitem', 'item_priority')
    ...
    models = {
        ...
        'bhp_registration.registeredsubject': {
            ...
            'salt': ('django.db.models.fields.CharField', [], {'default': "',3Go7X9MI.K>'", 'max_length': '25'}),
        ...
        'mpepu_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 29, 11, 38, 24, 261892)'}),
