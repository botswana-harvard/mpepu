...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('bhp_form_appointment', ['visit_definition_id', 'visit_instance', 'registered_subject_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Appointment', fields ['visit_definition', 'visit_instance', 'registered_subject']
        db.create_unique('bhp_form_appointment', ['visit_definition_id', 'visit_instance', 'registered_subject_id'])
