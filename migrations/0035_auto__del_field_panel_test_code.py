...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Panel.test_code'
        # db.delete_column('lab_clinic_api_panel', 'test_code_id')

        # Adding M2M table for field test_code on 'Panel'
        db.create_table('lab_clinic_api_panel_test_code', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panel', models.ForeignKey(orm['lab_clinic_api.panel'], null=False)),
            ('testcode', models.ForeignKey(orm['lab_clinic_api.testcode'], null=False))
        ))
        db.create_unique('lab_clinic_api_panel_test_code', ['panel_id', 'testcode_id'])


    def backwards(self, orm):
        # Adding field 'Panel.test_code'
#        db.add_column('lab_clinic_api_panel', 'test_code',
#                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.TestCode'], null=True),
#                      keep_default=False)

        # Removing M2M table for field test_code on 'Panel'
        db.delete_table('lab_clinic_api_panel_test_code')
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 18, 0, 0)'}),
        ...
        'lab_clinic_api.panel': {
            ...
            'test_code': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lab_clinic_api.TestCode']", 'null': 'True', 'symmetrical': 'False'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 18, 0, 0)', 'db_index': 'True'}),
