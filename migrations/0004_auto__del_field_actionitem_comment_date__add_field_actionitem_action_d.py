...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActionItem.comment_date'
        db.delete_column('bhp_data_manager_actionitem', 'comment_date')

        # Adding field 'ActionItem.action_date'
        db.add_column('bhp_data_manager_actionitem', 'action_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 6, 16, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ActionItem.comment_date'
        db.add_column('bhp_data_manager_actionitem', 'comment_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 5, 7, 0, 0)),
                      keep_default=False)

        # Deleting field 'ActionItem.action_date'
        db.delete_column('bhp_data_manager_actionitem', 'action_date')


    models = {
        'bhp_data_manager.actionitem': {
            'Meta': {'object_name': 'ActionItem'},
            'action_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 16, 0, 0)'}),
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 14, 0, 0)'}),
        ...
        'bhp_data_manager.comment': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'comment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 16, 0, 0)'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
