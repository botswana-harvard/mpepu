...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackingListItem.old_panel_id'
        db.add_column('mpepu_lab_packinglistitem', 'old_panel_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackingListItem.old_panel_id'
        db.delete_column('mpepu_lab_packinglistitem', 'old_panel_id')
