...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultItem.subject_type'
        db.add_column('lab_clinic_api_resultitem', 'subject_type',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultItem.subject_type'
        db.delete_column('lab_clinic_api_resultitem', 'subject_type')
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 1, 0, 0)', 'db_index': 'True'}),
