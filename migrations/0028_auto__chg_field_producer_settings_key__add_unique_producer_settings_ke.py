...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bhp_sync_producer', 'settings_key', self.gf('django.db.models.fields.CharField')(default='0', unique=True, max_length=25))
        # Adding unique constraint on 'Producer', fields ['settings_key']
        db.create_unique(u'bhp_sync_producer', ['settings_key'])


    def backwards(self, orm):
        # Removing unique constraint on 'Producer', fields ['settings_key']
        db.delete_unique(u'bhp_sync_producer', ['settings_key'])


        # Changing field 'Producer.settings_key'
        db.alter_column(u'bhp_sync_producer', 'settings_key', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'bhp_sync.producer': {
            ...
            'settings_key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '25'}),
