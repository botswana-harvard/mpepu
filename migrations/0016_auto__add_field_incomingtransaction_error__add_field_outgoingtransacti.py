...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IncomingTransaction.error'
        db.add_column('bhp_sync_incomingtransaction', 'error', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'OutgoingTransaction.error'
        db.add_column('bhp_sync_outgoingtransaction', 'error', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.error'
        db.add_column('bhp_sync_transaction', 'error', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IncomingTransaction.error'
        db.delete_column('bhp_sync_incomingtransaction', 'error')

        # Deleting field 'OutgoingTransaction.error'
        db.delete_column('bhp_sync_outgoingtransaction', 'error')

        # Deleting field 'Transaction.error'
        db.delete_column('bhp_sync_transaction', 'error')
    ...
    models = {
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 6, 15, 5, 2, 500401)'}),
