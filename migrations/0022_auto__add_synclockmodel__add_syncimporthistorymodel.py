...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('bhp_sync', ['SyncLockModel'])
        ...
        db.create_table('bhp_sync_syncimporthistorymodel', (
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='mac.local', max_length=50, db_index=True, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('start_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 12, 0, 0))),
        ...
        db.send_create_signal('bhp_sync', ['SyncImportHistoryModel'])
