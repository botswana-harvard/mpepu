...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfantRequisitionAudit.old_panel_id'
        db.add_column('mpepu_lab_infantrequisition_audit', 'old_panel_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'InfantRequisitionAudit.old_aliquot_type_id'
        db.add_column('mpepu_lab_infantrequisition_audit', 'old_aliquot_type_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'MaternalRequisitionAudit.old_panel_id'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'old_panel_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'MaternalRequisitionAudit.old_aliquot_type_id'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'old_aliquot_type_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'InfantRequisition.old_panel_id'
        db.add_column('mpepu_lab_infantrequisition', 'old_panel_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'InfantRequisition.old_aliquot_type_id'
        db.add_column('mpepu_lab_infantrequisition', 'old_aliquot_type_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'MaternalRequisition.old_panel_id'
        db.add_column('mpepu_lab_maternalrequisition', 'old_panel_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'MaternalRequisition.old_aliquot_type_id'
        db.add_column('mpepu_lab_maternalrequisition', 'old_aliquot_type_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfantRequisitionAudit.old_panel_id'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'old_panel_id')

        # Deleting field 'InfantRequisitionAudit.old_aliquot_type_id'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'old_aliquot_type_id')

        # Deleting field 'MaternalRequisitionAudit.old_panel_id'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'old_panel_id')

        # Deleting field 'MaternalRequisitionAudit.old_aliquot_type_id'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'old_aliquot_type_id')

        # Deleting field 'InfantRequisition.old_panel_id'
        db.delete_column('mpepu_lab_infantrequisition', 'old_panel_id')

        # Deleting field 'InfantRequisition.old_aliquot_type_id'
        db.delete_column('mpepu_lab_infantrequisition', 'old_aliquot_type_id')

        # Deleting field 'MaternalRequisition.old_panel_id'
        db.delete_column('mpepu_lab_maternalrequisition', 'old_panel_id')

        # Deleting field 'MaternalRequisition.old_aliquot_type_id'
        db.delete_column('mpepu_lab_maternalrequisition', 'old_aliquot_type_id')
