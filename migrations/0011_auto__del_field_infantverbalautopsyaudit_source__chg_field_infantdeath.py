...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfantVerbalAutopsyAudit.source'
        db.delete_column('mpepu_infant_infantverbalautopsy_audit', 'source')

        # Changing field 'InfantDeathAudit.death_cause'
        db.alter_column('mpepu_infant_infantdeath_audit', 'death_cause', self.gf('django.db.models.fields.TextField')(max_length=1000))

        # Deleting field 'InfantVerbalAutopsy.source'
        db.delete_column('mpepu_infant_infantverbalautopsy', 'source')

        # Adding M2M table for field source on 'InfantVerbalAutopsy'
        db.create_table('mpepu_infant_infantverbalautopsy_source', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('infantverbalautopsy', models.ForeignKey(orm['mpepu_infant.infantverbalautopsy'], null=False)),
            ('autopsyinfosource', models.ForeignKey(orm['mpepu_list.autopsyinfosource'], null=False))
        ))
        db.create_unique('mpepu_infant_infantverbalautopsy_source', ['infantverbalautopsy_id', 'autopsyinfosource_id'])

        # Changing field 'InfantDeath.death_cause'
        db.alter_column('mpepu_infant_infantdeath', 'death_cause', self.gf('django.db.models.fields.TextField')(max_length=1000))

        # Changing field 'InfantStudyDrugAudit.drug_status'
        db.alter_column('mpepu_infant_infantstudydrug_audit', 'drug_status', self.gf('django.db.models.fields.CharField')(max_length=90))

        # Changing field 'InfantStudyDrug.drug_status'
        db.alter_column('mpepu_infant_infantstudydrug', 'drug_status', self.gf('django.db.models.fields.CharField')(max_length=90))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InfantVerbalAutopsyAudit.source'
        raise RuntimeError("Cannot reverse this migration. 'InfantVerbalAutopsyAudit.source' and its values cannot be restored.")

        # Changing field 'InfantDeathAudit.death_cause'
        db.alter_column('mpepu_infant_infantdeath_audit', 'death_cause', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # User chose to not deal with backwards NULL issues for 'InfantVerbalAutopsy.source'
        raise RuntimeError("Cannot reverse this migration. 'InfantVerbalAutopsy.source' and its values cannot be restored.")

        # Removing M2M table for field source on 'InfantVerbalAutopsy'
        db.delete_table('mpepu_infant_infantverbalautopsy_source')

        # Changing field 'InfantDeath.death_cause'
        db.alter_column('mpepu_infant_infantdeath', 'death_cause', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'InfantStudyDrugAudit.drug_status'
        db.alter_column('mpepu_infant_infantstudydrug_audit', 'drug_status', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'InfantStudyDrug.drug_status'
        db.alter_column('mpepu_infant_infantstudydrug', 'drug_status', self.gf('django.db.models.fields.CharField')(max_length=50))
