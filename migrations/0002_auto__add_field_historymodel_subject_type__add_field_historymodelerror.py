...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoryModel.subject_type'
        db.add_column('bhp_lab_tracker_historymodel', 'subject_type',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'HistoryModelError.subject_type'
        db.add_column('bhp_lab_tracker_historymodelerror', 'subject_type',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoryModel.subject_type'
        db.delete_column('bhp_lab_tracker_historymodel', 'subject_type')

        # Deleting field 'HistoryModelError.subject_type'
        db.delete_column('bhp_lab_tracker_historymodelerror', 'subject_type')
