...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lab_clinic_reference_gradinglistitem_audit', (
            ...
            ('lln_quantifier', self.gf('django.db.models.fields.CharField')(default='>=', max_length=10)),
            ('uln', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4, blank=True)),
            ('uln_quantifier', self.gf('django.db.models.fields.CharField')(default='<=', max_length=10)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('lab_clinic_reference_gradinglistitem_audit')
