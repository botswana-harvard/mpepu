...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AliquotCondition.name'
        db.alter_column('lab_clinic_api_aliquotcondition', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'AliquotCondition.name'
        db.alter_column('lab_clinic_api_aliquotcondition', 'name', self.gf('django.db.models.fields.CharField')(default='-', max_length=250, unique=True))
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 27, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 27, 0, 0)', 'db_index': 'True'}),
