...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.review'
        db.add_column('lab_clinic_api_result', 'review',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['lab_clinic_api.Review'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.review'
        db.delete_column('lab_clinic_api_result', 'review_id')
