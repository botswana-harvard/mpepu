...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantStudyDrugItemsAudit.modification_reason'
        db.alter_column('mpepu_infant_infantstudydrugitems_audit', 'modification_reason', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'InfantStudyDrugItems.modification_reason'
        db.alter_column('mpepu_infant_infantstudydrugitems', 'modification_reason', self.gf('django.db.models.fields.CharField')(max_length=75))

    def backwards(self, orm):

        # Changing field 'InfantStudyDrugItemsAudit.modification_reason'
        db.alter_column('mpepu_infant_infantstudydrugitems_audit', 'modification_reason', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'InfantStudyDrugItems.modification_reason'
        db.alter_column('mpepu_infant_infantstudydrugitems', 'modification_reason', self.gf('django.db.models.fields.CharField')(max_length=35))
    ...
    models = {
        ...
        'bhp_registration.registeredsubject': {
            'Meta': {'ordering': "['subject_identifier']", 'unique_together': "(('identity', 'first_name', 'dob', 'initials'),)", 'object_name': 'RegisteredSubject'},
