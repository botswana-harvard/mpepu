...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('bhp_lab_core_resultitem', ['hostname_created'])

        # Adding index on 'ResultItem', fields ['hostname_modified']
        db.create_index('bhp_lab_core_resultitem', ['hostname_modified'])


    def backwards(self, orm):
        # Removing index on 'ResultItem', fields ['hostname_modified']
        db.delete_index('bhp_lab_core_resultitem', ['hostname_modified'])

        # Removing index on 'ResultItem', fields ['hostname_created']
        db.delete_index('bhp_lab_core_resultitem', ['hostname_created'])
