...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceRangeListItem.dummy'
        db.add_column('lab_clinic_reference_referencerangelistitem', 'dummy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ReferenceRangeListItemAudit.dummy'
        db.add_column('lab_clinic_reference_referencerangelistitem_audit', 'dummy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferenceRangeListItem.dummy'
        db.delete_column('lab_clinic_reference_referencerangelistitem', 'dummy')

        # Deleting field 'ReferenceRangeListItemAudit.dummy'
        db.delete_column('lab_clinic_reference_referencerangelistitem_audit', 'dummy')
