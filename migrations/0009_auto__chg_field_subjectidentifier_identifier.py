...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectIdentifier.identifier'
        db.alter_column('bhp_identifier_subjectidentifier', 'identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36))

    def backwards(self, orm):

        # Changing field 'SubjectIdentifier.identifier'
        db.alter_column('bhp_identifier_subjectidentifier', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))
