...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IncomingTransaction.consumer'
        db.alter_column('bhp_sync_incomingtransaction', 'consumer', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'OutgoingTransaction.consumer'
        db.alter_column('bhp_sync_outgoingtransaction', 'consumer', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Transaction.consumer'
        db.alter_column('bhp_sync_transaction', 'consumer', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))


    def backwards(self, orm):
        
        # Changing field 'IncomingTransaction.consumer'
        db.alter_column('bhp_sync_incomingtransaction', 'consumer', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'OutgoingTransaction.consumer'
        db.alter_column('bhp_sync_outgoingtransaction', 'consumer', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Transaction.consumer'
        db.alter_column('bhp_sync_transaction', 'consumer', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    ...
    models = {
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 5, 19, 34, 56, 500278)'}),
