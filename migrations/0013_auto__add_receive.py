...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lab_clinic_api_receive', (
            ...
            ('receive_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 7, 0, 0), db_index=True)),
        ...
        db.send_create_signal('lab_clinic_api', ['Receive'])


    def backwards(self, orm):
        # Deleting model 'Receive'
        db.delete_table('lab_clinic_api_receive')
