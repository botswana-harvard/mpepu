...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Holiday.configuration'
        db.add_column('bhp_appointment_holiday', 'configuration', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_appointment.Configuration']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Holiday.configuration'
        db.delete_column('bhp_appointment_holiday', 'configuration_id')
