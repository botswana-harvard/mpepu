...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantDeathAudit.comment'
        db.alter_column('mpepu_infant_infantdeath_audit', 'comment', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

        # Changing field 'InfantDeathAudit.death_reason_hospitalized'
        db.alter_column('mpepu_infant_infantdeath_audit', 'death_reason_hospitalized_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bhp_adverse.DeathReasonHospitalized']))

        # Changing field 'InfantDeath.comment'
        db.alter_column('mpepu_infant_infantdeath', 'comment', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

        # Changing field 'InfantDeath.death_reason_hospitalized'
        db.alter_column('mpepu_infant_infantdeath', 'death_reason_hospitalized_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_adverse.DeathReasonHospitalized'], null=True))


    def backwards(self, orm):
        
        # Changing field 'InfantDeathAudit.comment'
        db.alter_column('mpepu_infant_infantdeath_audit', 'comment', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # User chose to not deal with backwards NULL issues for 'InfantDeathAudit.death_reason_hospitalized'
        raise RuntimeError("Cannot reverse this migration. 'InfantDeathAudit.death_reason_hospitalized' and its values cannot be restored.")

        # Changing field 'InfantDeath.comment'
        db.alter_column('mpepu_infant_infantdeath', 'comment', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # User chose to not deal with backwards NULL issues for 'InfantDeath.death_reason_hospitalized'
        raise RuntimeError("Cannot reverse this migration. 'InfantDeath.death_reason_hospitalized' and its values cannot be restored.")
