...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lab_clinic_api_resultitem', 'grade_message',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ResultItem.grade_warn'
        db.add_column('lab_clinic_api_resultitem', 'grade_warn',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lab_clinic_api_resultitem', 'grade_message')

        # Deleting field 'ResultItem.grade_warn'
        db.delete_column('lab_clinic_api_resultitem', 'grade_warn')
