...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Crypt', fields ['hash', 'mode', 'algorithm']
        db.create_unique('bhp_crypto_crypt', ['hash', 'mode', 'algorithm'])


    def backwards(self, orm):
        # Removing unique constraint on 'Crypt', fields ['hash', 'mode', 'algorithm']
        db.delete_unique('bhp_crypto_crypt', ['hash', 'mode', 'algorithm'])


    models = {
        'bhp_crypto.crypt': {
            'Meta': {'unique_together': "(('hash', 'algorithm', 'mode'),)", 'object_name': 'Crypt'},
