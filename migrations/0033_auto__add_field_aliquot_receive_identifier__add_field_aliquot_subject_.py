...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lab_clinic_api_aliquot', 'receive_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Aliquot.subject_identifier'
        db.add_column('lab_clinic_api_aliquot', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Order.receive_identifier'
        db.add_column('lab_clinic_api_order', 'receive_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Order.subject_identifier'
        db.add_column('lab_clinic_api_order', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Result.receive_identifier'
        db.add_column('lab_clinic_api_result', 'receive_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Result.subject_identifier'
        db.add_column('lab_clinic_api_result', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'ResultItem.receive_identifier'
        db.add_column('lab_clinic_api_resultitem', 'receive_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'ResultItem.subject_identifier'
        db.add_column('lab_clinic_api_resultitem', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aliquot.receive_identifier'
        db.delete_column('lab_clinic_api_aliquot', 'receive_identifier')

        # Deleting field 'Aliquot.subject_identifier'
        db.delete_column('lab_clinic_api_aliquot', 'subject_identifier')

        # Deleting field 'Order.receive_identifier'
        db.delete_column('lab_clinic_api_order', 'receive_identifier')

        # Deleting field 'Order.subject_identifier'
        db.delete_column('lab_clinic_api_order', 'subject_identifier')

        # Deleting field 'Result.receive_identifier'
        db.delete_column('lab_clinic_api_result', 'receive_identifier')

        # Deleting field 'Result.subject_identifier'
        db.delete_column('lab_clinic_api_result', 'subject_identifier')

        # Deleting field 'ResultItem.receive_identifier'
        db.delete_column('lab_clinic_api_resultitem', 'receive_identifier')

        # Deleting field 'ResultItem.subject_identifier'
        db.delete_column('lab_clinic_api_resultitem', 'subject_identifier')
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 0, 0)', 'db_index': 'True'}),
