...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestSubjectConsent.confirm_identity'
        db.add_column('bhp_consent_testsubjectconsent', 'confirm_identity',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestSubjectConsent.confirm_identity'
        db.delete_column('bhp_consent_testsubjectconsent', 'confirm_identity')
