...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'InfantFuDxItems.fu_dx'
        raise RuntimeError("Cannot reverse this migration. 'InfantFuDxItems.fu_dx' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'InfantFuDxItemsAudit.fu_dx'
        raise RuntimeError("Cannot reverse this migration. 'InfantFuDxItemsAudit.fu_dx' and its values cannot be restored.")
