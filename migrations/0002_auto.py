...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ResultSource', fields ['hostname_created']
        db.create_index('bhp_lab_core_resultsource', ['hostname_created'])

        # Adding index on 'ResultSource', fields ['hostname_modified']
        db.create_index('bhp_lab_core_resultsource', ['hostname_modified'])

        # Adding index on 'Result', fields ['hostname_created']
        db.create_index('bhp_lab_core_result', ['hostname_created'])

        # Adding index on 'Result', fields ['hostname_modified']
        db.create_index('bhp_lab_core_result', ['hostname_modified'])


    def backwards(self, orm):
        # Removing index on 'Result', fields ['hostname_modified']
        db.delete_index('bhp_lab_core_result', ['hostname_modified'])

        # Removing index on 'Result', fields ['hostname_created']
        db.delete_index('bhp_lab_core_result', ['hostname_created'])

        # Removing index on 'ResultSource', fields ['hostname_modified']
        db.delete_index('bhp_lab_core_resultsource', ['hostname_modified'])

        # Removing index on 'ResultSource', fields ['hostname_created']
        db.delete_index('bhp_lab_core_resultsource', ['hostname_created'])
