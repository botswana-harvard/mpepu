...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsentCatalogueAudit.add_for_app'
        db.add_column('bhp_consent_consentcatalogue_audit', 'add_for_app',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConsentCatalogue.add_for_app'
        db.add_column('bhp_consent_consentcatalogue', 'add_for_app',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsentCatalogueAudit.add_for_app'
        db.delete_column('bhp_consent_consentcatalogue_audit', 'add_for_app')

        # Deleting field 'ConsentCatalogue.add_for_app'
        db.delete_column('bhp_consent_consentcatalogue', 'add_for_app')
