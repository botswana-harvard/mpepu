...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bhp_form_appointment_audit', '_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AppointmentAudit._audit_subject_identifier'
        db.delete_column('bhp_form_appointment_audit', '_audit_subject_identifier')
