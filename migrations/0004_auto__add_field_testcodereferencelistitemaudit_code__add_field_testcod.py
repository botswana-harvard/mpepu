...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCodeReferenceListItemAudit.code'
        db.add_column('bhp_lab_test_code_testcodereferencelistitem_audit', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'TestCodeReferenceListItem.code'
        db.add_column('bhp_lab_test_code_testcodereferencelistitem', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TestCodeReferenceListItemAudit.code'
        db.delete_column('bhp_lab_test_code_testcodereferencelistitem_audit', 'code')

        # Deleting field 'TestCodeReferenceListItem.code'
        db.delete_column('bhp_lab_test_code_testcodereferencelistitem', 'code')
