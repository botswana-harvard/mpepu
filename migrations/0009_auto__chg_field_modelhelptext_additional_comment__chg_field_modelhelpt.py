...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModelHelpText.additional_comment'
        db.alter_column('bhp_data_manager_modelhelptext', 'additional_comment', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

        # Changing field 'ModelHelpText.help_text'
        db.alter_column('bhp_data_manager_modelhelptext', 'help_text', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

        # Changing field 'ModelHelpText.trans_assistance'
        db.alter_column('bhp_data_manager_modelhelptext', 'trans_assistance', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ModelHelpText.additional_comment'
        raise RuntimeError("Cannot reverse this migration. 'ModelHelpText.additional_comment' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ModelHelpText.help_text'
        raise RuntimeError("Cannot reverse this migration. 'ModelHelpText.help_text' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ModelHelpText.trans_assistance'
        raise RuntimeError("Cannot reverse this migration. 'ModelHelpText.trans_assistance' and its values cannot be restored.")
