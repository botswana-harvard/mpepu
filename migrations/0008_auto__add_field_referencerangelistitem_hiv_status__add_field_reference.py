...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceRangeListItem.hiv_status'
        db.add_column('lab_clinic_reference_referencerangelistitem', 'hiv_status',
                      self.gf('django.db.models.fields.CharField')(default='ANY', max_length=10),
                      keep_default=False)

        # Adding field 'ReferenceRangeListItemAudit.hiv_status'
        db.add_column('lab_clinic_reference_referencerangelistitem_audit', 'hiv_status',
                      self.gf('django.db.models.fields.CharField')(default='ANY', max_length=10),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ReferenceRangeListItem.hiv_status'
        db.delete_column('lab_clinic_reference_referencerangelistitem', 'hiv_status')

        # Deleting field 'ReferenceRangeListItemAudit.hiv_status'
        db.delete_column('lab_clinic_reference_referencerangelistitem_audit', 'hiv_status')
