...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GradingListItemAudit.fasting'
        db.add_column('lab_clinic_reference_gradinglistitem_audit', 'fasting',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)

        # Adding field 'GradingListItemAudit.serum'
        db.add_column('lab_clinic_reference_gradinglistitem_audit', 'serum',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)

        # Adding field 'GradingListItem.fasting'
        db.add_column('lab_clinic_reference_gradinglistitem', 'fasting',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)

        # Adding field 'GradingListItem.serum'
        db.add_column('lab_clinic_reference_gradinglistitem', 'serum',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GradingListItemAudit.fasting'
        db.delete_column('lab_clinic_reference_gradinglistitem_audit', 'fasting')

        # Deleting field 'GradingListItemAudit.serum'
        db.delete_column('lab_clinic_reference_gradinglistitem_audit', 'serum')

        # Deleting field 'GradingListItem.fasting'
        db.delete_column('lab_clinic_reference_gradinglistitem', 'fasting')

        # Deleting field 'GradingListItem.serum'
        db.delete_column('lab_clinic_reference_gradinglistitem', 'serum')
