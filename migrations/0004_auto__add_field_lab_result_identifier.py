...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lab.result_identifier'
        db.add_column('lab_clinic_api_lab', 'result_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lab.result_identifier'
        db.delete_column('lab_clinic_api_lab', 'result_identifier')
