...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TestCode', fields ['edc_name']
        db.create_index('lab_clinic_api_testcode', ['edc_name'])


    def backwards(self, orm):
        # Removing index on 'TestCode', fields ['edc_name']
        db.delete_index('lab_clinic_api_testcode', ['edc_name'])
