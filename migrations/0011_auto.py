...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'MaternalLabDel', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdel', ['hostname_modified'])

        # Removing index on 'MaternalLabDel', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdel', ['hostname_created'])

        # Removing index on 'MaternalLocator', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallocator', ['hostname_modified'])

        # Removing index on 'MaternalLocator', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallocator', ['hostname_created'])

        # Removing index on 'MaternalEnrollMedAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrollmed_audit', ['hostname_modified'])

        # Removing index on 'MaternalEnrollMedAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrollmed_audit', ['hostname_created'])

        # Removing index on 'MaternalArvPost', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpost', ['hostname_modified'])

        # Removing index on 'MaternalArvPost', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpost', ['hostname_created'])

        # Removing index on 'MaternalConsent', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalconsent', ['hostname_modified'])

        # Removing index on 'MaternalConsent', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalconsent', ['hostname_created'])

        # Removing index on 'MaternalLabDelAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdel_audit', ['hostname_modified'])

        # Removing index on 'MaternalLabDelAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdel_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollObAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrollob_audit', ['hostname_modified'])

        # Removing index on 'MaternalEnrollObAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrollob_audit', ['hostname_created'])

        # Removing index on 'MaternalEligibilityAnte', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternaleligibilityante', ['hostname_modified'])

        # Removing index on 'MaternalEligibilityAnte', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternaleligibilityante', ['hostname_created'])

        # Removing index on 'MaternalPostFuDxT', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalpostfudxt', ['hostname_modified'])

        # Removing index on 'MaternalPostFuDxT', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalpostfudxt', ['hostname_created'])

        # Removing index on 'MaternalArvAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarv_audit', ['hostname_modified'])

        # Removing index on 'MaternalArvAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarv_audit', ['hostname_created'])

        # Removing index on 'MaternalLabDelDxT', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdeldxt', ['hostname_modified'])

        # Removing index on 'MaternalLabDelDxT', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdeldxt', ['hostname_created'])

        # Removing index on 'MaternalEnrollClin', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrollclin', ['hostname_modified'])

        # Removing index on 'MaternalEnrollClin', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrollclin', ['hostname_created'])

        # Removing index on 'MaternalLabDelClinic', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdelclinic', ['hostname_modified'])

        # Removing index on 'MaternalLabDelClinic', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdelclinic', ['hostname_created'])

        # Removing index on 'MaternalPostFuDx', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalpostfudx', ['hostname_modified'])

        # Removing index on 'MaternalPostFuDx', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalpostfudx', ['hostname_created'])

        # Removing index on 'MaternalArvPreg', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpreg', ['hostname_modified'])

        # Removing index on 'MaternalArvPreg', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpreg', ['hostname_created'])

        # Removing index on 'MaternalLocatorAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallocator_audit', ['hostname_modified'])

        # Removing index on 'MaternalLocatorAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallocator_audit', ['hostname_created'])

        # Removing index on 'MaternalArvPPHistory', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpphistory', ['hostname_modified'])

        # Removing index on 'MaternalArvPPHistory', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpphistory', ['hostname_created'])

        # Removing index on 'MaternalPostReg', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalpostreg', ['hostname_modified'])

        # Removing index on 'MaternalPostReg', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalpostreg', ['hostname_created'])

        # Removing index on 'MaternalArvPPHistoryAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpphistory_audit', ['hostname_modified'])

        # Removing index on 'MaternalArvPPHistoryAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpphistory_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollDem', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrolldem', ['hostname_modified'])

        # Removing index on 'MaternalEnrollDem', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrolldem', ['hostname_created'])

        # Removing index on 'MaternalEligibilityPost', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternaleligibilitypost', ['hostname_created'])

        # Removing index on 'MaternalEligibilityPost', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternaleligibilitypost', ['hostname_modified'])

        # Removing index on 'MaternalPostFuDxAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalpostfudx_audit', ['hostname_modified'])

        # Removing index on 'MaternalPostFuDxAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalpostfudx_audit', ['hostname_created'])

        # Removing index on 'MaternalPostFuDxTAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalpostfudxt_audit', ['hostname_modified'])

        # Removing index on 'MaternalPostFuDxTAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalpostfudxt_audit', ['hostname_created'])

        # Removing index on 'MaternalPostFu', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalpostfu', ['hostname_modified'])

        # Removing index on 'MaternalPostFu', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalpostfu', ['hostname_created'])

        # Removing index on 'MaternalEnrollArvAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrollarv_audit', ['hostname_modified'])

        # Removing index on 'MaternalEnrollArvAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrollarv_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollMed', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrollmed', ['hostname_modified'])

        # Removing index on 'MaternalEnrollMed', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrollmed', ['hostname_created'])

        # Removing index on 'MaternalEnroll', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenroll', ['hostname_modified'])

        # Removing index on 'MaternalEnroll', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenroll', ['hostname_created'])

        # Removing index on 'MaternalArvPostAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpost_audit', ['hostname_modified'])

        # Removing index on 'MaternalArvPostAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpost_audit', ['hostname_created'])

        # Removing index on 'MaternalPostRegAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalpostreg_audit', ['hostname_modified'])

        # Removing index on 'MaternalPostRegAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalpostreg_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollDxAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrolldx_audit', ['hostname_modified'])

        # Removing index on 'MaternalEnrollDxAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrolldx_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollDx', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrolldx', ['hostname_modified'])

        # Removing index on 'MaternalEnrollDx', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrolldx', ['hostname_created'])

        # Removing index on 'MaternalLabDelClinicAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdelclinic_audit', ['hostname_modified'])

        # Removing index on 'MaternalLabDelClinicAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdelclinic_audit', ['hostname_created'])

        # Removing index on 'MaternalArvPostModAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpostmod_audit', ['hostname_modified'])

        # Removing index on 'MaternalArvPostModAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpostmod_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollClinAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrollclin_audit', ['hostname_modified'])

        # Removing index on 'MaternalEnrollClinAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrollclin_audit', ['hostname_created'])

        # Removing index on 'MaternalDeath', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternaldeath', ['hostname_modified'])

        # Removing index on 'MaternalDeath', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternaldeath', ['hostname_created'])

        # Removing index on 'MaternalLabDelDxAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdeldx_audit', ['hostname_modified'])

        # Removing index on 'MaternalLabDelDxAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdeldx_audit', ['hostname_created'])

        # Removing index on 'MaternalLabDelMedAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdelmed_audit', ['hostname_modified'])

        # Removing index on 'MaternalLabDelMedAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdelmed_audit', ['hostname_created'])

        # Removing index on 'MaternalOffStudyAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternaloffstudy_audit', ['hostname_modified'])

        # Removing index on 'MaternalOffStudyAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternaloffstudy_audit', ['hostname_created'])

        # Removing index on 'MaternalArvPostMod', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpostmod', ['hostname_created'])

        # Removing index on 'MaternalArvPostMod', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpostmod', ['hostname_modified'])

        # Removing index on 'MaternalEnrollAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenroll_audit', ['hostname_modified'])

        # Removing index on 'MaternalEnrollAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenroll_audit', ['hostname_created'])

        # Removing index on 'MaternalLabDelDxTAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdeldxt_audit', ['hostname_modified'])

        # Removing index on 'MaternalLabDelDxTAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdeldxt_audit', ['hostname_created'])

        # Removing index on 'MaternalEligibilityAnteAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternaleligibilityante_audit', ['hostname_modified'])

        # Removing index on 'MaternalEligibilityAnteAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternaleligibilityante_audit', ['hostname_created'])

        # Removing index on 'MaternalArvPostAdhAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpostadh_audit', ['hostname_modified'])

        # Removing index on 'MaternalArvPostAdhAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpostadh_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollOb', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrollob', ['hostname_modified'])

        # Removing index on 'MaternalEnrollOb', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrollob', ['hostname_created'])

        # Removing index on 'MaternalEligibilityPostAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternaleligibilitypost_audit', ['hostname_modified'])

        # Removing index on 'MaternalEligibilityPostAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternaleligibilitypost_audit', ['hostname_created'])

        # Removing index on 'MaternalArvPostAdh', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpostadh', ['hostname_modified'])

        # Removing index on 'MaternalArvPostAdh', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpostadh', ['hostname_created'])

        # Removing index on 'MaternalArvPregHistory', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpreghistory', ['hostname_modified'])

        # Removing index on 'MaternalArvPregHistory', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpreghistory', ['hostname_created'])

        # Removing index on 'MaternalLabDelDx', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdeldx', ['hostname_modified'])

        # Removing index on 'MaternalLabDelDx', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdeldx', ['hostname_created'])

        # Removing index on 'MaternalOffStudy', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternaloffstudy', ['hostname_modified'])

        # Removing index on 'MaternalOffStudy', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternaloffstudy', ['hostname_created'])

        # Removing index on 'MaternalPostFuAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalpostfu_audit', ['hostname_modified'])

        # Removing index on 'MaternalPostFuAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalpostfu_audit', ['hostname_created'])

        # Removing index on 'MaternalDeathAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternaldeath_audit', ['hostname_modified'])

        # Removing index on 'MaternalDeathAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternaldeath_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollArv', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrollarv', ['hostname_modified'])

        # Removing index on 'MaternalEnrollArv', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrollarv', ['hostname_created'])

        # Removing index on 'MaternalArv', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarv', ['hostname_modified'])

        # Removing index on 'MaternalArv', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarv', ['hostname_created'])

        # Removing index on 'MaternalVisitAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalvisit_audit', ['hostname_modified'])

        # Removing index on 'MaternalVisitAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalvisit_audit', ['hostname_created'])

        # Removing index on 'MaternalConsentAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalconsent_audit', ['hostname_modified'])

        # Removing index on 'MaternalConsentAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalconsent_audit', ['hostname_created'])

        # Removing index on 'MaternalLabDelMed', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternallabdelmed', ['hostname_modified'])

        # Removing index on 'MaternalLabDelMed', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternallabdelmed', ['hostname_created'])

        # Removing index on 'MaternalVisit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalvisit', ['hostname_modified'])

        # Removing index on 'MaternalVisit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalvisit', ['hostname_created'])

        # Removing index on 'MaternalArvPregAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpreg_audit', ['hostname_modified'])

        # Removing index on 'MaternalArvPregAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpreg_audit', ['hostname_created'])

        # Removing index on 'MaternalArvPregHistoryAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalarvpreghistory_audit', ['hostname_modified'])

        # Removing index on 'MaternalArvPregHistoryAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalarvpreghistory_audit', ['hostname_created'])

        # Removing index on 'MaternalEnrollDemAudit', fields ['hostname_modified']
        db.delete_index('mpepu_maternal_maternalenrolldem_audit', ['hostname_modified'])

        # Removing index on 'MaternalEnrollDemAudit', fields ['hostname_created']
        db.delete_index('mpepu_maternal_maternalenrolldem_audit', ['hostname_created'])
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 3, 26)'}),
