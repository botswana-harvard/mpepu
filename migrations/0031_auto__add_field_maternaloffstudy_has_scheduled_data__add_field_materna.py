...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaternalOffStudy.has_scheduled_data'
        db.add_column('mpepu_maternal_maternaloffstudy', 'has_scheduled_data',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)

        # Adding field 'MaternalOffStudyAudit.has_scheduled_data'
        db.add_column('mpepu_maternal_maternaloffstudy_audit', 'has_scheduled_data',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MaternalOffStudy.has_scheduled_data'
        db.delete_column('mpepu_maternal_maternaloffstudy', 'has_scheduled_data')

        # Deleting field 'MaternalOffStudyAudit.has_scheduled_data'
        db.delete_column('mpepu_maternal_maternaloffstudy_audit', 'has_scheduled_data')
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 27, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 27, 0, 0)'}),
