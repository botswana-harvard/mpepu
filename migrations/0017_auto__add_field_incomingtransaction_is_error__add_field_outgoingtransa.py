...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IncomingTransaction.is_error'
        db.add_column('bhp_sync_incomingtransaction', 'is_error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'OutgoingTransaction.is_error'
        db.add_column('bhp_sync_outgoingtransaction', 'is_error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Transaction.is_error'
        db.add_column('bhp_sync_transaction', 'is_error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IncomingTransaction.is_error'
        db.delete_column('bhp_sync_incomingtransaction', 'is_error')

        # Deleting field 'OutgoingTransaction.is_error'
        db.delete_column('bhp_sync_outgoingtransaction', 'is_error')

        # Deleting field 'Transaction.is_error'
        db.delete_column('bhp_sync_transaction', 'is_error')
    ...
    models = {
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 6, 15, 16, 45, 211296)'}),
