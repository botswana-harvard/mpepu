...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfantFuDxItems.onset_date'
        db.add_column('mpepu_infant_infantfudxitems', 'onset_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'InfantFuDxItems.is_eae_required'
        db.add_column('mpepu_infant_infantfudxitems', 'is_eae_required',
                      self.gf('django.db.models.fields.CharField')(default='UNKNOWN', max_length=10),
                      keep_default=False)

        # Adding field 'InfantFuDxItems.eae_reference'
        db.add_column('mpepu_infant_infantfudxitems', 'eae_reference',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


        # Changing field 'InfantFuDxItems.grade'
        db.alter_column('mpepu_infant_infantfudxitems', 'grade', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'InfantBirth.first_name'
        db.alter_column('mpepu_infant_infantbirth', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=78L))

        # Changing field 'InfantBirthAudit.first_name'
        db.alter_column('mpepu_infant_infantbirth_audit', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=78L))
        # Adding field 'InfantFuDxItemsAudit.onset_date'
        db.add_column('mpepu_infant_infantfudxitems_audit', 'onset_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'InfantFuDxItemsAudit.is_eae_required'
        db.add_column('mpepu_infant_infantfudxitems_audit', 'is_eae_required',
                      self.gf('django.db.models.fields.CharField')(default='UNKNOWN', max_length=10),
                      keep_default=False)

        # Adding field 'InfantFuDxItemsAudit.eae_reference'
        db.add_column('mpepu_infant_infantfudxitems_audit', 'eae_reference',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


        # Changing field 'InfantFuDxItemsAudit.grade'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'grade', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Deleting field 'InfantFuDxItems.onset_date'
        db.delete_column('mpepu_infant_infantfudxitems', 'onset_date')

        # Deleting field 'InfantFuDxItems.is_eae_required'
        db.delete_column('mpepu_infant_infantfudxitems', 'is_eae_required')

        # Deleting field 'InfantFuDxItems.eae_reference'
        db.delete_column('mpepu_infant_infantfudxitems', 'eae_reference')


        # Changing field 'InfantFuDxItems.grade'
        db.alter_column('mpepu_infant_infantfudxitems', 'grade', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'InfantBirth.first_name'
        db.alter_column('mpepu_infant_infantbirth', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'InfantBirthAudit.first_name'
        db.alter_column('mpepu_infant_infantbirth_audit', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=250))
        # Deleting field 'InfantFuDxItemsAudit.onset_date'
        db.delete_column('mpepu_infant_infantfudxitems_audit', 'onset_date')

        # Deleting field 'InfantFuDxItemsAudit.is_eae_required'
        db.delete_column('mpepu_infant_infantfudxitems_audit', 'is_eae_required')

        # Deleting field 'InfantFuDxItemsAudit.eae_reference'
        db.delete_column('mpepu_infant_infantfudxitems_audit', 'eae_reference')


        # Changing field 'InfantFuDxItemsAudit.grade'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'grade', self.gf('django.db.models.fields.IntegerField')())
