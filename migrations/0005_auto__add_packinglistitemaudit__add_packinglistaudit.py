...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lab_packing_packinglist_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('list_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 29, 13, 15, 51, 372670))),
    ...
    models = {
        'lab_packing.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 13, 15, 51, 372670)'}),
