...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Producer.sync_datetime'
        db.add_column('bhp_sync_producer', 'sync_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Producer.sync_datetime'
        db.delete_column('bhp_sync_producer', 'sync_datetime')
    ...
    models = {
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 30, 8, 10, 57, 275506)'}),
