...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IncomingTransaction.is_ignored'
        db.add_column('bhp_sync_incomingtransaction', 'is_ignored',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'OutgoingTransaction.is_ignored'
        db.add_column('bhp_sync_outgoingtransaction', 'is_ignored',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Transaction.is_ignored'
        db.add_column('bhp_sync_transaction', 'is_ignored',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IncomingTransaction.is_ignored'
        db.delete_column('bhp_sync_incomingtransaction', 'is_ignored')

        # Deleting field 'OutgoingTransaction.is_ignored'
        db.delete_column('bhp_sync_outgoingtransaction', 'is_ignored')

        # Deleting field 'Transaction.is_ignored'
        db.delete_column('bhp_sync_transaction', 'is_ignored')
    ...
    models = {
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 4, 0, 0)'}),
