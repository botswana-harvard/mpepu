...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lab_clinic_api_aliquot', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Receive.import_datetime'
        db.add_column('lab_clinic_api_receive', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.import_datetime'
        db.add_column('lab_clinic_api_order', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Result.import_datetime'
        db.add_column('lab_clinic_api_result', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ResultItem.import_datetime'
        db.add_column('lab_clinic_api_resultitem', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lab_clinic_api_aliquot', 'import_datetime')

        # Deleting field 'Receive.import_datetime'
        db.delete_column('lab_clinic_api_receive', 'import_datetime')

        # Deleting field 'Order.import_datetime'
        db.delete_column('lab_clinic_api_order', 'import_datetime')

        # Deleting field 'Result.import_datetime'
        db.delete_column('lab_clinic_api_result', 'import_datetime')

        # Deleting field 'ResultItem.import_datetime'
        db.delete_column('lab_clinic_api_resultitem', 'import_datetime')
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 14, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 14, 0, 0)', 'db_index': 'True'}),
