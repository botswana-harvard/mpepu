...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lab_clinic_api_resultitem', 'test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.TestCode']))

    def backwards(self, orm):

        # Changing field 'ResultItem.test_code'
        db.alter_column('lab_clinic_api_resultitem', 'test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_test_code.TestCode']))
