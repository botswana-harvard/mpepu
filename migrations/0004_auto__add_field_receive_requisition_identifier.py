...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Receive.requisition_identifier'
        db.add_column('bhp_lab_core_receive', 'requisition_identifier',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding index on 'Receive', fields ['hostname_created']
        db.create_index('bhp_lab_core_receive', ['hostname_created'])

        # Adding index on 'Receive', fields ['hostname_modified']
        db.create_index('bhp_lab_core_receive', ['hostname_modified'])


    def backwards(self, orm):
        # Removing index on 'Receive', fields ['hostname_modified']
        db.delete_index('bhp_lab_core_receive', ['hostname_modified'])

        # Removing index on 'Receive', fields ['hostname_created']
        db.delete_index('bhp_lab_core_receive', ['hostname_created'])

        # Deleting field 'Receive.requisition_identifier'
        db.delete_column('bhp_lab_core_receive', 'requisition_identifier')
