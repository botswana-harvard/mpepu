...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MaternalConsentUpdate.consent_version'
        db.alter_column('mpepu_maternal_maternalconsentupdate', 'consent_version', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MaternalConsentUpdate.consent_version'
        raise RuntimeError("Cannot reverse this migration. 'MaternalConsentUpdate.consent_version' and its values cannot be restored.")
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 19, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 19, 0, 0)'}),
