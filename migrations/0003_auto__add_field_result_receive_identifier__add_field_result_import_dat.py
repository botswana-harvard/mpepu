...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bhp_lab_core_result', 'receive_identifier')

        # Deleting field 'Result.import_datetime'
        db.delete_column('bhp_lab_core_result', 'import_datetime')

        # Deleting field 'Result.subject_identifier'
        db.delete_column('bhp_lab_core_result', 'subject_identifier')
