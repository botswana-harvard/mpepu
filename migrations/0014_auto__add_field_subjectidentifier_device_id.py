...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectIdentifier.device_id'
        db.add_column('bhp_identifier_subjectidentifier', 'device_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectIdentifier.device_id'
        db.delete_column('bhp_identifier_subjectidentifier', 'device_id')
