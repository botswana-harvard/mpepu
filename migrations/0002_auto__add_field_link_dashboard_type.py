...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Link.dashboard_type'
        db.add_column('bhp_subject_summary_link', 'dashboard_type', self.gf('django.db.models.fields.CharField')(default='infant', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Link.dashboard_type'
        db.delete_column('bhp_subject_summary_link', 'dashboard_type')
