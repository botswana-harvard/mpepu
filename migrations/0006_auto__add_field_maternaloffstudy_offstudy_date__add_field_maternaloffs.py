...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaternalOffStudy.offstudy_date'
        db.add_column('mpepu_maternal_maternaloffstudy', 'offstudy_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(1900, 1, 1)), keep_default=False)

        # Adding field 'MaternalOffStudy.reason_other'
        db.add_column('mpepu_maternal_maternaloffstudy', 'reason_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'MaternalOffStudy.comment'
        db.alter_column('mpepu_maternal_maternaloffstudy', 'comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))

        # Adding field 'MaternalOffStudyAudit.offstudy_date'
        db.add_column('mpepu_maternal_maternaloffstudy_audit', 'offstudy_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(1900, 1, 1)), keep_default=False)

        # Adding field 'MaternalOffStudyAudit.reason_other'
        db.add_column('mpepu_maternal_maternaloffstudy_audit', 'reason_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'MaternalOffStudyAudit.comment'
        db.alter_column('mpepu_maternal_maternaloffstudy_audit', 'comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))


    def backwards(self, orm):
        
        # Deleting field 'MaternalOffStudy.offstudy_date'
        db.delete_column('mpepu_maternal_maternaloffstudy', 'offstudy_date')

        # Deleting field 'MaternalOffStudy.reason_other'
        db.delete_column('mpepu_maternal_maternaloffstudy', 'reason_other')

        # User chose to not deal with backwards NULL issues for 'MaternalOffStudy.comment'
        raise RuntimeError("Cannot reverse this migration. 'MaternalOffStudy.comment' and its values cannot be restored.")

        # Deleting field 'MaternalOffStudyAudit.offstudy_date'
        db.delete_column('mpepu_maternal_maternaloffstudy_audit', 'offstudy_date')

        # Deleting field 'MaternalOffStudyAudit.reason_other'
        db.delete_column('mpepu_maternal_maternaloffstudy_audit', 'reason_other')

        # User chose to not deal with backwards NULL issues for 'MaternalOffStudyAudit.comment'
        raise RuntimeError("Cannot reverse this migration. 'MaternalOffStudyAudit.comment' and its values cannot be restored.")
