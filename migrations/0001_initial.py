...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_form_appointment', (
            ...
            ('visit_definition', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['bhp_visit.VisitDefinition'])),
        ...
        db.create_unique('bhp_form_appointment', ['registered_subject_id', 'visit_definition_id', 'visit_instance'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Appointment', fields ['registered_subject', 'visit_definition', 'visit_instance']
        db.delete_unique('bhp_form_appointment', ['registered_subject_id', 'visit_definition_id', 'visit_instance'])

        # Deleting model 'Appointment'
        db.delete_table('bhp_form_appointment')
