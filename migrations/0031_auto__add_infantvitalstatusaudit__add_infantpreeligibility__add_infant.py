...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfantPreEligibility'
        db.create_table('mpepu_infant_infantpreeligibility', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2, blank=True)),
            ('clinical_jaundice', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('anemia_neutropenia', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantPreEligibility'])

        # Adding model 'InfantPreEligibilityAudit'
        db.create_table('mpepu_infant_infantpreeligibility_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_infantpreeligibility', to=orm['bhp_registration.RegisteredSubject'])),
            ('infant_birth', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_infantpreeligibility', to=orm['mpepu_infant.InfantBirth'])),
        ))
        db.send_create_signal('mpepu_infant', ['InfantPreEligibilityAudit'])

        # Adding model 'InfantVitalStatus'
        db.create_table('mpepu_infant_infantvitalstatus', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'InfantPreEligibility'
        db.delete_table('mpepu_infant_infantpreeligibility')

        # Deleting model 'InfantPreEligibilityAudit'
        db.delete_table('mpepu_infant_infantpreeligibility_audit')

        # Deleting model 'InfantVitalStatus'
        db.delete_table('mpepu_infant_infantvitalstatus')
