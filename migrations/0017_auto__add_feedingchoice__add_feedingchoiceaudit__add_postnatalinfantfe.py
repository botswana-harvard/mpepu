...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedingChoice'
        db.create_table('mpepu_maternal_feedingchoice', (
            ...
            ('first_time_feeding', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ))
        db.send_create_signal('mpepu_maternal', ['FeedingChoice'])

        # Adding model 'FeedingChoiceAudit'
        db.create_table('mpepu_maternal_feedingchoice_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_feedingchoice', to=orm['mpepu_maternal.MaternalVisit'])),
            ('first_time_feeding', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ...
        db.send_create_signal('mpepu_maternal', ['FeedingChoiceAudit'])

        # Adding model 'PostNatalInfantFeedingSurveyAudit'
        db.create_table('mpepu_maternal_postnatalinfantfeedingsurvey_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_postnatalinfantfeedingsurvey', to=orm['mpepu_maternal.MaternalVisit'])),
            ('feeding_satisfaction', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('next_feeding_choice', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('feeding_period', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('feeding_duration', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('correct_bf_duration', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('mpepu_maternal', ['PostNatalInfantFeedingSurveyAudit'])

        # Adding model 'FeedingChoiceSectionOne'
        db.create_table('mpepu_maternal_feedingchoicesectionone', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_maternal.MaternalVisit'])),
            ('last_baby_feeding', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('baby_weaned_age', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('hiv_aware_feeding', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('hiv_status', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_maternal', ['FeedingChoiceSectionOne'])

        # Adding model 'FeedingChoiceSectionTwo'
        db.create_table('mpepu_maternal_feedingchoicesectiontwo', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_maternal.MaternalVisit'])),
            ('status_disclosure', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('disclose_hiv_father', self.gf('django.db.models.fields.IntegerField')(max_length=3)),
            ('outside_disclosure', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('work_influence', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('work_return', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('bf_hiv_worry', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('infant_hiv_risk', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('hiv_worry', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('death_worry', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('bf_hiv_arv', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('safe_ff', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('bf_ff_benefits', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('baby_bf_choice', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('doc_feeding_advice', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal('mpepu_maternal', ['FeedingChoiceSectionTwo'])

        # Adding M2M table for field influential_people on 'FeedingChoiceSectionTwo'
        db.create_table('mpepu_maternal_feedingchoicesectiontwo_influential_people', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feedingchoicesectiontwo', models.ForeignKey(orm['mpepu_maternal.feedingchoicesectiontwo'], null=False)),
            ('maternalfeedinginfluence', models.ForeignKey(orm['mpepu_list.maternalfeedinginfluence'], null=False))
        ))
        db.create_unique('mpepu_maternal_feedingchoicesectiontwo_influential_people', ['feedingchoicesectiontwo_id', 'maternalfeedinginfluence_id'])

        # Adding model 'PostNatalInfantFeedingSurvey'
        db.create_table('mpepu_maternal_postnatalinfantfeedingsurvey', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('mpepu_maternal', ['PostNatalInfantFeedingSurvey'])

        # Adding model 'FeedingChoiceSectionTwoAudit'
        db.create_table('mpepu_maternal_feedingchoicesectiontwo_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_feedingchoicesectiontwo', to=orm['mpepu_maternal.MaternalVisit'])),
            ('status_disclosure', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('disclose_hiv_father', self.gf('django.db.models.fields.IntegerField')(max_length=3)),
            ('outside_disclosure', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('work_influence', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ...
        db.send_create_signal('mpepu_maternal', ['FeedingChoiceSectionTwoAudit'])

        # Adding model 'FeedingChoiceSectionThree'
        db.create_table('mpepu_maternal_feedingchoicesectionthree', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_maternal.MaternalVisit'])),
            ('und_risk_benefit', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('ff_advice', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('bf_advice', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('feeding_choice_made', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('chosen_feeding_choice', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('mpepu_maternal', ['FeedingChoiceSectionThree'])

        # Adding M2M table for field risk_benefit_training on 'FeedingChoiceSectionThree'
        db.create_table('mpepu_maternal_feedingchoicesectionthree_risk_benefit_training', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feedingchoicesectionthree', models.ForeignKey(orm['mpepu_maternal.feedingchoicesectionthree'], null=False)),
            ('maternalbfffrisksbenefits', models.ForeignKey(orm['mpepu_list.maternalbfffrisksbenefits'], null=False))
        ))
        db.create_unique('mpepu_maternal_feedingchoicesectionthree_risk_benefit_training', ['feedingchoicesectionthree_id', 'maternalbfffrisksbenefits_id'])

        # Adding M2M table for field undecided_feeding on 'FeedingChoiceSectionThree'
        db.create_table('mpepu_maternal_feedingchoicesectionthree_undecided_feeding', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feedingchoicesectionthree', models.ForeignKey(orm['mpepu_maternal.feedingchoicesectionthree'], null=False)),
            ('maternalundecidedfeeding', models.ForeignKey(orm['mpepu_list.maternalundecidedfeeding'], null=False))
        ))
        db.create_unique('mpepu_maternal_feedingchoicesectionthree_undecided_feeding', ['feedingchoicesectionthree_id', 'maternalundecidedfeeding_id'])

        # Adding model 'FeedingChoiceSectionOneAudit'
        db.create_table('mpepu_maternal_feedingchoicesectionone_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_feedingchoicesectionone', to=orm['mpepu_maternal.MaternalVisit'])),
            ('last_baby_feeding', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('baby_weaned_age', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('hiv_aware_feeding', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('hiv_status', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
        ...
        db.send_create_signal('mpepu_maternal', ['FeedingChoiceSectionOneAudit'])

        # Adding model 'FeedingChoiceSectionThreeAudit'
        db.create_table('mpepu_maternal_feedingchoicesectionthree_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('_audit_subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_feedingchoicesectionthree', to=orm['mpepu_maternal.MaternalVisit'])),
            ('und_risk_benefit', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('ff_advice', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('bf_advice', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('feeding_choice_made', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ...
        db.send_create_signal('mpepu_maternal', ['FeedingChoiceSectionThreeAudit'])

        # Adding field 'MaternalConsentV2Audit.is_incarcerated'
        db.add_column('mpepu_maternal_maternalconsentv2_audit', 'is_incarcerated',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)

        # Adding field 'MaternalEligibilityPostAudit.is_cd4_low'
        db.add_column('mpepu_maternal_maternaleligibilitypost_audit', 'is_cd4_low',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityPostAudit.feeding_choice'
        db.add_column('mpepu_maternal_maternaleligibilitypost_audit', 'feeding_choice',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityPostAudit.maternal_haart'
        db.add_column('mpepu_maternal_maternaleligibilitypost_audit', 'maternal_haart',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'MaternalConsentV2.is_incarcerated'
        db.add_column('mpepu_maternal_maternalconsentv2', 'is_incarcerated',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)

        # Adding field 'MaternalEligibilityAnteAudit.is_cd4_low'
        db.add_column('mpepu_maternal_maternaleligibilityante_audit', 'is_cd4_low',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityAnteAudit.feeding_choice'
        db.add_column('mpepu_maternal_maternaleligibilityante_audit', 'feeding_choice',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityAnteAudit.maternal_haart'
        db.add_column('mpepu_maternal_maternaleligibilityante_audit', 'maternal_haart',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityPost.is_cd4_low'
        db.add_column('mpepu_maternal_maternaleligibilitypost', 'is_cd4_low',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityPost.feeding_choice'
        db.add_column('mpepu_maternal_maternaleligibilitypost', 'feeding_choice',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityPost.maternal_haart'
        db.add_column('mpepu_maternal_maternaleligibilitypost', 'maternal_haart',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityAnte.is_cd4_low'
        db.add_column('mpepu_maternal_maternaleligibilityante', 'is_cd4_low',
                      self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityAnte.feeding_choice'
        db.add_column('mpepu_maternal_maternaleligibilityante', 'feeding_choice',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'MaternalEligibilityAnte.maternal_haart'
        db.add_column('mpepu_maternal_maternaleligibilityante', 'maternal_haart',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FeedingChoice'
        db.delete_table('mpepu_maternal_feedingchoice')

        # Deleting model 'FeedingChoiceAudit'
        db.delete_table('mpepu_maternal_feedingchoice_audit')

        # Deleting model 'PostNatalInfantFeedingSurveyAudit'
        db.delete_table('mpepu_maternal_postnatalinfantfeedingsurvey_audit')

        # Deleting model 'FeedingChoiceSectionOne'
        db.delete_table('mpepu_maternal_feedingchoicesectionone')

        # Deleting model 'FeedingChoiceSectionTwo'
        db.delete_table('mpepu_maternal_feedingchoicesectiontwo')

        # Removing M2M table for field influential_people on 'FeedingChoiceSectionTwo'
        db.delete_table('mpepu_maternal_feedingchoicesectiontwo_influential_people')

        # Deleting model 'PostNatalInfantFeedingSurvey'
        db.delete_table('mpepu_maternal_postnatalinfantfeedingsurvey')

        # Deleting model 'FeedingChoiceSectionTwoAudit'
        db.delete_table('mpepu_maternal_feedingchoicesectiontwo_audit')

        # Deleting model 'FeedingChoiceSectionThree'
        db.delete_table('mpepu_maternal_feedingchoicesectionthree')

        # Removing M2M table for field risk_benefit_training on 'FeedingChoiceSectionThree'
        db.delete_table('mpepu_maternal_feedingchoicesectionthree_risk_benefit_training')

        # Removing M2M table for field undecided_feeding on 'FeedingChoiceSectionThree'
        db.delete_table('mpepu_maternal_feedingchoicesectionthree_undecided_feeding')

        # Deleting model 'FeedingChoiceSectionOneAudit'
        db.delete_table('mpepu_maternal_feedingchoicesectionone_audit')

        # Deleting model 'FeedingChoiceSectionThreeAudit'
        db.delete_table('mpepu_maternal_feedingchoicesectionthree_audit')

        # Deleting field 'MaternalConsentV2Audit.is_incarcerated'
        db.delete_column('mpepu_maternal_maternalconsentv2_audit', 'is_incarcerated')

        # Deleting field 'MaternalEligibilityPostAudit.is_cd4_low'
        db.delete_column('mpepu_maternal_maternaleligibilitypost_audit', 'is_cd4_low')

        # Deleting field 'MaternalEligibilityPostAudit.feeding_choice'
        db.delete_column('mpepu_maternal_maternaleligibilitypost_audit', 'feeding_choice')

        # Deleting field 'MaternalEligibilityPostAudit.maternal_haart'
        db.delete_column('mpepu_maternal_maternaleligibilitypost_audit', 'maternal_haart')

        # Deleting field 'MaternalConsentV2.is_incarcerated'
        db.delete_column('mpepu_maternal_maternalconsentv2', 'is_incarcerated')

        # Deleting field 'MaternalEligibilityAnteAudit.is_cd4_low'
        db.delete_column('mpepu_maternal_maternaleligibilityante_audit', 'is_cd4_low')

        # Deleting field 'MaternalEligibilityAnteAudit.feeding_choice'
        db.delete_column('mpepu_maternal_maternaleligibilityante_audit', 'feeding_choice')

        # Deleting field 'MaternalEligibilityAnteAudit.maternal_haart'
        db.delete_column('mpepu_maternal_maternaleligibilityante_audit', 'maternal_haart')

        # Deleting field 'MaternalEligibilityPost.is_cd4_low'
        db.delete_column('mpepu_maternal_maternaleligibilitypost', 'is_cd4_low')

        # Deleting field 'MaternalEligibilityPost.feeding_choice'
        db.delete_column('mpepu_maternal_maternaleligibilitypost', 'feeding_choice')

        # Deleting field 'MaternalEligibilityPost.maternal_haart'
        db.delete_column('mpepu_maternal_maternaleligibilitypost', 'maternal_haart')

        # Deleting field 'MaternalEligibilityAnte.is_cd4_low'
        db.delete_column('mpepu_maternal_maternaleligibilityante', 'is_cd4_low')

        # Deleting field 'MaternalEligibilityAnte.feeding_choice'
        db.delete_column('mpepu_maternal_maternaleligibilityante', 'feeding_choice')

        # Deleting field 'MaternalEligibilityAnte.maternal_haart'
        db.delete_column('mpepu_maternal_maternaleligibilityante', 'maternal_haart')
    ...
    models = {
        ...
        'mpepu_maternal.feedingchoicesectiontwo': {
            ...
            'baby_bf_choice': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'bf_ff_benefits': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'bf_hiv_arv': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'bf_hiv_worry': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'death_worry': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'disclose_hiv_father': ('django.db.models.fields.IntegerField', [], {'max_length': '3'}),
            'doc_feeding_advice': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'hiv_worry': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'melissa'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'melissa'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'infant_hiv_risk': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            ...
            'safe_ff': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
        ...
        'mpepu_maternal.maternalconsentv2': {
            'Meta': {'object_name': 'MaternalConsentV2'},
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'confirm_identity': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True'}),
            'consent_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'mpepu_maternal.maternalconsentv2audit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'MaternalConsentV2Audit', 'db_table': "'mpepu_maternal_maternalconsentv2_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_subject_identifier': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'may_store_samples': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'study_site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_maternalconsentv2'", 'to': "orm['bhp_variables.StudySite']"}),
            'subject_identifier': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '36', 'null': 'True', 'blank': 'True'}),
            'subject_type': ('django.db.models.fields.CharField', [], {'default': "'undetermined'", 'max_length': '25', 'null': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        ...
        'mpepu_maternal.maternaleligibilityante': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'feeding_choice': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
            'gestational_age': ('django.db.models.fields.IntegerField', [], {}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'melissa'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'melissa'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'is_cd4_low': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True'}),
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 25, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 25, 0, 0)'}),
