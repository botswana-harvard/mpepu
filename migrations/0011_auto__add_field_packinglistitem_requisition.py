...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PackingListItem.requisition'
        db.add_column('mpepu_lab_packinglistitem', 'requisition', self.gf('django.db.models.fields.CharField')(max_length=35, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PackingListItem.requisition'
        db.delete_column('mpepu_lab_packinglistitem', 'requisition')
    ...
    models = {
        ...
        'bhp_registration.registeredsubject': {
            ...
            'salt': ('django.db.models.fields.CharField', [], {'default': "'{,9#w(sBs*qc'", 'max_length': '25'}),
        ...
        'mpepu_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 15, 52, 37, 337107)'}),
