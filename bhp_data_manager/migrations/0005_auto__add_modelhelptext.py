...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_data_manager_modelhelptext', (
            ...
            ('additional_comment', self.gf('django.db.models.fields.TextField')(max_length=500)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bhp_data_manager_modelhelptext')
