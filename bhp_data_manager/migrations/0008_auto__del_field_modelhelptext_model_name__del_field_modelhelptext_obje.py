...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ModelHelpText.model_name'
        db.delete_column('bhp_data_manager_modelhelptext', 'model_name')

        # Deleting field 'ModelHelpText.object_name'
        db.delete_column('bhp_data_manager_modelhelptext', 'object_name')

        # Adding field 'ModelHelpText.module_name'
        db.add_column('bhp_data_manager_modelhelptext', 'module_name',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ModelHelpText.model_name'
        raise RuntimeError("Cannot reverse this migration. 'ModelHelpText.model_name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ModelHelpText.object_name'
        raise RuntimeError("Cannot reverse this migration. 'ModelHelpText.object_name' and its values cannot be restored.")
        # Deleting field 'ModelHelpText.module_name'
        db.delete_column('bhp_data_manager_modelhelptext', 'module_name')
    ...
    models = {
        ...
        'bhp_data_manager.modelhelptext': {
            ...
            'trans_assistance': ('django.db.models.fields.TextField', [], {'max_length': '500'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
