...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_data_manager_comment', (
            ...
            ('comment_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 8, 9, 0, 0))),
            ('comment', self.gf('django.db.models.fields.TextField')(max_length=500)),
        ))
        db.send_create_signal('bhp_data_manager', ['Comment'])
    ...
    models = {
        'bhp_data_manager.comment': {
            ...
            'comment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 9, 0, 0)'}),
