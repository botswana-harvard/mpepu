...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantFuDxItems.grade'
        db.alter_column('mpepu_infant_infantfudxitems', 'grade', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'InfantFuDxItems.health_facility'
        db.alter_column('mpepu_infant_infantfudxitems', 'health_facility', self.gf('django.db.models.fields.CharField')(default='-', max_length=3))

        # Changing field 'InfantFuDxItems.fu_dx'
        db.alter_column('mpepu_infant_infantfudxitems', 'fu_dx', self.gf('django.db.models.fields.CharField')(default='-', max_length=150))

        # Changing field 'InfantFuDxItems.was_hosptalized'
        db.alter_column('mpepu_infant_infantfudxitems', 'was_hosptalized', self.gf('django.db.models.fields.CharField')(default='-', max_length=3))

        # Changing field 'InfantFuDxItemsAudit.grade'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'grade', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'InfantFuDxItemsAudit.health_facility'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'health_facility', self.gf('django.db.models.fields.CharField')(default='-', max_length=3))

        # Changing field 'InfantFuDxItemsAudit.fu_dx'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'fu_dx', self.gf('django.db.models.fields.CharField')(default='-', max_length=150))

        # Changing field 'InfantFuDxItemsAudit.was_hosptalized'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'was_hosptalized', self.gf('django.db.models.fields.CharField')(default='-', max_length=3))


    def backwards(self, orm):
        
        # Changing field 'InfantFuDxItems.grade'
        db.alter_column('mpepu_infant_infantfudxitems', 'grade', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'InfantFuDxItems.health_facility'
        db.alter_column('mpepu_infant_infantfudxitems', 'health_facility', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'InfantFuDxItems.fu_dx'
        db.alter_column('mpepu_infant_infantfudxitems', 'fu_dx', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'InfantFuDxItems.was_hosptalized'
        db.alter_column('mpepu_infant_infantfudxitems', 'was_hosptalized', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'InfantFuDxItemsAudit.grade'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'grade', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'InfantFuDxItemsAudit.health_facility'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'health_facility', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'InfantFuDxItemsAudit.fu_dx'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'fu_dx', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'InfantFuDxItemsAudit.was_hosptalized'
        db.alter_column('mpepu_infant_infantfudxitems_audit', 'was_hosptalized', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
    ...
    models = {
        ...
        'mpepu_infant.infantfudxitems': {
            ...
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'was_hosptalized': ('django.db.models.fields.CharField', [], {'max_length': '3'})
        },
