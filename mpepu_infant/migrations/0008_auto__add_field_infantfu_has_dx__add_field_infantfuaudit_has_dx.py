...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfantFu.has_dx'
        db.add_column('mpepu_infant_infantfu', 'has_dx', self.gf('django.db.models.fields.CharField')(default='?', max_length=25), keep_default=False)

        # Adding field 'InfantFuAudit.has_dx'
        db.add_column('mpepu_infant_infantfu_audit', 'has_dx', self.gf('django.db.models.fields.CharField')(default='?', max_length=25), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'InfantFu.has_dx'
        db.delete_column('mpepu_infant_infantfu', 'has_dx')

        # Deleting field 'InfantFuAudit.has_dx'
        db.delete_column('mpepu_infant_infantfu_audit', 'has_dx')
