...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InfantRandoDeferralAudit'
        db.create_table('mpepu_infant_infantrandodeferral_audit', (
            ...
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_infantrandodeferral', to=orm['bhp_registration.RegisteredSubject'])),
            ('infant_birth', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_infantrandodeferral', to=orm['mpepu_infant.InfantBirth'])),
        ))
        db.send_create_signal('mpepu_infant', ['InfantRandoDeferralAudit'])

        # Adding model 'InfantRandoDeferral'
        db.create_table('mpepu_infant_infantrandodeferral', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('mpepu_infant', ['InfantRandoDeferral'])


    def backwards(self, orm):
        # Deleting model 'InfantRandoDeferralAudit'
        db.delete_table('mpepu_infant_infantrandodeferral_audit')

        # Deleting model 'InfantRandoDeferral'
        db.delete_table('mpepu_infant_infantrandodeferral')
    ...
    models = {
        ...
        'mpepu_infant.infanteligibility': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'rando_bf_duration': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'randomization_site': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'registered_subject': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'unique': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'weight': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '2'})
        },
