...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InfantHivStatusAudit'
        db.create_table('mpepu_infant_infanthivstatus_audit', (
            ...
            ('infant_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_infanthivstatus', to=orm['mpepu_infant.InfantVisit'])),
            ('recent_hiv_result', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('recent_hiv_date', self.gf('django.db.models.fields.DateField')()),
            ('recent_hiv_date_est', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('test_place', self.gf('django.db.models.fields.TextField')(max_length=35)),
            ('result_record', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('date_first_pos', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('infant_haart', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('infant_haart_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal('mpepu_infant', ['InfantHivStatusAudit'])

        # Adding model 'InfantHivStatus'
        db.create_table('mpepu_infant_infanthivstatus', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('mpepu_infant', ['InfantHivStatus'])


    def backwards(self, orm):
        # Deleting model 'InfantHivStatusAudit'
        db.delete_table('mpepu_infant_infanthivstatus_audit')

        # Deleting model 'InfantHivStatus'
        db.delete_table('mpepu_infant_infanthivstatus')
