...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mpepu_infant_infantverbalautopsy', 'registered_subject_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bhp_registration.RegisteredSubject'], unique=True))

        # Adding unique constraint on 'InfantVerbalAutopsy', fields ['registered_subject']
        db.create_unique('mpepu_infant_infantverbalautopsy', ['registered_subject_id'])

        # Changing field 'InfantBirth.registered_subject'
        db.alter_column('mpepu_infant_infantbirth', 'registered_subject_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bhp_registration.RegisteredSubject'], unique=True))

        # Adding unique constraint on 'InfantBirth', fields ['registered_subject']
        db.create_unique('mpepu_infant_infantbirth', ['registered_subject_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'InfantBirth', fields ['registered_subject']
        db.delete_unique('mpepu_infant_infantbirth', ['registered_subject_id'])

        # Removing unique constraint on 'InfantVerbalAutopsy', fields ['registered_subject']
        db.delete_unique('mpepu_infant_infantverbalautopsy', ['registered_subject_id'])

        # Changing field 'InfantVerbalAutopsy.registered_subject'
        db.alter_column('mpepu_infant_infantverbalautopsy', 'registered_subject_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_registration.RegisteredSubject']))

        # Changing field 'InfantBirth.registered_subject'
        db.alter_column('mpepu_infant_infantbirth', 'registered_subject_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_registration.RegisteredSubject']))
    ...
    models = {
        ...
        'mpepu_infant.infantfudxitems': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'fu_dx': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True'}),
            'fu_dx_specify': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'grade': ('django.db.models.fields.IntegerField', [], {'max_length': '3', 'null': 'True'}),
            'health_facility': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            ...
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'was_hosptalized': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'})
        },
