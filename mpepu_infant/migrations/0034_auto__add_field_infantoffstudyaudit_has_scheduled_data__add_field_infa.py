...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfantOffStudyAudit.has_scheduled_data'
        db.add_column('mpepu_infant_infantoffstudy_audit', 'has_scheduled_data',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)

        # Adding field 'InfantOffStudy.has_scheduled_data'
        db.add_column('mpepu_infant_infantoffstudy', 'has_scheduled_data',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfantOffStudyAudit.has_scheduled_data'
        db.delete_column('mpepu_infant_infantoffstudy_audit', 'has_scheduled_data')

        # Deleting field 'InfantOffStudy.has_scheduled_data'
        db.delete_column('mpepu_infant_infantoffstudy', 'has_scheduled_data')
