...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfantRandoDeferralAudit.clinical_jaundice'
        db.add_column('mpepu_infant_infantrandodeferral_audit', 'clinical_jaundice',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=3),
                      keep_default=False)

        # Adding field 'InfantRandoDeferralAudit.anemia_neutropenia'
        db.add_column('mpepu_infant_infantrandodeferral_audit', 'anemia_neutropenia',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=3),
                      keep_default=False)

        # Adding field 'InfantEligibility.clinical_jaundice'
        db.add_column('mpepu_infant_infanteligibility', 'clinical_jaundice',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InfantEligibility.anemia_neutropenia'
        db.add_column('mpepu_infant_infanteligibility', 'anemia_neutropenia',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InfantRandoDeferral.clinical_jaundice'
        db.add_column('mpepu_infant_infantrandodeferral', 'clinical_jaundice',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=3),
                      keep_default=False)

        # Adding field 'InfantRandoDeferral.anemia_neutropenia'
        db.add_column('mpepu_infant_infantrandodeferral', 'anemia_neutropenia',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=3),
                      keep_default=False)

        # Adding field 'InfantEligibilityAudit.clinical_jaundice'
        db.add_column('mpepu_infant_infanteligibility_audit', 'clinical_jaundice',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InfantEligibilityAudit.anemia_neutropenia'
        db.add_column('mpepu_infant_infanteligibility_audit', 'anemia_neutropenia',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfantRandoDeferralAudit.clinical_jaundice'
        db.delete_column('mpepu_infant_infantrandodeferral_audit', 'clinical_jaundice')

        # Deleting field 'InfantRandoDeferralAudit.anemia_neutropenia'
        db.delete_column('mpepu_infant_infantrandodeferral_audit', 'anemia_neutropenia')

        # Deleting field 'InfantEligibility.clinical_jaundice'
        db.delete_column('mpepu_infant_infanteligibility', 'clinical_jaundice')

        # Deleting field 'InfantEligibility.anemia_neutropenia'
        db.delete_column('mpepu_infant_infanteligibility', 'anemia_neutropenia')

        # Deleting field 'InfantRandoDeferral.clinical_jaundice'
        db.delete_column('mpepu_infant_infantrandodeferral', 'clinical_jaundice')

        # Deleting field 'InfantRandoDeferral.anemia_neutropenia'
        db.delete_column('mpepu_infant_infantrandodeferral', 'anemia_neutropenia')

        # Deleting field 'InfantEligibilityAudit.clinical_jaundice'
        db.delete_column('mpepu_infant_infanteligibility_audit', 'clinical_jaundice')

        # Deleting field 'InfantEligibilityAudit.anemia_neutropenia'
        db.delete_column('mpepu_infant_infanteligibility_audit', 'anemia_neutropenia')
