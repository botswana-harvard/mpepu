...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfantFuDxAudit.has_dx'
        db.delete_column('mpepu_infant_infantfudx_audit', 'has_dx')

        # Deleting field 'InfantFuDx.has_dx'
        db.delete_column('mpepu_infant_infantfudx', 'has_dx')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InfantFuDxAudit.has_dx'
        raise RuntimeError("Cannot reverse this migration. 'InfantFuDxAudit.has_dx' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'InfantFuDx.has_dx'
        raise RuntimeError("Cannot reverse this migration. 'InfantFuDx.has_dx' and its values cannot be restored.")
