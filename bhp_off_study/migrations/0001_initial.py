...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_off_study_testoffstudy', (
        ...
        db.send_create_signal('bhp_off_study', ['TestOffStudy'])


    def backwards(self, orm):
        # Deleting model 'TestOffStudy'
        db.delete_table('bhp_off_study_testoffstudy')


    models = {
        'bhp_off_study.testoffstudy': {
