...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudySpecific.machine_type'
        db.add_column('bhp_variables_studyspecific', 'machine_type', self.gf('django.db.models.fields.CharField')(default='NETBOOK', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StudySpecific.machine_type'
        db.delete_column('bhp_variables_studyspecific', 'machine_type')
    ...
    models = {
        ...
        'bhp_variables.studyspecific': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'machine_type': ('django.db.models.fields.CharField', [], {'default': "'NETBOOK'", 'max_length': '25'}),
