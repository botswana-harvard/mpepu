...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lab.order_identifier'
        db.add_column('mpepu_dashboard_lab', 'order_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lab.order_identifier'
        db.delete_column('mpepu_dashboard_lab', 'order_identifier')
