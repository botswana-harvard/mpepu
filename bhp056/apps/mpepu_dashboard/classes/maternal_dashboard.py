...
class MaternalDashboard(RegisteredSubjectDashboard):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs.update({'dashboard_models': {'maternal_consent': MaternalConsent}, 'membership_form_category': ['maternal_eligible_antenat', 'maternal_eligible_postnat', 'maternal_postnatal_reg', 'maternal_resistance']})
