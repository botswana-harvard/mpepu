...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfantRequisition.is_receive'
        db.add_column('mpepu_lab_infantrequisition', 'is_receive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'InfantRequisition.is_receive_datetime'
        db.add_column('mpepu_lab_infantrequisition', 'is_receive_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfantRequisition.is_packed'
        db.add_column('mpepu_lab_infantrequisition', 'is_packed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'InfantRequisition.is_labelled'
        db.add_column('mpepu_lab_infantrequisition', 'is_labelled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'InfantRequisition.is_labelled_datetime'
        db.add_column('mpepu_lab_infantrequisition', 'is_labelled_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfantRequisition.is_lis'
        db.add_column('mpepu_lab_infantrequisition', 'is_lis', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        # Adding field 'InfantRequisitionAudit.is_receive'
        db.add_column('mpepu_lab_infantrequisition_audit', 'is_receive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'InfantRequisitionAudit.is_receive_datetime'
        db.add_column('mpepu_lab_infantrequisition_audit', 'is_receive_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfantRequisitionAudit.is_packed'
        db.add_column('mpepu_lab_infantrequisition_audit', 'is_packed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'InfantRequisitionAudit.is_labelled'
        db.add_column('mpepu_lab_infantrequisition_audit', 'is_labelled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'InfantRequisitionAudit.is_labelled_datetime'
        db.add_column('mpepu_lab_infantrequisition_audit', 'is_labelled_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfantRequisitionAudit.is_lis'
        db.add_column('mpepu_lab_infantrequisition_audit', 'is_lis', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        # Adding field 'MaternalRequisitionAudit.is_receive'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'is_receive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MaternalRequisitionAudit.is_receive_datetime'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'is_receive_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'MaternalRequisitionAudit.is_packed'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'is_packed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MaternalRequisitionAudit.is_labelled'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'is_labelled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MaternalRequisitionAudit.is_labelled_datetime'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'is_labelled_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'MaternalRequisitionAudit.is_lis'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'is_lis', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        ...
        # Adding field 'MaternalRequisition.is_receive'
        db.add_column('mpepu_lab_maternalrequisition', 'is_receive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MaternalRequisition.is_receive_datetime'
        db.add_column('mpepu_lab_maternalrequisition', 'is_receive_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'MaternalRequisition.is_packed'
        db.add_column('mpepu_lab_maternalrequisition', 'is_packed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MaternalRequisition.is_labelled'
        db.add_column('mpepu_lab_maternalrequisition', 'is_labelled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MaternalRequisition.is_labelled_datetime'
        db.add_column('mpepu_lab_maternalrequisition', 'is_labelled_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'MaternalRequisition.is_lis'
        db.add_column('mpepu_lab_maternalrequisition', 'is_lis', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InfantRequisition.is_receive'
        db.delete_column('mpepu_lab_infantrequisition', 'is_receive')

        # Deleting field 'InfantRequisition.is_receive_datetime'
        db.delete_column('mpepu_lab_infantrequisition', 'is_receive_datetime')

        # Deleting field 'InfantRequisition.is_packed'
        db.delete_column('mpepu_lab_infantrequisition', 'is_packed')

        # Deleting field 'InfantRequisition.is_labelled'
        db.delete_column('mpepu_lab_infantrequisition', 'is_labelled')

        # Deleting field 'InfantRequisition.is_labelled_datetime'
        db.delete_column('mpepu_lab_infantrequisition', 'is_labelled_datetime')

        # Deleting field 'InfantRequisition.is_lis'
        db.delete_column('mpepu_lab_infantrequisition', 'is_lis')

        # Deleting field 'InfantRequisition.packing_list'
        db.delete_column('mpepu_lab_infantrequisition', 'packing_list_id')

        # Deleting field 'InfantRequisitionAudit.is_receive'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'is_receive')

        # Deleting field 'InfantRequisitionAudit.is_receive_datetime'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'is_receive_datetime')

        # Deleting field 'InfantRequisitionAudit.is_packed'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'is_packed')

        # Deleting field 'InfantRequisitionAudit.is_labelled'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'is_labelled')

        # Deleting field 'InfantRequisitionAudit.is_labelled_datetime'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'is_labelled_datetime')

        # Deleting field 'InfantRequisitionAudit.is_lis'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'is_lis')

        # Deleting field 'InfantRequisitionAudit.packing_list'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'packing_list_id')

        # Deleting field 'MaternalRequisitionAudit.is_receive'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'is_receive')

        # Deleting field 'MaternalRequisitionAudit.is_receive_datetime'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'is_receive_datetime')

        # Deleting field 'MaternalRequisitionAudit.is_packed'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'is_packed')

        # Deleting field 'MaternalRequisitionAudit.is_labelled'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'is_labelled')

        # Deleting field 'MaternalRequisitionAudit.is_labelled_datetime'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'is_labelled_datetime')

        # Deleting field 'MaternalRequisitionAudit.is_lis'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'is_lis')

        # Deleting field 'MaternalRequisitionAudit.packing_list'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'packing_list_id')

        # Deleting field 'MaternalRequisition.is_receive'
        db.delete_column('mpepu_lab_maternalrequisition', 'is_receive')

        # Deleting field 'MaternalRequisition.is_receive_datetime'
        db.delete_column('mpepu_lab_maternalrequisition', 'is_receive_datetime')

        # Deleting field 'MaternalRequisition.is_packed'
        db.delete_column('mpepu_lab_maternalrequisition', 'is_packed')

        # Deleting field 'MaternalRequisition.is_labelled'
        db.delete_column('mpepu_lab_maternalrequisition', 'is_labelled')

        # Deleting field 'MaternalRequisition.is_labelled_datetime'
        db.delete_column('mpepu_lab_maternalrequisition', 'is_labelled_datetime')

        # Deleting field 'MaternalRequisition.is_lis'
        db.delete_column('mpepu_lab_maternalrequisition', 'is_lis')
    ...
    models = {
        ...
        'lab_packing.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 10, 7, 8, 28, 517171)'}),
        ...
        'mpepu_lab.infantrequisition': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'packing_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lab_packing.PackingList']", 'null': 'True'}),
        ...
        'mpepu_lab.infantrequisitionaudit': {
            ...
            'item_type': ('django.db.models.fields.CharField', [], {'default': "'tube'", 'max_length': '25'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'packing_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_infantrequisition'", 'null': 'True', 'to': "orm['lab_packing.PackingList']"}),
        ...
        'mpepu_lab.maternalrequisitionaudit': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'packing_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_maternalrequisition'", 'null': 'True', 'to': "orm['lab_packing.PackingList']"}),
