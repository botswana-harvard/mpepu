...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'InfantRequisition', fields ['specimen_identifier']
        db.create_unique('mpepu_lab_infantrequisition', ['specimen_identifier'])

        # Changing field 'InfantRequisition.clinician_initials'
        db.alter_column('mpepu_lab_infantrequisition', 'clinician_initials', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'InfantRequisitionAudit.clinician_initials'
        db.alter_column('mpepu_lab_infantrequisition_audit', 'clinician_initials', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'MaternalRequisitionAudit.clinician_initials'
        db.alter_column('mpepu_lab_maternalrequisition_audit', 'clinician_initials', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Adding unique constraint on 'MaternalRequisition', fields ['specimen_identifier']
        db.create_unique('mpepu_lab_maternalrequisition', ['specimen_identifier'])

        # Changing field 'MaternalRequisition.clinician_initials'
        db.alter_column('mpepu_lab_maternalrequisition', 'clinician_initials', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))


    def backwards(self, orm):
        
        # Removing unique constraint on 'MaternalRequisition', fields ['specimen_identifier']
        db.delete_unique('mpepu_lab_maternalrequisition', ['specimen_identifier'])

        # Removing unique constraint on 'InfantRequisition', fields ['specimen_identifier']
        db.delete_unique('mpepu_lab_infantrequisition', ['specimen_identifier'])

        # User chose to not deal with backwards NULL issues for 'InfantRequisition.clinician_initials'
        raise RuntimeError("Cannot reverse this migration. 'InfantRequisition.clinician_initials' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'InfantRequisitionAudit.clinician_initials'
        raise RuntimeError("Cannot reverse this migration. 'InfantRequisitionAudit.clinician_initials' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MaternalRequisitionAudit.clinician_initials'
        raise RuntimeError("Cannot reverse this migration. 'MaternalRequisitionAudit.clinician_initials' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MaternalRequisition.clinician_initials'
        raise RuntimeError("Cannot reverse this migration. 'MaternalRequisition.clinician_initials' and its values cannot be restored.")
    ...
    models = {
        ...
        'lab_packing.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 15, 9, 38, 7, 617326)'}),
