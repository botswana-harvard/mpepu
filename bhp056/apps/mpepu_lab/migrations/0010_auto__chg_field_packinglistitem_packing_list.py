...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mpepu_lab_packinglistitem', 'packing_list_id', self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['mpepu_lab.PackingList']))


    def backwards(self, orm):
        
        # Changing field 'PackingListItem.packing_list'
        db.alter_column('mpepu_lab_packinglistitem', 'packing_list_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_lab.PackingList'], null=True))
    ...
    models = {
        ...
        'mpepu_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 17, 15, 25, 56, 454447)'}),
