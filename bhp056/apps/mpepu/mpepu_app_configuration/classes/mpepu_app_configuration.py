...
class MpepuAppConfiguration(BaseAppConfiguration):
    ...
    global_configuration = {'dashboard': {'show_not_required_metadata': False, 'allow_additional_requisitions': True, 'show_drop_down_requisitions': True, 'show_drop_down_entries': True},
