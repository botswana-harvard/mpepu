...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArvResistanceConsent.confirm_identity'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent', 'confirm_identity')

        # Deleting field 'ArvResistanceConsent.consent_reviewed'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent', 'consent_reviewed')

        # Deleting field 'ArvResistanceConsent.assessment_score'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent', 'assessment_score')

        # Deleting field 'ArvResistanceConsent.consent_copy'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent', 'consent_copy')

        # Deleting field 'ArvResistanceConsent.identity'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent', 'identity')

        # Deleting field 'ArvResistanceConsent.identity_type'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent', 'identity_type')

        # Deleting field 'ArvResistanceConsent.study_questions'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent', 'study_questions')

        # Deleting field 'ArvResistanceConsentAudit.confirm_identity'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'confirm_identity')

        # Deleting field 'ArvResistanceConsentAudit.consent_reviewed'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'consent_reviewed')

        # Deleting field 'ArvResistanceConsentAudit.assessment_score'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'assessment_score')

        # Deleting field 'ArvResistanceConsentAudit.consent_copy'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'consent_copy')

        # Deleting field 'ArvResistanceConsentAudit.identity'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'identity')

        # Deleting field 'ArvResistanceConsentAudit.identity_type'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'identity_type')

        # Deleting field 'ArvResistanceConsentAudit.study_questions'
        db.delete_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'study_questions')


    def backwards(self, orm):
        # Adding field 'ArvResistanceConsent.confirm_identity'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent', 'confirm_identity',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsent.consent_reviewed'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent', 'consent_reviewed',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsent.assessment_score'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent', 'assessment_score',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsent.consent_copy'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent', 'consent_copy',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsent.identity'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent', 'identity',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=78L, unique=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsent.identity_type'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent', 'identity_type',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)

        # Adding field 'ArvResistanceConsent.study_questions'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent', 'study_questions',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsentAudit.confirm_identity'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'confirm_identity',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsentAudit.consent_reviewed'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'consent_reviewed',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsentAudit.assessment_score'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'assessment_score',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsentAudit.consent_copy'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'consent_copy',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'ArvResistanceConsentAudit.identity'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'identity',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=78L),
                      keep_default=False)

        # Adding field 'ArvResistanceConsentAudit.identity_type'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'identity_type',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)

        # Adding field 'ArvResistanceConsentAudit.study_questions'
        db.add_column(u'mpepu_arv_resistance_arvresistanceconsent_audit', 'study_questions',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'mpepu_arv_resistance.arvresistanceconsent': {
            'Meta': {'object_name': 'ArvResistanceConsent'},
        ...
        'mpepu_arv_resistance.arvresistanceconsentaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'ArvResistanceConsentAudit', 'db_table': "u'mpepu_arv_resistance_arvresistanceconsent_audit'"},
            ...
            'may_store_samples': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_arvresistanceconsent'", 'null': 'True', 'to': "orm['registration.RegisteredSubject']"}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'study_site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_arvresistanceconsent'", 'null': 'True', 'to': "orm['bhp_variables.StudySite']"}),
        ...
        'mpepu_arv_resistance.arvresistancediscontinuation': {
            'Meta': {'object_name': 'ArvResistanceDiscontinuation'},
        ...
        'mpepu_arv_resistance.arvresistancediscontinuationaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'ArvResistanceDiscontinuationAudit', 'db_table': "u'mpepu_arv_resistance_arvresistancediscontinuation_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'as_prescribed': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'last_ftc_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'last_tdf_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'maternal_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_arvresistancediscontinuation'", 'to': "orm['mpepu_maternal.MaternalVisit']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'regimen': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
        ...
        'mpepu_arv_resistance.arvresistanceeligibility': {
            'Meta': {'object_name': 'ArvResistanceEligibility'},
        ...
        'mpepu_arv_resistance.arvresistanceeligibilityaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'ArvResistanceEligibilityAudit', 'db_table': "u'mpepu_arv_resistance_arvresistanceeligibility_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'co_enrolled': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            ...
            'incarcerated': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'lates_cd4': ('django.db.models.fields.IntegerField', [], {'max_length': '4'}),
            'maternal_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_arvresistanceeligibility'", 'to': "orm['mpepu_maternal.MaternalVisit']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'status_evidence': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
    ...
    complete_apps = ['mpepu_arv_resistance']