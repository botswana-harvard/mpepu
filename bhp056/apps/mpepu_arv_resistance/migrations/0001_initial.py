...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mpepu_arv_resistance_arvresistanceconsent_audit', (
        ...
        db.send_create_signal('mpepu_arv_resistance', ['ArvResistanceConsentAudit'])

        # Adding model 'ArvResistanceConsent'
        db.create_table(u'mpepu_arv_resistance_arvresistanceconsent', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('mpepu_arv_resistance', ['ArvResistanceConsent'])

        # Adding model 'ArvResistanceEligibilityAudit'
        db.create_table(u'mpepu_arv_resistance_arvresistanceeligibility_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='silverapple', max_length=50, db_index=True, blank=True)),
            ('revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 12, 0, 0))),
        ...
        db.send_create_signal('mpepu_arv_resistance', ['ArvResistanceEligibilityAudit'])

        # Adding model 'ArvResistanceEligibility'
        db.create_table(u'mpepu_arv_resistance_arvresistanceeligibility', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('mpepu_arv_resistance', ['ArvResistanceEligibility'])

        # Adding model 'ArvResistanceDiscontinuationAudit'
        db.create_table(u'mpepu_arv_resistance_arvresistancediscontinuation_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_arvresistancediscontinuation', to=orm['mpepu_maternal.MaternalVisit'])),
        ))
        db.send_create_signal('mpepu_arv_resistance', ['ArvResistanceDiscontinuationAudit'])

        # Adding model 'ArvResistanceDiscontinuation'
        db.create_table(u'mpepu_arv_resistance_arvresistancediscontinuation', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('mpepu_arv_resistance', ['ArvResistanceDiscontinuation'])


    def backwards(self, orm):
        # Deleting model 'ArvResistanceConsentAudit'
        db.delete_table(u'mpepu_arv_resistance_arvresistanceconsent_audit')

        # Deleting model 'ArvResistanceConsent'
        db.delete_table(u'mpepu_arv_resistance_arvresistanceconsent')

        # Deleting model 'ArvResistanceEligibilityAudit'
        db.delete_table(u'mpepu_arv_resistance_arvresistanceeligibility_audit')

        # Deleting model 'ArvResistanceEligibility'
        db.delete_table(u'mpepu_arv_resistance_arvresistanceeligibility')

        # Deleting model 'ArvResistanceDiscontinuationAudit'
        db.delete_table(u'mpepu_arv_resistance_arvresistancediscontinuation_audit')

        # Deleting model 'ArvResistanceDiscontinuation'
        db.delete_table(u'mpepu_arv_resistance_arvresistancediscontinuation')
