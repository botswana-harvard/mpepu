...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Dispensing.identifier'
        raise RuntimeError("Cannot reverse this migration. 'Dispensing.identifier' and its values cannot be restored.")
