...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dispensing.registered_subject'
        db.add_column('ph_dispenser_dispensing', 'registered_subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_registration.RegisteredSubject'], null=True),
                      keep_default=False)


        # Changing field 'Dispensing.identifier'
        db.alter_column('ph_dispenser_dispensing', 'identifier', self.gf('django.db.models.fields.CharField')(default='-', max_length=25))
        # Adding field 'DispensingIdentifierModel.is_derived'
        db.add_column('ph_dispenser_dispensingidentifiermodel', 'is_derived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DispensingIdentifierModel.sequence_app_label'
        db.add_column('ph_dispenser_dispensingidentifiermodel', 'sequence_app_label',
                      self.gf('django.db.models.fields.CharField')(default='bhp_identifier', max_length=50),
                      keep_default=False)

        # Adding field 'DispensingIdentifierModel.sequence_model_name'
        db.add_column('ph_dispenser_dispensingidentifiermodel', 'sequence_model_name',
                      self.gf('django.db.models.fields.CharField')(default='sequence', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dispensing.registered_subject'
        db.delete_column('ph_dispenser_dispensing', 'registered_subject_id')


        # Changing field 'Dispensing.identifier'
        db.alter_column('ph_dispenser_dispensing', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Deleting field 'DispensingIdentifierModel.is_derived'
        db.delete_column('ph_dispenser_dispensingidentifiermodel', 'is_derived')

        # Deleting field 'DispensingIdentifierModel.sequence_app_label'
        db.delete_column('ph_dispenser_dispensingidentifiermodel', 'sequence_app_label')

        # Deleting field 'DispensingIdentifierModel.sequence_model_name'
        db.delete_column('ph_dispenser_dispensingidentifiermodel', 'sequence_model_name')
