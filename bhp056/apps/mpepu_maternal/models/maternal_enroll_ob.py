...
class MaternalEnrollOb(BaseScheduledVisitModel):
    ...
    live_children = models.IntegerField(
        verbose_name="How many other living children does the participant currently have (excluding baby to be enrolled in the study)",
        help_text="",
        )
    children_died_b4_5yrs = models.IntegerField(
        verbose_name="How many of the participant's children died after birth before 5 years of age? ",
        help_text="",
        )
