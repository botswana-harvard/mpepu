...
class FeedingChoiceSectionTwo(BaseScheduledVisitModel):
    ...
    disclose_hiv_father = models.CharField(
        verbose_name="I have disclosed my HIV status to the father of this baby: ",
        max_length=3,
        choices=YES_NO,
        help_text="",
        )
    ...
    influential_people = models.ManyToManyField(MaternalFeedingInfluence,
        verbose_name=("The individual(s) most influential in assisting me in making an "
    ...
    work_influence = models.CharField(
        verbose_name="My feeding choice will be influenced by my need to return to work: ",
        max_length=3,
        choices=YES_NO,
        help_text="",
        )
    ...
    bf_hiv_worry = models.CharField(
        verbose_name=("I am worried that my baby will become HIV infected if he/she "
                      " breastfeeds: "),
        max_length=35,
        choices=AGREEING_TERMS,
        )
    infant_hiv_risk = models.CharField(
        verbose_name=("I am worried that my infant is at risk for dying in the first two "
                      " years of their life:  "),
        max_length=35,
        choices=AGREEING_TERMS,
        )
    hiv_worry = models.CharField(
        verbose_name="I worry more about my baby getting HIV than about my baby dying: ",
        max_length=35,
        choices=AGREEING_TERMS,
        )
    death_worry = models.CharField(
        verbose_name="I worry more about my baby dying than about my baby getting HIV:",
        max_length=35,
        choices=AGREEING_TERMS,
        )
    bf_hiv_arv = models.CharField(
        verbose_name=("I feel I can breastfeed and still keep my baby from getting HIV by"
    ...
    bf_ff_benefits = models.CharField(
        verbose_name=("I understand the risks and benefits of breastfeeding and formula "
                      "feeding for my baby:"),
        max_length=35,
        choices=AGREEING_TERMS,
        )
    baby_bf_choice = models.CharField(
        verbose_name="I am the person who can make the best feeding choice for my baby: ",
        max_length=35,
        choices=AGREEING_TERMS,
        )
    doc_feeding_advice = models.CharField(
        verbose_name="A nurse or a doctor should tell me the best way to feed my baby:  ",
        max_length=35,
        choices=AGREEING_TERMS,
        )
