...
class PostNatalInfantFeedingSurvey(BaseScheduledVisitModel):
    ...
    feeding_period = models.CharField(
        verbose_name="2. Do you think your infant breastfed for the right number of months:",
        max_length=3,
        choices=YES_NO_FF,
        )
    feeding_duration = models.CharField(
        verbose_name="2a. If No to Q2 above, the duration of breastfeeding of my infant was:",
        max_length=3,
    ...
    correct_bf_duration = models.CharField(
        verbose_name=("3. What do you think the correct duration of breastfeeding should be"
    ...
    next_feeding_choice = models.CharField(
        verbose_name=("4. How do you think you will feed your next infant from birth through "
