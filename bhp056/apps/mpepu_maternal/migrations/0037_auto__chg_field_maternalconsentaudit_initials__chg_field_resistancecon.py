...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.alter_column(u'mpepu_maternal_maternalconsent_audit', 'initials', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ResistanceConsent.initials'
        db.alter_column(u'mpepu_maternal_resistanceconsent', 'initials', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'MaternalConsent.initials'
        # db.alter_column(u'mpepu_maternal_maternalconsent', 'initials', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ResistanceConsentAudit.initials'
        db.alter_column(u'mpepu_maternal_resistanceconsent_audit', 'initials', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'mpepu_maternal.feedingchoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 17, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_maternal.maternalconsent': {
            ...
            'initials': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 17, 0, 0)'}),
