...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MaternalConsent.registered_subject'
        db.alter_column(u'mpepu_maternal_maternalconsent', 'registered_subject_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['registration.RegisteredSubject'], unique=True, null=True))
        # Adding unique constraint on 'MaternalConsent', fields ['registered_subject']
        db.create_unique(u'mpepu_maternal_maternalconsent', ['registered_subject_id'])


    def backwards(self, orm):
	pass
        # Removing unique constraint on 'MaternalConsent', fields ['registered_subject']
        #db.delete_unique(u'mpepu_maternal_maternalconsent', ['registered_subject_id'])


        # Changing field 'MaternalConsent.registered_subject'
        #db.alter_column(u'mpepu_maternal_maternalconsent', 'registered_subject_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.RegisteredSubject'], null=True))
    ...
    models = {
        ...
        'mpepu_maternal.feedingchoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 8, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 8, 0, 0)'}),
