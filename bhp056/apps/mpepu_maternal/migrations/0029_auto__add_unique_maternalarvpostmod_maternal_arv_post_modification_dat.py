...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MaternalArvPostMod', fields ['maternal_arv_post', 'modification_date', 'arv_code']
        #db.create_unique('mpepu_maternal_maternalarvpostmod', ['maternal_arv_post_id', 'modification_date', 'arv_code'])


        # Changing field 'MaternalEnrollDx.diagnosis_year'
        db.alter_column('mpepu_maternal_maternalenrolldx', 'diagnosis_year', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'MaternalEnrollDx.diagnosis'
        db.alter_column('mpepu_maternal_maternalenrolldx', 'diagnosis', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))

        # Changing field 'MaternalEnrollDxAudit.diagnosis_year'
        db.alter_column('mpepu_maternal_maternalenrolldx_audit', 'diagnosis_year', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'MaternalEnrollDxAudit.diagnosis'
        db.alter_column('mpepu_maternal_maternalenrolldx_audit', 'diagnosis', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))

    def backwards(self, orm):
        # Removing unique constraint on 'MaternalArvPostMod', fields ['maternal_arv_post', 'modification_date', 'arv_code']
        db.delete_unique('mpepu_maternal_maternalarvpostmod', ['maternal_arv_post_id', 'modification_date', 'arv_code'])


        # Changing field 'MaternalEnrollDx.diagnosis_year'
        db.alter_column('mpepu_maternal_maternalenrolldx', 'diagnosis_year', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'MaternalEnrollDx.diagnosis'
        db.alter_column('mpepu_maternal_maternalenrolldx', 'diagnosis', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'MaternalEnrollDxAudit.diagnosis_year'
        db.alter_column('mpepu_maternal_maternalenrolldx_audit', 'diagnosis_year', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'MaternalEnrollDxAudit.diagnosis'
        db.alter_column('mpepu_maternal_maternalenrolldx_audit', 'diagnosis', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 14, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 14, 0, 0)'}),
