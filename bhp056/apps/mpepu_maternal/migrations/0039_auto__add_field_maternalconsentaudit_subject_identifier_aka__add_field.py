...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaternalConsentAudit.subject_identifier_aka'
        db.add_column(u'mpepu_maternal_maternalconsent_audit', 'subject_identifier_aka',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'MaternalConsentAudit.dm_comment'
        db.add_column(u'mpepu_maternal_maternalconsent_audit', 'dm_comment',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)

        # Adding field 'ResistanceConsent.subject_identifier_aka'
        db.add_column(u'mpepu_maternal_resistanceconsent', 'subject_identifier_aka',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'ResistanceConsent.dm_comment'
        db.add_column(u'mpepu_maternal_resistanceconsent', 'dm_comment',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)

        # Adding field 'MaternalConsent.subject_identifier_aka'
        db.add_column(u'mpepu_maternal_maternalconsent', 'subject_identifier_aka',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'MaternalConsent.dm_comment'
        db.add_column(u'mpepu_maternal_maternalconsent', 'dm_comment',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)

        # Adding field 'ResistanceConsentAudit.subject_identifier_aka'
        db.add_column(u'mpepu_maternal_resistanceconsent_audit', 'subject_identifier_aka',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'ResistanceConsentAudit.dm_comment'
        db.add_column(u'mpepu_maternal_resistanceconsent_audit', 'dm_comment',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        pass
        # Deleting field 'MaternalConsentAudit.subject_identifier_aka'
#         db.delete_column(u'mpepu_maternal_maternalconsent_audit', 'subject_identifier_aka')
# 
#         # Deleting field 'MaternalConsentAudit.dm_comment'
#         db.delete_column(u'mpepu_maternal_maternalconsent_audit', 'dm_comment')
# 
#         # Deleting field 'ResistanceConsent.subject_identifier_aka'
#         db.delete_column(u'mpepu_maternal_resistanceconsent', 'subject_identifier_aka')
# 
#         # Deleting field 'ResistanceConsent.dm_comment'
#         db.delete_column(u'mpepu_maternal_resistanceconsent', 'dm_comment')
# 
#         # Deleting field 'MaternalConsent.subject_identifier_aka'
#         db.delete_column(u'mpepu_maternal_maternalconsent', 'subject_identifier_aka')
# 
#         # Deleting field 'MaternalConsent.dm_comment'
#         db.delete_column(u'mpepu_maternal_maternalconsent', 'dm_comment')
# 
#         # Deleting field 'ResistanceConsentAudit.subject_identifier_aka'
#         db.delete_column(u'mpepu_maternal_resistanceconsent_audit', 'subject_identifier_aka')
# 
#         # Deleting field 'ResistanceConsentAudit.dm_comment'
#         db.delete_column(u'mpepu_maternal_resistanceconsent_audit', 'dm_comment')
    ...
    models = {
        ...
        'mpepu_maternal.feedingchoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
