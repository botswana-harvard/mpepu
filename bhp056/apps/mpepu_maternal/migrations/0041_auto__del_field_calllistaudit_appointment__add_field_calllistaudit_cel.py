...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CallListAudit.appointment'
        db.delete_column(u'mpepu_maternal_calllist_audit', 'appointment_id')

        # Adding field 'CallListAudit.cell'
        db.add_column(u'mpepu_maternal_calllist_audit', 'cell',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CallListAudit.alt_cell'
        db.add_column(u'mpepu_maternal_calllist_audit', 'alt_cell',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CallList.appointment'
        db.delete_column(u'mpepu_maternal_calllist', 'appointment_id')

        # Adding field 'CallList.cell'
        db.add_column(u'mpepu_maternal_calllist', 'cell',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CallList.alt_cell'
        db.add_column(u'mpepu_maternal_calllist', 'alt_cell',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'CallList', fields ['consent', 'label']
        db.create_unique(u'mpepu_maternal_calllist', ['consent_id', 'label'])


    def backwards(self, orm):
        # Removing unique constraint on 'CallList', fields ['consent', 'label']
        db.delete_unique(u'mpepu_maternal_calllist', ['consent_id', 'label'])

        # Adding field 'CallListAudit.appointment'
        db.add_column(u'mpepu_maternal_calllist_audit', 'appointment',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_calllist', null=True, to=orm['appointment.Appointment']),
                      keep_default=False)

        # Deleting field 'CallListAudit.cell'
        db.delete_column(u'mpepu_maternal_calllist_audit', 'cell')

        # Deleting field 'CallListAudit.alt_cell'
        db.delete_column(u'mpepu_maternal_calllist_audit', 'alt_cell')

        # Adding field 'CallList.appointment'
        db.add_column(u'mpepu_maternal_calllist', 'appointment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['appointment.Appointment'], null=True),
                      keep_default=False)

        # Deleting field 'CallList.cell'
        db.delete_column(u'mpepu_maternal_calllist', 'cell')

        # Deleting field 'CallList.alt_cell'
        db.delete_column(u'mpepu_maternal_calllist', 'alt_cell')
    ...
    models = {
        ...
        'mpepu_maternal.calllist': {
            'Meta': {'unique_together': "(['consent', 'label'],)", 'object_name': 'CallList'},
            'age_in_years': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'alt_cell': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            ...
            'cell': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
        ...
        'mpepu_maternal.feedingchoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)'}),
