...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaternalConsentAudit.is_verified'
        db.add_column('mpepu_maternal_maternalconsent_audit', 'is_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MaternalConsentAudit.is_verified_datetime'
        db.add_column('mpepu_maternal_maternalconsent_audit', 'is_verified_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'MaternalConsent.is_verified'
        db.add_column('mpepu_maternal_maternalconsent', 'is_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MaternalConsent.is_verified_datetime'
        db.add_column('mpepu_maternal_maternalconsent', 'is_verified_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MaternalConsentAudit.is_verified'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'is_verified')

        # Deleting field 'MaternalConsentAudit.is_verified_datetime'
        db.delete_column('mpepu_maternal_maternalconsent_audit', 'is_verified_datetime')

        # Deleting field 'MaternalConsent.is_verified'
        db.delete_column('mpepu_maternal_maternalconsent', 'is_verified')

        # Deleting field 'MaternalConsent.is_verified_datetime'
        db.delete_column('mpepu_maternal_maternalconsent', 'is_verified_datetime')
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 21, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 21, 0, 0)'}),
