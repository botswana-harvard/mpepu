...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MaternalLocator.maternal_visit'
        db.alter_column(u'mpepu_maternal_maternallocator', 'maternal_visit_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mpepu_maternal.MaternalVisit'], unique=True))
        # Adding unique constraint on 'MaternalLocator', fields ['maternal_visit']
        db.create_unique(u'mpepu_maternal_maternallocator', ['maternal_visit_id'])


    def backwards(self, orm):
        pass
        # Removing unique constraint on 'MaternalLocator', fields ['maternal_visit']
#         db.delete_unique(u'mpepu_maternal_maternallocator', ['maternal_visit_id'])
# 
# 
#         # Changing field 'MaternalLocator.maternal_visit'
#         db.alter_column(u'mpepu_maternal_maternallocator', 'maternal_visit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_maternal.MaternalVisit']))
    ...
    models = {
        ...
        'mpepu_maternal.feedingchoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 25, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 25, 0, 0)'}),
