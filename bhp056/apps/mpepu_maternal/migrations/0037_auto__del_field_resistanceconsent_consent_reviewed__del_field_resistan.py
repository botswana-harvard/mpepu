...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mpepu_maternal_resistanceconsent_audit', 'identity',
                      self.gf('django.db.models.fields.CharField')(max_length=78),)

        # Adding field 'MaternalConsentAudit.study_questions'
        db.add_column('mpepu_maternal_resistanceconsent_audit', 'identity_type',
                      self.gf('django.db.models.fields.CharField')(max_length=15,),)

        db.add_column('mpepu_maternal_resistanceconsent_audit', 'confirm_identity',
                      self.gf('django.db.models.fields.CharField')(max_length=78, null=True),)
    ...
    models = {
        ...
        'mpepu_maternal.feedingchoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 4, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 4, 0, 0)'}),
