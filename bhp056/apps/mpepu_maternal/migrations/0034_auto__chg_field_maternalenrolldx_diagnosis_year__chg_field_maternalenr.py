...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MaternalEnrollDx.diagnosis_year'
        db.alter_column(u'mpepu_maternal_maternalenrolldx', 'diagnosis_year', self.gf('django.db.models.fields.IntegerField')(default=2000))

        # Changing field 'MaternalEnrollDx.diagnosis'
        db.alter_column(u'mpepu_maternal_maternalenrolldx', 'diagnosis', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 11, 20, 0, 0), max_length=50))

        # Changing field 'MaternalEnrollDxAudit.diagnosis_year'
        db.alter_column(u'mpepu_maternal_maternalenrolldx_audit', 'diagnosis_year', self.gf('django.db.models.fields.IntegerField')(default=2000))

        # Changing field 'MaternalEnrollDxAudit.diagnosis'
        db.alter_column(u'mpepu_maternal_maternalenrolldx_audit', 'diagnosis', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))
    ...
    models = {
        ...
        'mpepu_maternal.feedingchoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)'}),
