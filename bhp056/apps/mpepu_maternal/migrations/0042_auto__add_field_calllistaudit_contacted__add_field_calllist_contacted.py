...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CallListAudit.contacted'
        db.add_column(u'mpepu_maternal_calllist_audit', 'contacted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CallList.contacted'
        db.add_column(u'mpepu_maternal_calllist', 'contacted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CallListAudit.contacted'
        db.delete_column(u'mpepu_maternal_calllist_audit', 'contacted')

        # Deleting field 'CallList.contacted'
        db.delete_column(u'mpepu_maternal_calllist', 'contacted')
