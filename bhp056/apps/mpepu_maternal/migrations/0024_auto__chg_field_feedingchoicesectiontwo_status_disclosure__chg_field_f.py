...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedingChoiceSectionTwo.status_disclosure'
        db.alter_column('mpepu_maternal_feedingchoicesectiontwo', 'status_disclosure', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'FeedingChoiceSectionTwo.outside_disclosure'
        db.alter_column('mpepu_maternal_feedingchoicesectiontwo', 'outside_disclosure', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'FeedingChoiceSectionTwoAudit.status_disclosure'
        db.alter_column('mpepu_maternal_feedingchoicesectiontwo_audit', 'status_disclosure', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'FeedingChoiceSectionTwoAudit.outside_disclosure'
        db.alter_column('mpepu_maternal_feedingchoicesectiontwo_audit', 'outside_disclosure', self.gf('django.db.models.fields.CharField')(max_length=45))

    def backwards(self, orm):

        # Changing field 'FeedingChoiceSectionTwo.status_disclosure'
        db.alter_column('mpepu_maternal_feedingchoicesectiontwo', 'status_disclosure', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'FeedingChoiceSectionTwo.outside_disclosure'
        db.alter_column('mpepu_maternal_feedingchoicesectiontwo', 'outside_disclosure', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'FeedingChoiceSectionTwoAudit.status_disclosure'
        db.alter_column('mpepu_maternal_feedingchoicesectiontwo_audit', 'status_disclosure', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'FeedingChoiceSectionTwoAudit.outside_disclosure'
        db.alter_column('mpepu_maternal_feedingchoicesectiontwo_audit', 'outside_disclosure', self.gf('django.db.models.fields.CharField')(max_length=35))
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 22, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 22, 0, 0)'}),
