...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MaternalDeathAudit.comment'
        db.alter_column('mpepu_maternal_maternaldeath_audit', 'comment', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

        # Changing field 'MaternalDeathAudit.death_reason_hospitalized'
        db.alter_column('mpepu_maternal_maternaldeath_audit', 'death_reason_hospitalized_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bhp_adverse.DeathReasonHospitalized']))

        # Changing field 'MaternalDeathAudit.death_cause'
        db.alter_column('mpepu_maternal_maternaldeath_audit', 'death_cause', self.gf('django.db.models.fields.TextField')(max_length=1000))

        # Changing field 'MaternalDeath.comment'
        db.alter_column('mpepu_maternal_maternaldeath', 'comment', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

        # Changing field 'MaternalDeath.death_reason_hospitalized'
        db.alter_column('mpepu_maternal_maternaldeath', 'death_reason_hospitalized_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_adverse.DeathReasonHospitalized'], null=True))

        # Changing field 'MaternalDeath.death_cause'
        db.alter_column('mpepu_maternal_maternaldeath', 'death_cause', self.gf('django.db.models.fields.TextField')(max_length=1000))

        # Changing field 'MaternalLocatorAudit.contact_physical_address'
        db.alter_column('mpepu_maternal_maternallocator_audit', 'contact_physical_address', self.gf('django.db.models.fields.TextField')(max_length=350))

        # Changing field 'MaternalLocatorAudit.physical_address'
        db.alter_column('mpepu_maternal_maternallocator_audit', 'physical_address', self.gf('django.db.models.fields.TextField')(max_length=350))

        # Changing field 'MaternalLocatorAudit.subject_work_place'
        db.alter_column('mpepu_maternal_maternallocator_audit', 'subject_work_place', self.gf('django.db.models.fields.TextField')(max_length=35, null=True))

        # Changing field 'MaternalLocator.contact_physical_address'
        db.alter_column('mpepu_maternal_maternallocator', 'contact_physical_address', self.gf('django.db.models.fields.TextField')(max_length=350))

        # Changing field 'MaternalLocator.physical_address'
        db.alter_column('mpepu_maternal_maternallocator', 'physical_address', self.gf('django.db.models.fields.TextField')(max_length=350))

        # Changing field 'MaternalLocator.subject_work_place'
        db.alter_column('mpepu_maternal_maternallocator', 'subject_work_place', self.gf('django.db.models.fields.TextField')(max_length=35, null=True))


    def backwards(self, orm):
        
        # Changing field 'MaternalDeathAudit.comment'
        db.alter_column('mpepu_maternal_maternaldeath_audit', 'comment', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # User chose to not deal with backwards NULL issues for 'MaternalDeathAudit.death_reason_hospitalized'
        raise RuntimeError("Cannot reverse this migration. 'MaternalDeathAudit.death_reason_hospitalized' and its values cannot be restored.")

        # Changing field 'MaternalDeathAudit.death_cause'
        db.alter_column('mpepu_maternal_maternaldeath_audit', 'death_cause', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'MaternalDeath.comment'
        db.alter_column('mpepu_maternal_maternaldeath', 'comment', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # User chose to not deal with backwards NULL issues for 'MaternalDeath.death_reason_hospitalized'
        raise RuntimeError("Cannot reverse this migration. 'MaternalDeath.death_reason_hospitalized' and its values cannot be restored.")

        # Changing field 'MaternalDeath.death_cause'
        db.alter_column('mpepu_maternal_maternaldeath', 'death_cause', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'MaternalLocatorAudit.contact_physical_address'
        db.alter_column('mpepu_maternal_maternallocator_audit', 'contact_physical_address', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'MaternalLocatorAudit.physical_address'
        db.alter_column('mpepu_maternal_maternallocator_audit', 'physical_address', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'MaternalLocatorAudit.subject_work_place'
        db.alter_column('mpepu_maternal_maternallocator_audit', 'subject_work_place', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'MaternalLocator.contact_physical_address'
        db.alter_column('mpepu_maternal_maternallocator', 'contact_physical_address', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'MaternalLocator.physical_address'
        db.alter_column('mpepu_maternal_maternallocator', 'physical_address', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'MaternalLocator.subject_work_place'
        db.alter_column('mpepu_maternal_maternallocator', 'subject_work_place', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))
    ...
    models = {
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'contact_physical_address': ('django.db.models.fields.TextField', [], {'max_length': '350'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'physical_address': ('django.db.models.fields.TextField', [], {'max_length': '350'}),
