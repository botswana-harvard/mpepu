...
#         db.create_table(u'mpepu_maternal_calllist_audit', (
#             ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
#             ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
#             ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
#             ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
#             ('hostname_created', self.gf('django.db.models.fields.CharField')(default='fchilisa.local', max_length=50, db_index=True, blank=True)),
#             ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='fchilisa.local', max_length=50, db_index=True, blank=True)),
...
#             ('consent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_calllist', to=orm['mpepu_maternal.MaternalConsent'])),
...
#             ('call_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
...
#             ('call_outcome', self.gf('django.db.models.fields.TextField')(max_length=150, null=True)),
...
#             ('appointment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_calllist', null=True, to=orm['appointment.Appointment'])),
...
#         ))
#         db.send_create_signal('mpepu_maternal', ['CallListAudit'])

        # Adding model 'CallList'
#         db.create_table(u'mpepu_maternal_calllist', (
#             ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
#             ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
#             ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
#             ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
...
#             ('revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
#             ('consent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_maternal.MaternalConsent'])),
#             ('site', self.gf('django.db.models.fields.CharField')(max_length=50)),
#             ('subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25)),
#             ('call_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
#             ('app_label', self.gf('django.db.models.fields.CharField')(max_length=25)),
...
#             ('call_status', self.gf('django.db.models.fields.CharField')(default='NEW', max_length=15)),
#             ('label', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
#             ('appointment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['appointment.Appointment'], null=True)),
#         ))
#         db.send_create_signal('mpepu_maternal', ['CallList'])


        # Changing field 'MaternalOffStudy.reason'
        db.alter_column(u'mpepu_maternal_maternaloffstudy', 'reason', self.gf('django.db.models.fields.CharField')(max_length=115))

        # Changing field 'MaternalOffStudyAudit.reason'
        db.alter_column(u'mpepu_maternal_maternaloffstudy_audit', 'reason', self.gf('django.db.models.fields.CharField')(max_length=115))

    def backwards(self, orm):
        pass
#         # Deleting model 'CallListAudit'
#         db.delete_table(u'mpepu_maternal_calllist_audit')
# 
#         # Deleting model 'CallList'
#         db.delete_table(u'mpepu_maternal_calllist')
# 
# 
#         # Changing field 'MaternalOffStudy.reason'
#         db.alter_column(u'mpepu_maternal_maternaloffstudy', 'reason', self.gf('django.db.models.fields.CharField')(max_length=30))
# 
#         # Changing field 'MaternalOffStudyAudit.reason'
#         db.alter_column(u'mpepu_maternal_maternaloffstudy_audit', 'reason', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        'adverse_event.deathcausecategory': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'fchilisa.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'fchilisa.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
        ...
        'mpepu_maternal.calllist': {
            ...
            'appointment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['appointment.Appointment']", 'null': 'True'}),
            ...
            'consent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mpepu_maternal.MaternalConsent']"}),
        ...
        'mpepu_maternal.calllistaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'CallListAudit', 'db_table': "u'mpepu_maternal_calllist_audit'"},
            ...
            'age_in_years': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'app_label': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'appointment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_calllist'", 'null': 'True', 'to': "orm['appointment.Appointment']"}),
            'call_attempts': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'call_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'call_outcome': ('django.db.models.fields.TextField', [], {'max_length': '150', 'null': 'True'}),
            'call_status': ('django.db.models.fields.CharField', [], {'default': "'NEW'", 'max_length': '15'}),
            'consent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_calllist'", 'to': "orm['mpepu_maternal.MaternalConsent']"}),
            'consent_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '78L'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
        ...
        'mpepu_maternal.feedingchoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 8, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_maternal.maternallocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 8, 0, 0)'}),
        ...
        'mpepu_maternal.maternaloffstudy': {
            ...
            'reason': ('django.db.models.fields.CharField', [], {'max_length': '115'}),
