...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MaternalOffStudy.offstudy_datetime'
        db.delete_column('mpepu_maternal_maternaloffstudy', 'offstudy_datetime')

        # Deleting field 'MaternalOffStudyAudit.offstudy_datetime'
        db.delete_column('mpepu_maternal_maternaloffstudy_audit', 'offstudy_datetime')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MaternalOffStudy.offstudy_datetime'
        raise RuntimeError("Cannot reverse this migration. 'MaternalOffStudy.offstudy_datetime' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MaternalOffStudyAudit.offstudy_datetime'
        raise RuntimeError("Cannot reverse this migration. 'MaternalOffStudyAudit.offstudy_datetime' and its values cannot be restored.")
