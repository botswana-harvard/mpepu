...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mpepu_maternal_maternalvisit', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(default='056-0000', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MaternalConsentAudit.study_site'
        db.alter_column(u'mpepu_maternal_maternalconsent_audit', 'study_site_id', self.gf('django.db.models.fields.related.ForeignKey')(default='study-sitie', to=orm['bhp_variables.StudySite']))
        ...
        # Changing field 'MaternalConsent.study_site'
        db.alter_column(u'mpepu_maternal_maternalconsent', 'study_site_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2013, 10, 30, 0, 0), to=orm['bhp_variables.StudySite']))
