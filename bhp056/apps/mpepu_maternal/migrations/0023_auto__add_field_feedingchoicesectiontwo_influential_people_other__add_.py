...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedingChoiceSectionTwo.influential_people_other'
        db.add_column('mpepu_maternal_feedingchoicesectiontwo', 'influential_people_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Adding field 'FeedingChoiceSectionTwoAudit.influential_people_other'
        db.add_column('mpepu_maternal_feedingchoicesectiontwo_audit', 'influential_people_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedingChoiceSectionTwo.influential_people_other'
        db.delete_column('mpepu_maternal_feedingchoicesectiontwo', 'influential_people_other')

        # Deleting field 'FeedingChoiceSectionTwoAudit.influential_people_other'
        db.delete_column('mpepu_maternal_feedingchoicesectiontwo_audit', 'influential_people_other')
