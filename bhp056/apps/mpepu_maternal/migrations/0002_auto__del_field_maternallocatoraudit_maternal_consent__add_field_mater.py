...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MaternalLocatorAudit.maternal_consent'
        db.delete_column('mpepu_maternal_maternallocator_audit', 'maternal_consent_id')

        # Adding field 'MaternalLocatorAudit.maternal_visit'
        db.add_column('mpepu_maternal_maternallocator_audit', 'maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='_audit_maternallocator', to=orm['mpepu_maternal.MaternalVisit']), keep_default=False)

        # Deleting field 'MaternalLocator.maternal_consent'
        db.delete_column('mpepu_maternal_maternallocator', 'maternal_consent_id')

        # Adding field 'MaternalLocator.maternal_visit'
        db.add_column('mpepu_maternal_maternallocator', 'maternal_visit', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mpepu_maternal.MaternalVisit']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MaternalLocatorAudit.maternal_consent'
        raise RuntimeError("Cannot reverse this migration. 'MaternalLocatorAudit.maternal_consent' and its values cannot be restored.")

        # Deleting field 'MaternalLocatorAudit.maternal_visit'
        db.delete_column('mpepu_maternal_maternallocator_audit', 'maternal_visit_id')

        # User chose to not deal with backwards NULL issues for 'MaternalLocator.maternal_consent'
        raise RuntimeError("Cannot reverse this migration. 'MaternalLocator.maternal_consent' and its values cannot be restored.")

        # Deleting field 'MaternalLocator.maternal_visit'
        db.delete_column('mpepu_maternal_maternallocator', 'maternal_visit_id')
