...
class InfantEligibilityTests(TestCase):
    ...
    def test_bf(self):
        ...
        print "assert that if hiv_status is Yes then infant is ineligible"
        self.assertRaisesMessage(ValidationError,'Randomization failed. Cannot determine subject_identifier from RegisteredSubject table. Contact the Data Manager.', InfantEligibilityFactory,infant_birth1, hiv_status='Yes')
#       