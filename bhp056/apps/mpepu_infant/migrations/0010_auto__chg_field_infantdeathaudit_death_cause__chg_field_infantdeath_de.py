...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'InfantDeathAudit.death_cause'
        db.alter_column('mpepu_infant_infantdeath_audit', 'death_cause', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'InfantDeath.death_cause'
        db.alter_column('mpepu_infant_infantdeath', 'death_cause', self.gf('django.db.models.fields.CharField')(max_length=35))
    ...
    models = {
        ...
        'mpepu_infant.infantdeath': {
            ...
            'death_cause': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
