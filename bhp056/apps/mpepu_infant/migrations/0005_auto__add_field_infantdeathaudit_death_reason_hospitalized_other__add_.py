...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfantDeathAudit.death_reason_hospitalized_other'
        db.add_column('mpepu_infant_infantdeath_audit', 'death_reason_hospitalized_other', self.gf('django.db.models.fields.TextField')(default=0, max_length=250), keep_default=False)

        # Adding field 'InfantDeathAudit.study_drug_relate'
        db.add_column('mpepu_infant_infantdeath_audit', 'study_drug_relate', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'InfantDeathAudit.infant_nvp_relate'
        db.add_column('mpepu_infant_infantdeath_audit', 'infant_nvp_relate', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'InfantDeathAudit.haart_relate'
        db.add_column('mpepu_infant_infantdeath_audit', 'haart_relate', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'InfantDeathAudit.trad_med_relate'
        db.add_column('mpepu_infant_infantdeath_audit', 'trad_med_relate', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'InfantDeath.death_reason_hospitalized_other'
        db.add_column('mpepu_infant_infantdeath', 'death_reason_hospitalized_other', self.gf('django.db.models.fields.TextField')(default=0, max_length=250), keep_default=False)

        # Adding field 'InfantDeath.study_drug_relate'
        db.add_column('mpepu_infant_infantdeath', 'study_drug_relate', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'InfantDeath.infant_nvp_relate'
        db.add_column('mpepu_infant_infantdeath', 'infant_nvp_relate', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'InfantDeath.haart_relate'
        db.add_column('mpepu_infant_infantdeath', 'haart_relate', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'InfantDeath.trad_med_relate'
        db.add_column('mpepu_infant_infantdeath', 'trad_med_relate', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InfantDeathAudit.death_reason_hospitalized_other'
        db.delete_column('mpepu_infant_infantdeath_audit', 'death_reason_hospitalized_other')

        # Deleting field 'InfantDeathAudit.study_drug_relate'
        db.delete_column('mpepu_infant_infantdeath_audit', 'study_drug_relate')

        # Deleting field 'InfantDeathAudit.infant_nvp_relate'
        db.delete_column('mpepu_infant_infantdeath_audit', 'infant_nvp_relate')

        # Deleting field 'InfantDeathAudit.haart_relate'
        db.delete_column('mpepu_infant_infantdeath_audit', 'haart_relate')

        # Deleting field 'InfantDeathAudit.trad_med_relate'
        db.delete_column('mpepu_infant_infantdeath_audit', 'trad_med_relate')

        # Deleting field 'InfantDeath.death_reason_hospitalized_other'
        db.delete_column('mpepu_infant_infantdeath', 'death_reason_hospitalized_other')

        # Deleting field 'InfantDeath.study_drug_relate'
        db.delete_column('mpepu_infant_infantdeath', 'study_drug_relate')

        # Deleting field 'InfantDeath.infant_nvp_relate'
        db.delete_column('mpepu_infant_infantdeath', 'infant_nvp_relate')

        # Deleting field 'InfantDeath.haart_relate'
        db.delete_column('mpepu_infant_infantdeath', 'haart_relate')

        # Deleting field 'InfantDeath.trad_med_relate'
        db.delete_column('mpepu_infant_infantdeath', 'trad_med_relate')
    ...
    models = {
        'bhp_adverse.deathcausecategory': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'s20.bhp.org.bw'", 'max_length': '50', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'s20.bhp.org.bw'", 'max_length': '50', 'blank': 'True'}),
        ...
        'mpepu_infant.infantdeath': {
            ...
            'death_reason_hospitalized_other': ('django.db.models.fields.TextField', [], {'max_length': '250'}),
