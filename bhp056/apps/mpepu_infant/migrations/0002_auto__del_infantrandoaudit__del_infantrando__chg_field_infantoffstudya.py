...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantOffStudyAudit.comment'
        db.alter_column('mpepu_infant_infantoffstudy_audit', 'comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))

        # Adding field 'InfantEligibilityAudit.hiv_result_reference'
        db.add_column('mpepu_infant_infanteligibility_audit', 'hiv_result_reference', self.gf('django.db.models.fields.CharField')(max_length=25, null=True), keep_default=False)

        # Changing field 'InfantOffStudy.comment'
        db.alter_column('mpepu_infant_infantoffstudy', 'comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))

        # Adding field 'InfantEligibility.hiv_result_reference'
        db.add_column('mpepu_infant_infanteligibility', 'hiv_result_reference', self.gf('django.db.models.fields.CharField')(max_length=25, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('mpepu_infant', ['InfantRandoAudit'])
        ...
        db.create_table('mpepu_infant_infantrando', (
            ...
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
            ('sid', self.gf('django.db.models.fields.CharField')(max_length=15, unique=True)),
            ('site', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('infant_initials', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('bf_duration', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
        ...
        db.send_create_signal('mpepu_infant', ['InfantRando'])

        # Changing field 'InfantOffStudyAudit.comment'
        db.alter_column('mpepu_infant_infantoffstudy_audit', 'comment', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Deleting field 'InfantEligibilityAudit.hiv_result_reference'
        db.delete_column('mpepu_infant_infanteligibility_audit', 'hiv_result_reference')

        # Changing field 'InfantOffStudy.comment'
        db.alter_column('mpepu_infant_infantoffstudy', 'comment', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Deleting field 'InfantEligibility.hiv_result_reference'
        db.delete_column('mpepu_infant_infanteligibility', 'hiv_result_reference')
