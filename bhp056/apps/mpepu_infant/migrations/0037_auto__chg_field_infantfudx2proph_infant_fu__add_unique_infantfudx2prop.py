...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantFuDx2Proph.infant_fu'
        db.alter_column(u'mpepu_infant_infantfudx2proph', 'infant_fu_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mpepu_infant.InfantFu'], unique=True))
        # Adding unique constraint on 'InfantFuDx2Proph', fields ['infant_fu']
        db.create_unique(u'mpepu_infant_infantfudx2proph', ['infant_fu_id'])


    def backwards(self, orm):
        pass
        # Removing unique constraint on 'InfantFuDx2Proph', fields ['infant_fu']
#         db.delete_unique(u'mpepu_infant_infantfudx2proph', ['infant_fu_id'])
# 
# 
#         # Changing field 'InfantFuDx2Proph.infant_fu'
#         db.alter_column(u'mpepu_infant_infantfudx2proph', 'infant_fu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantFu']))
