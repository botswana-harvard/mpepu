...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantFuPhysical.infant_fu'
        db.alter_column(u'mpepu_infant_infantfuphysical', 'infant_fu_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mpepu_infant.InfantFu'], unique=True))
        # Adding unique constraint on 'InfantFuPhysical', fields ['infant_fu']
        db.create_unique(u'mpepu_infant_infantfuphysical', ['infant_fu_id'])


    def backwards(self, orm):
        pass
        # Removing unique constraint on 'InfantFuPhysical', fields ['infant_fu']
#         db.delete_unique(u'mpepu_infant_infantfuphysical', ['infant_fu_id'])
# 
# 
#         # Changing field 'InfantFuPhysical.infant_fu'
#         db.alter_column(u'mpepu_infant_infantfuphysical', 'infant_fu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantFu']))
    ...
    models = {
        ...
        'mpepu_infant.infantarvproph': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 27, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'mpepu_infant.infantfudx': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'infant_fu': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['mpepu_infant.InfantFu']", 'unique': 'True'}),
            'infant_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['mpepu_infant.InfantVisit']", 'unique': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 27, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
