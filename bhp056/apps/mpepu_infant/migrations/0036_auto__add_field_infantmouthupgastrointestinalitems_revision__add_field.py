...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfantVitalStatusAudit.revision'
        db.add_column(u'mpepu_infant_infantvitalstatus_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'InfantVitalStatus.revision'
        db.add_column(u'mpepu_infant_infantvitalstatus', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InfantVitalStatusAudit.revision'
        db.delete_column(u'mpepu_infant_infantvitalstatus_audit', 'revision')
        ...
        # Deleting field 'InfantVitalStatus.revision'
        db.delete_column(u'mpepu_infant_infantvitalstatus', 'revision')
