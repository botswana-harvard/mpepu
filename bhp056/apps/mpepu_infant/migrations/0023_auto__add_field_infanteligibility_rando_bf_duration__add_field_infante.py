...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfantEligibility.rando_bf_duration'
        db.add_column('mpepu_infant_infanteligibility', 'rando_bf_duration',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'InfantEligibilityAudit.rando_bf_duration'
        db.add_column('mpepu_infant_infanteligibility_audit', 'rando_bf_duration',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfantEligibility.rando_bf_duration'
        db.delete_column('mpepu_infant_infanteligibility', 'rando_bf_duration')

        # Deleting field 'InfantEligibilityAudit.rando_bf_duration'
        db.delete_column('mpepu_infant_infanteligibility_audit', 'rando_bf_duration')
