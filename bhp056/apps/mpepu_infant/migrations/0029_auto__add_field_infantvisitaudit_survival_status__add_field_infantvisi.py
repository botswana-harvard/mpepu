...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfantVisitAudit.survival_status'
        db.add_column('mpepu_infant_infantvisit_audit', 'survival_status',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'InfantVisitAudit.date_last_alive'
        db.add_column('mpepu_infant_infantvisit_audit', 'date_last_alive',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InfantVisit.survival_status'
        db.add_column('mpepu_infant_infantvisit', 'survival_status',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'InfantVisit.date_last_alive'
        db.add_column('mpepu_infant_infantvisit', 'date_last_alive',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfantVisitAudit.survival_status'
        db.delete_column('mpepu_infant_infantvisit_audit', 'survival_status')

        # Deleting field 'InfantVisitAudit.date_last_alive'
        db.delete_column('mpepu_infant_infantvisit_audit', 'date_last_alive')

        # Deleting field 'InfantVisit.survival_status'
        db.delete_column('mpepu_infant_infantvisit', 'survival_status')

        # Deleting field 'InfantVisit.date_last_alive'
        db.delete_column('mpepu_infant_infantvisit', 'date_last_alive')
