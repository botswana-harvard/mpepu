...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InfantStoolCollection.stool_texture'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'stool_texture')

        # Deleting field 'InfantStoolCollection.diarrhoea_bloody'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'diarrhoea_bloody')

        # Deleting field 'InfantStoolCollection.stools_past_24hrs'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'stools_past_24hrs')

        # Deleting field 'InfantStoolCollection.past_illness'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'past_illness')

        # Deleting field 'InfantStoolCollection.continuous_loose_stools'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'continuous_loose_stools')

        # Deleting field 'InfantStoolCollection.illness_classification'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'illness_classification')

        # Deleting field 'InfantStoolCollection.currently_ill'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'currently_ill')

        # Adding field 'InfantStoolCollection.past_diarrhea'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'past_diarrhea',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.diarrhea_past_24hrs'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'diarrhea_past_24hrs',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.antibiotics_7days'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'antibiotics_7days',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.antibiotic_dose_24hrs'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'antibiotic_dose_24hrs',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Deleting field 'InfantStoolCollectionAudit.stools_past_24hrs'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'stools_past_24hrs')

        # Deleting field 'InfantStoolCollectionAudit.diarrhoea_bloody'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'diarrhoea_bloody')

        # Deleting field 'InfantStoolCollectionAudit.past_illness'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'past_illness')

        # Deleting field 'InfantStoolCollectionAudit.continuous_loose_stools'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'continuous_loose_stools')

        # Deleting field 'InfantStoolCollectionAudit.illness_classification'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'illness_classification')

        # Deleting field 'InfantStoolCollectionAudit.stool_texture'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'stool_texture')

        # Deleting field 'InfantStoolCollectionAudit.currently_ill'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'currently_ill')

        # Adding field 'InfantStoolCollectionAudit.past_diarrhea'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'past_diarrhea',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.diarrhea_past_24hrs'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'diarrhea_past_24hrs',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.antibiotics_7days'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'antibiotics_7days',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.antibiotic_dose_24hrs'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'antibiotic_dose_24hrs',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InfantStoolCollection.stool_texture'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'stool_texture',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.diarrhoea_bloody'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'diarrhoea_bloody',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.stools_past_24hrs'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'stools_past_24hrs',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.past_illness'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'past_illness',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.continuous_loose_stools'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'continuous_loose_stools',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.illness_classification'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'illness_classification',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollection.currently_ill'
        db.add_column(u'mpepu_infant_infantstoolcollection', 'currently_ill',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Deleting field 'InfantStoolCollection.past_diarrhea'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'past_diarrhea')

        # Deleting field 'InfantStoolCollection.diarrhea_past_24hrs'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'diarrhea_past_24hrs')

        # Deleting field 'InfantStoolCollection.antibiotics_7days'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'antibiotics_7days')

        # Deleting field 'InfantStoolCollection.antibiotic_dose_24hrs'
        db.delete_column(u'mpepu_infant_infantstoolcollection', 'antibiotic_dose_24hrs')

        # Adding field 'InfantStoolCollectionAudit.stools_past_24hrs'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'stools_past_24hrs',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.diarrhoea_bloody'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'diarrhoea_bloody',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.past_illness'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'past_illness',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.continuous_loose_stools'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'continuous_loose_stools',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.illness_classification'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'illness_classification',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.stool_texture'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'stool_texture',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True),
                      keep_default=False)

        # Adding field 'InfantStoolCollectionAudit.currently_ill'
        db.add_column(u'mpepu_infant_infantstoolcollection_audit', 'currently_ill',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True),
                      keep_default=False)

        # Deleting field 'InfantStoolCollectionAudit.past_diarrhea'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'past_diarrhea')

        # Deleting field 'InfantStoolCollectionAudit.diarrhea_past_24hrs'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'diarrhea_past_24hrs')

        # Deleting field 'InfantStoolCollectionAudit.antibiotics_7days'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'antibiotics_7days')

        # Deleting field 'InfantStoolCollectionAudit.antibiotic_dose_24hrs'
        db.delete_column(u'mpepu_infant_infantstoolcollection_audit', 'antibiotic_dose_24hrs')
    ...
    models = {
        ...
        'mpepu_infant.infantarvproph': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 18, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
