...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfantVerbalAutopsyItems'
        db.create_table('mpepu_infant_infantverbalautopsyitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('hostname_created', self.gf('django.db.models.fields.CharField')(default='s20.bhp.org.bw', max_length=50, blank=True)),
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='s20.bhp.org.bw', max_length=50, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('verbal_autopsy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantVerbalAutopsy'])),
            ('sign_symptom', self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True)),
            ('onset_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal('mpepu_infant', ['InfantVerbalAutopsyItems'])

        # Adding field 'InfantVerbalAutopsyAudit.sign_symptoms'
        db.add_column('mpepu_infant_infantverbalautopsy_audit', 'sign_symptoms', self.gf('django.db.models.fields.CharField')(default=0, max_length=3), keep_default=False)

        # Adding field 'InfantVerbalAutopsy.sign_symptoms'
        db.add_column('mpepu_infant_infantverbalautopsy', 'sign_symptoms', self.gf('django.db.models.fields.CharField')(default=0, max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'InfantVerbalAutopsyItems'
        db.delete_table('mpepu_infant_infantverbalautopsyitems')

        # Deleting field 'InfantVerbalAutopsyAudit.sign_symptoms'
        db.delete_column('mpepu_infant_infantverbalautopsy_audit', 'sign_symptoms')

        # Deleting field 'InfantVerbalAutopsy.sign_symptoms'
        db.delete_column('mpepu_infant_infantverbalautopsy', 'sign_symptoms')
