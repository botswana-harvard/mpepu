...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfantMouthUpGastrointestinalItems'
        db.create_table('mpepu_infant_infantmouthupgastrointestinalitems', (
            ...
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('mouth_up_gastrointest', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('mouth_up_gastrointest_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantMouthUpGastrointestinalItems'])

        # Adding model 'InfantMusculoskeletalAbnormalItems'
        db.create_table('mpepu_infant_infantmusculoskeletalabnormalitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('musculo_skeletal', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('musculo_skeletal_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantMusculoskeletalAbnormalItems'])

        # Adding model 'InfantMaleGenitalAnomalyItems'
        db.create_table('mpepu_infant_infantmalegenitalanomalyitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('male_genital_anomal', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('male_genital_anomal_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantMaleGenitalAnomalyItems'])

        # Adding model 'InfantFacialDefectItems'
        db.create_table('mpepu_infant_infantfacialdefectitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('facial_defect', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('facial_defects_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantFacialDefectItems'])

        # Adding model 'InfantRespiratoryDefectItems'
        db.create_table('mpepu_infant_infantrespiratorydefectitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('respiratory_defect', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('respiratory_defects_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantRespiratoryDefectItems'])

        # Adding model 'InfantOtherAbnormalityItems'
        db.create_table('mpepu_infant_infantotherabnormalityitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('other_abnormalities', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('other_abnormalities_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantOtherAbnormalityItems'])

        # Adding model 'InfantCnsAbnormalityItems'
        db.create_table('mpepu_infant_infantcnsabnormalityitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('cns_abnormality', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('cns_abnormality_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantCnsAbnormalityItems'])

        # Adding model 'InfantSkinAbnormalItems'
        db.create_table('mpepu_infant_infantskinabnormalitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('skin_abnormality', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('skin_abnormality_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantSkinAbnormalItems'])

        # Adding model 'InfantCongenitalAnomalies'
        db.create_table('mpepu_infant_infantcongenitalanomalies', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='s007', max_length=50, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('birth_data', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mpepu_infant.InfantBirthData'], unique=True)),
        ...
        db.send_create_signal('mpepu_infant', ['InfantCongenitalAnomalies'])

        # Adding model 'InfantCleftDisorderItems'
        db.create_table('mpepu_infant_infantcleftdisorderitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('cleft_disorder', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('cleft_disorders_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantCleftDisorderItems'])

        # Adding model 'InfantFemaleGenitalAnomalyItems'
        db.create_table('mpepu_infant_infantfemalegenitalanomalyitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('female_genital_anomal', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('female_genital_anomal_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantFemaleGenitalAnomalyItems'])

        # Adding model 'InfantRenalAnomalyItems'
        db.create_table('mpepu_infant_infantrenalanomalyitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('renal_amomalies', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('renal_amomalies_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantRenalAnomalyItems'])

        # Adding model 'InfantCardiovascularDisorderItems'
        db.create_table('mpepu_infant_infantcardiovasculardisorderitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('cardiovascular_disorder', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('cardiovascular_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantCardiovascularDisorderItems'])

        # Adding model 'InfantTrisomiesChromosomeItems'
        db.create_table('mpepu_infant_infanttrisomieschromosomeitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('triso_chromo_abnormal', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('triso_chromo_abnormal_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantTrisomiesChromosomeItems'])

        # Adding model 'InfantLowerGastrointestinalItems'
        db.create_table('mpepu_infant_infantlowergastrointestinalitems', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('congenital_anomalies', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantCongenitalAnomalies'])),
            ('lower_gastrointestinal', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('abnormality_status', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('lower_gastrointestinal_other', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('mpepu_infant', ['InfantLowerGastrointestinalItems'])


    def backwards(self, orm):
        
        # Deleting model 'InfantMouthUpGastrointestinalItems'
        db.delete_table('mpepu_infant_infantmouthupgastrointestinalitems')

        # Deleting model 'InfantMusculoskeletalAbnormalItems'
        db.delete_table('mpepu_infant_infantmusculoskeletalabnormalitems')

        # Deleting model 'InfantMaleGenitalAnomalyItems'
        db.delete_table('mpepu_infant_infantmalegenitalanomalyitems')

        # Deleting model 'InfantFacialDefectItems'
        db.delete_table('mpepu_infant_infantfacialdefectitems')

        # Deleting model 'InfantRespiratoryDefectItems'
        db.delete_table('mpepu_infant_infantrespiratorydefectitems')

        # Deleting model 'InfantOtherAbnormalityItems'
        db.delete_table('mpepu_infant_infantotherabnormalityitems')

        # Deleting model 'InfantCnsAbnormalityItems'
        db.delete_table('mpepu_infant_infantcnsabnormalityitems')

        # Deleting model 'InfantSkinAbnormalItems'
        db.delete_table('mpepu_infant_infantskinabnormalitems')

        # Deleting model 'InfantCongenitalAnomalies'
        db.delete_table('mpepu_infant_infantcongenitalanomalies')

        # Deleting model 'InfantCleftDisorderItems'
        db.delete_table('mpepu_infant_infantcleftdisorderitems')

        # Deleting model 'InfantFemaleGenitalAnomalyItems'
        db.delete_table('mpepu_infant_infantfemalegenitalanomalyitems')

        # Deleting model 'InfantRenalAnomalyItems'
        db.delete_table('mpepu_infant_infantrenalanomalyitems')

        # Deleting model 'InfantCardiovascularDisorderItems'
        db.delete_table('mpepu_infant_infantcardiovasculardisorderitems')

        # Deleting model 'InfantTrisomiesChromosomeItems'
        db.delete_table('mpepu_infant_infanttrisomieschromosomeitems')

        # Deleting model 'InfantLowerGastrointestinalItems'
        db.delete_table('mpepu_infant_infantlowergastrointestinalitems')
    ...
    models = {
        ...
        'mpepu_infant.infantcongenitalanomalies': {
            ...
            'birth_data': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['mpepu_infant.InfantBirthData']", 'unique': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'s007'", 'max_length': '50', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'s007'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
