...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantMouthUpGastrointestinalItems.revision'
        db.alter_column(u'mpepu_infant_infantmouthupgastrointestinalitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuMed.revision'
        db.alter_column(u'mpepu_infant_infantfumed', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantHaartAudit.revision'
        db.alter_column(u'mpepu_infant_infanthaart_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuMedAudit.revision'
        db.alter_column(u'mpepu_infant_infantfumed_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantOffStudyAudit.revision'
        db.alter_column(u'mpepu_infant_infantoffstudy_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirth.revision'
        db.alter_column(u'mpepu_infant_infantbirth', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantSkinAbnormalItems.revision'
        db.alter_column(u'mpepu_infant_infantskinabnormalitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantOffStudy.revision'
        db.alter_column(u'mpepu_infant_infantoffstudy', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantRandoDeferralAudit.revision'
        db.alter_column(u'mpepu_infant_infantrandodeferral_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuPhysical.revision'
        db.alter_column(u'mpepu_infant_infantfuphysical', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFemaleGenitalAnomalyItems.revision'
        db.alter_column(u'mpepu_infant_infantfemalegenitalanomalyitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDAudit.revision'
        db.alter_column(u'mpepu_infant_infantfud_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuD.revision'
        db.alter_column(u'mpepu_infant_infantfud', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFu.revision'
        db.alter_column(u'mpepu_infant_infantfu', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDxItemsAudit.revision'
        db.alter_column(u'mpepu_infant_infantfudxitems_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantStudyDrugItemsAudit.revision'
        db.alter_column(u'mpepu_infant_infantstudydrugitems_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantCongenitalAnomalies.revision'
        db.alter_column(u'mpepu_infant_infantcongenitalanomalies', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantCardiovascularDisorderItems.revision'
        db.alter_column(u'mpepu_infant_infantcardiovasculardisorderitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantArvProph.revision'
        db.alter_column(u'mpepu_infant_infantarvproph', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantStudyDrugAudit.revision'
        db.alter_column(u'mpepu_infant_infantstudydrug_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantHivStatusAudit.revision'
        db.alter_column(u'mpepu_infant_infanthivstatus_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantArvProphAudit.revision'
        db.alter_column(u'mpepu_infant_infantarvproph_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuNewMedItems.revision'
        db.alter_column(u'mpepu_infant_infantfunewmeditems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantHaart.revision'
        db.alter_column(u'mpepu_infant_infanthaart', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantLowerGastrointestinalItems.revision'
        db.alter_column(u'mpepu_infant_infantlowergastrointestinalitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantMaleGenitalAnomalyItems.revision'
        db.alter_column(u'mpepu_infant_infantmalegenitalanomalyitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantStudyDrugInit.revision'
        db.alter_column(u'mpepu_infant_infantstudydruginit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantHaartModAudit.revision'
        db.alter_column(u'mpepu_infant_infanthaartmod_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDx2ProphItemsAudit.revision'
        db.alter_column(u'mpepu_infant_infantfudx2prophitems_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantNvpAdherenceAudit.revision'
        db.alter_column(u'mpepu_infant_infantnvpadherence_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuNewMedItemsAudit.revision'
        db.alter_column(u'mpepu_infant_infantfunewmeditems_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantMusculoskeletalAbnormalItems.revision'
        db.alter_column(u'mpepu_infant_infantmusculoskeletalabnormalitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantHivStatus.revision'
        db.alter_column(u'mpepu_infant_infanthivstatus', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantDeath.revision'
        db.alter_column(u'mpepu_infant_infantdeath', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantSurvival.revision'
        db.alter_column(u'mpepu_infant_infantsurvival', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuAudit.revision'
        db.alter_column(u'mpepu_infant_infantfu_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthFeed.revision'
        db.alter_column(u'mpepu_infant_infantbirthfeed', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantVitalStatusAudit.revision'
        db.alter_column(u'mpepu_infant_infantvitalstatus_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantEligibilityAudit.revision'
        db.alter_column(u'mpepu_infant_infanteligibility_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantStudyDrug.revision'
        db.alter_column(u'mpepu_infant_infantstudydrug', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantRandoDeferral.revision'
        db.alter_column(u'mpepu_infant_infantrandodeferral', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthExamAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirthexam_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantOffDrug.revision'
        db.alter_column(u'mpepu_infant_infantoffdrug', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFeeding.revision'
        db.alter_column(u'mpepu_infant_infantfeeding', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFeedingAudit.revision'
        db.alter_column(u'mpepu_infant_infantfeeding_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantDeathAudit.revision'
        db.alter_column(u'mpepu_infant_infantdeath_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFacialDefectItems.revision'
        db.alter_column(u'mpepu_infant_infantfacialdefectitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthArv.revision'
        db.alter_column(u'mpepu_infant_infantbirtharv', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantRespiratoryDefectItems.revision'
        db.alter_column(u'mpepu_infant_infantrespiratorydefectitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantOtherAbnormalityItems.revision'
        db.alter_column(u'mpepu_infant_infantotherabnormalityitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantPreEligibility.revision'
        db.alter_column(u'mpepu_infant_infantpreeligibility', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantSurvivalAudit.revision'
        db.alter_column(u'mpepu_infant_infantsurvival_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantCnsAbnormalityItems.revision'
        db.alter_column(u'mpepu_infant_infantcnsabnormalityitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantHaartMod.revision'
        db.alter_column(u'mpepu_infant_infanthaartmod', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantCtxPlaceboAdhAudit.revision'
        db.alter_column(u'mpepu_infant_infantctxplaceboadh_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantArvProphModAudit.revision'
        db.alter_column(u'mpepu_infant_infantarvprophmod_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantCleftDisorderItems.revision'
        db.alter_column(u'mpepu_infant_infantcleftdisorderitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDx2Proph.revision'
        db.alter_column(u'mpepu_infant_infantfudx2proph', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthData.revision'
        db.alter_column(u'mpepu_infant_infantbirthdata', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantStudyDrugInitAudit.revision'
        db.alter_column(u'mpepu_infant_infantstudydruginit_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantVisit.revision'
        db.alter_column('mpepu_infant_infantvisit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDx2ProphItems.revision'
        db.alter_column(u'mpepu_infant_infantfudx2prophitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuNewMed.revision'
        db.alter_column(u'mpepu_infant_infantfunewmed', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantRenalAnomalyItems.revision'
        db.alter_column(u'mpepu_infant_infantrenalanomalyitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthArvAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirtharv_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuNewMedAudit.revision'
        db.alter_column(u'mpepu_infant_infantfunewmed_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthExam.revision'
        db.alter_column(u'mpepu_infant_infantbirthexam', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantTrisomiesChromosomeItems.revision'
        db.alter_column(u'mpepu_infant_infanttrisomieschromosomeitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthFeedAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirthfeed_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDx2ProphAudit.revision'
        db.alter_column(u'mpepu_infant_infantfudx2proph_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantPreEligibilityAudit.revision'
        db.alter_column(u'mpepu_infant_infantpreeligibility_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantCtxPlaceboAdh.revision'
        db.alter_column(u'mpepu_infant_infantctxplaceboadh', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuPhysicalAudit.revision'
        db.alter_column(u'mpepu_infant_infantfuphysical_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDxAudit.revision'
        db.alter_column(u'mpepu_infant_infantfudx_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirth_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantStudyDrugItems.revision'
        db.alter_column(u'mpepu_infant_infantstudydrugitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantBirthDataAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirthdata_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantVerbalAutopsy.revision'
        db.alter_column(u'mpepu_infant_infantverbalautopsy', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantVerbalAutopsyItems.revision'
        db.alter_column(u'mpepu_infant_infantverbalautopsyitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantEligibility.revision'
        db.alter_column(u'mpepu_infant_infanteligibility', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantPrerandoLoss.revision'
        db.alter_column(u'mpepu_infant_infantprerandoloss', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantOffDrugAudit.revision'
        db.alter_column(u'mpepu_infant_infantoffdrug_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantNvpAdherence.revision'
        db.alter_column(u'mpepu_infant_infantnvpadherence', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantVitalStatus.revision'
        db.alter_column(u'mpepu_infant_infantvitalstatus', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantVisitAudit.revision'
        db.alter_column('mpepu_infant_infantvisit_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantPrerandoLossAudit.revision'
        db.alter_column(u'mpepu_infant_infantprerandoloss_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantVerbalAutopsyAudit.revision'
        db.alter_column(u'mpepu_infant_infantverbalautopsy_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantArvProphMod.revision'
        db.alter_column(u'mpepu_infant_infantarvprophmod', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDx.revision'
        db.alter_column(u'mpepu_infant_infantfudx', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'InfantFuDxItems.revision'
        db.alter_column(u'mpepu_infant_infantfudxitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'InfantMouthUpGastrointestinalItems.revision'
        db.alter_column(u'mpepu_infant_infantmouthupgastrointestinalitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuMed.revision'
        db.alter_column(u'mpepu_infant_infantfumed', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantHaartAudit.revision'
        db.alter_column(u'mpepu_infant_infanthaart_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuMedAudit.revision'
        db.alter_column(u'mpepu_infant_infantfumed_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantOffStudyAudit.revision'
        db.alter_column(u'mpepu_infant_infantoffstudy_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirth.revision'
        db.alter_column(u'mpepu_infant_infantbirth', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantSkinAbnormalItems.revision'
        db.alter_column(u'mpepu_infant_infantskinabnormalitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantOffStudy.revision'
        db.alter_column(u'mpepu_infant_infantoffstudy', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantRandoDeferralAudit.revision'
        db.alter_column(u'mpepu_infant_infantrandodeferral_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuPhysical.revision'
        db.alter_column(u'mpepu_infant_infantfuphysical', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFemaleGenitalAnomalyItems.revision'
        db.alter_column(u'mpepu_infant_infantfemalegenitalanomalyitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDAudit.revision'
        db.alter_column(u'mpepu_infant_infantfud_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuD.revision'
        db.alter_column(u'mpepu_infant_infantfud', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFu.revision'
        db.alter_column(u'mpepu_infant_infantfu', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDxItemsAudit.revision'
        db.alter_column(u'mpepu_infant_infantfudxitems_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantStudyDrugItemsAudit.revision'
        db.alter_column(u'mpepu_infant_infantstudydrugitems_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantCongenitalAnomalies.revision'
        db.alter_column(u'mpepu_infant_infantcongenitalanomalies', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantCardiovascularDisorderItems.revision'
        db.alter_column(u'mpepu_infant_infantcardiovasculardisorderitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantArvProph.revision'
        db.alter_column(u'mpepu_infant_infantarvproph', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantStudyDrugAudit.revision'
        db.alter_column(u'mpepu_infant_infantstudydrug_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantHivStatusAudit.revision'
        db.alter_column(u'mpepu_infant_infanthivstatus_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantArvProphAudit.revision'
        db.alter_column(u'mpepu_infant_infantarvproph_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuNewMedItems.revision'
        db.alter_column(u'mpepu_infant_infantfunewmeditems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantHaart.revision'
        db.alter_column(u'mpepu_infant_infanthaart', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantLowerGastrointestinalItems.revision'
        db.alter_column(u'mpepu_infant_infantlowergastrointestinalitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantMaleGenitalAnomalyItems.revision'
        db.alter_column(u'mpepu_infant_infantmalegenitalanomalyitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantStudyDrugInit.revision'
        db.alter_column(u'mpepu_infant_infantstudydruginit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantHaartModAudit.revision'
        db.alter_column(u'mpepu_infant_infanthaartmod_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDx2ProphItemsAudit.revision'
        db.alter_column(u'mpepu_infant_infantfudx2prophitems_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantNvpAdherenceAudit.revision'
        db.alter_column(u'mpepu_infant_infantnvpadherence_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuNewMedItemsAudit.revision'
        db.alter_column(u'mpepu_infant_infantfunewmeditems_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantMusculoskeletalAbnormalItems.revision'
        db.alter_column(u'mpepu_infant_infantmusculoskeletalabnormalitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantHivStatus.revision'
        db.alter_column(u'mpepu_infant_infanthivstatus', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantDeath.revision'
        db.alter_column(u'mpepu_infant_infantdeath', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantSurvival.revision'
        db.alter_column(u'mpepu_infant_infantsurvival', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuAudit.revision'
        db.alter_column(u'mpepu_infant_infantfu_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthFeed.revision'
        db.alter_column(u'mpepu_infant_infantbirthfeed', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantVitalStatusAudit.revision'
        db.alter_column(u'mpepu_infant_infantvitalstatus_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantEligibilityAudit.revision'
        db.alter_column(u'mpepu_infant_infanteligibility_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantStudyDrug.revision'
        db.alter_column(u'mpepu_infant_infantstudydrug', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantRandoDeferral.revision'
        db.alter_column(u'mpepu_infant_infantrandodeferral', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthExamAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirthexam_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantOffDrug.revision'
        db.alter_column(u'mpepu_infant_infantoffdrug', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFeeding.revision'
        db.alter_column(u'mpepu_infant_infantfeeding', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFeedingAudit.revision'
        db.alter_column(u'mpepu_infant_infantfeeding_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantDeathAudit.revision'
        db.alter_column(u'mpepu_infant_infantdeath_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFacialDefectItems.revision'
        db.alter_column(u'mpepu_infant_infantfacialdefectitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthArv.revision'
        db.alter_column(u'mpepu_infant_infantbirtharv', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantRespiratoryDefectItems.revision'
        db.alter_column(u'mpepu_infant_infantrespiratorydefectitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantOtherAbnormalityItems.revision'
        db.alter_column(u'mpepu_infant_infantotherabnormalityitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantPreEligibility.revision'
        db.alter_column(u'mpepu_infant_infantpreeligibility', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantSurvivalAudit.revision'
        db.alter_column(u'mpepu_infant_infantsurvival_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantCnsAbnormalityItems.revision'
        db.alter_column(u'mpepu_infant_infantcnsabnormalityitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantHaartMod.revision'
        db.alter_column(u'mpepu_infant_infanthaartmod', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantCtxPlaceboAdhAudit.revision'
        db.alter_column(u'mpepu_infant_infantctxplaceboadh_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantArvProphModAudit.revision'
        db.alter_column(u'mpepu_infant_infantarvprophmod_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantCleftDisorderItems.revision'
        db.alter_column(u'mpepu_infant_infantcleftdisorderitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDx2Proph.revision'
        db.alter_column(u'mpepu_infant_infantfudx2proph', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthData.revision'
        db.alter_column(u'mpepu_infant_infantbirthdata', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantStudyDrugInitAudit.revision'
        db.alter_column(u'mpepu_infant_infantstudydruginit_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantVisit.revision'
        db.alter_column('mpepu_infant_infantvisit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDx2ProphItems.revision'
        db.alter_column(u'mpepu_infant_infantfudx2prophitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuNewMed.revision'
        db.alter_column(u'mpepu_infant_infantfunewmed', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantRenalAnomalyItems.revision'
        db.alter_column(u'mpepu_infant_infantrenalanomalyitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthArvAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirtharv_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuNewMedAudit.revision'
        db.alter_column(u'mpepu_infant_infantfunewmed_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthExam.revision'
        db.alter_column(u'mpepu_infant_infantbirthexam', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantTrisomiesChromosomeItems.revision'
        db.alter_column(u'mpepu_infant_infanttrisomieschromosomeitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthFeedAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirthfeed_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDx2ProphAudit.revision'
        db.alter_column(u'mpepu_infant_infantfudx2proph_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantPreEligibilityAudit.revision'
        db.alter_column(u'mpepu_infant_infantpreeligibility_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantCtxPlaceboAdh.revision'
        db.alter_column(u'mpepu_infant_infantctxplaceboadh', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuPhysicalAudit.revision'
        db.alter_column(u'mpepu_infant_infantfuphysical_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDxAudit.revision'
        db.alter_column(u'mpepu_infant_infantfudx_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirth_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantStudyDrugItems.revision'
        db.alter_column(u'mpepu_infant_infantstudydrugitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantBirthDataAudit.revision'
        db.alter_column(u'mpepu_infant_infantbirthdata_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantVerbalAutopsy.revision'
        db.alter_column(u'mpepu_infant_infantverbalautopsy', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantVerbalAutopsyItems.revision'
        db.alter_column(u'mpepu_infant_infantverbalautopsyitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantEligibility.revision'
        db.alter_column(u'mpepu_infant_infanteligibility', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantPrerandoLoss.revision'
        db.alter_column(u'mpepu_infant_infantprerandoloss', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantOffDrugAudit.revision'
        db.alter_column(u'mpepu_infant_infantoffdrug_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantNvpAdherence.revision'
        db.alter_column(u'mpepu_infant_infantnvpadherence', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantVitalStatus.revision'
        db.alter_column(u'mpepu_infant_infantvitalstatus', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantVisitAudit.revision'
        db.alter_column('mpepu_infant_infantvisit_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantPrerandoLossAudit.revision'
        db.alter_column(u'mpepu_infant_infantprerandoloss_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantVerbalAutopsyAudit.revision'
        db.alter_column(u'mpepu_infant_infantverbalautopsy_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantArvProphMod.revision'
        db.alter_column(u'mpepu_infant_infantarvprophmod', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDx.revision'
        db.alter_column(u'mpepu_infant_infantfudx', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'InfantFuDxItems.revision'
        db.alter_column(u'mpepu_infant_infantfudxitems', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'mpepu_infant.infantvitalstatusaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'InfantVitalStatusAudit', 'db_table': "u'mpepu_infant_infantvitalstatus_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_infantvitalstatus'", 'to': "orm['registration.RegisteredSubject']"}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
