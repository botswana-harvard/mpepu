...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mpepu_infant_infantstoolcollection', (
            ...
            ('stool_texture', self.gf('django.db.models.fields.CharField')(max_length=45, null=True)),
            ('axi_temp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1)),
            ('past_illness', self.gf('django.db.models.fields.CharField')(max_length=3, null=True)),
            ('currently_ill', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('illness_classification', self.gf('django.db.models.fields.CharField')(max_length=75, null=True)),
            ('stools_past_24hrs', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('diarrhoea_bloody', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('continuous_loose_stools', self.gf('django.db.models.fields.CharField')(max_length=45, null=True)),
        ))
    ...
    models = {
        ...
        'mpepu_infant.infantstoolcollection': {
            ...
            'continuous_loose_stools': ('django.db.models.fields.CharField', [], {'max_length': '45', 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'currently_ill': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'diarrhoea_bloody': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'illness_classification': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True'}),
            'infant_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['mpepu_infant.InfantVisit']", 'unique': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'past_illness': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 28, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'sample_obtained': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'stool_texture': ('django.db.models.fields.CharField', [], {'max_length': '45', 'null': 'True'}),
            'stools_past_24hrs': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
