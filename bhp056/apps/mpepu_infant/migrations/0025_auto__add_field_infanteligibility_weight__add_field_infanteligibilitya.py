...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfantEligibility.weight'
        db.add_column('mpepu_infant_infanteligibility', 'weight',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2),
                      keep_default=False)

        # Adding field 'InfantEligibilityAudit.weight'
        db.add_column('mpepu_infant_infanteligibility_audit', 'weight',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfantEligibility.weight'
        db.delete_column('mpepu_infant_infanteligibility', 'weight')

        # Deleting field 'InfantEligibilityAudit.weight'
        db.delete_column('mpepu_infant_infanteligibility_audit', 'weight')
