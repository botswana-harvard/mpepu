...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantFuMed.infant_fu'
        db.alter_column(u'mpepu_infant_infantfumed', 'infant_fu_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mpepu_infant.InfantFu'], unique=True))
        # Adding unique constraint on 'InfantFuMed', fields ['infant_fu']
        db.create_unique(u'mpepu_infant_infantfumed', ['infant_fu_id'])


    def backwards(self, orm):
        pass
        # Removing unique constraint on 'InfantFuMed', fields ['infant_fu']
#         db.delete_unique(u'mpepu_infant_infantfumed', ['infant_fu_id'])
# 
# 
#         # Changing field 'InfantFuMed.infant_fu'
#         db.alter_column(u'mpepu_infant_infantfumed', 'infant_fu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpepu_infant.InfantFu']))
