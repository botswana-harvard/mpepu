...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfantCongenitalAnomalies.birth_data'
        db.delete_column('mpepu_infant_infantcongenitalanomalies', 'birth_data_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InfantCongenitalAnomalies.birth_data'
        raise RuntimeError("Cannot reverse this migration. 'InfantCongenitalAnomalies.birth_data' and its values cannot be restored.")
