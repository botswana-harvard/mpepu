...
class MpepuInfantRandoMonthlyVisitSchedule(VisitScheduleConfiguration):
    ...
    visit_definitions['2010'] = {
            ...
            'requisitions': (
                ...
                RequisitionPanelTuple(400L, u'mpepu_lab', u'infantrequisition', 'Stool storage', 'STORAGE', 'ST', SHOW_FORM),
                RequisitionPanelTuple(500L, u'mpepu_lab', u'infantrequisition', 'Plasma and Buffy Coat Storage', 'STORAGE', 'WB', HIDE_FORM),
                RequisitionPanelTuple(600L, u'mpepu_lab', u'infantrequisition', 'ELISA', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(700L, u'mpepu_lab', u'infantrequisition', 'Bana 01 Chemistry', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(800L, u'mpepu_lab', u'infantrequisition', 'Hepatitis B only', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(900L, u'mpepu_lab', u'infantrequisition', 'HIV Western Blot', 'TEST', 'WB', HIDE_FORM),
                ),
            'entries': (
    ...
    visit_definitions['2020'] = {
            ...
            'instructions': None,
            'requisitions': (
                RequisitionPanelTuple(100L, u'mpepu_lab', u'infantrequisition', 'DNA PCR', 'TEST', 'WB', HIDE_FORM),
    ...
    visit_definitions['2030'] = {
            ...
            'requisitions': (
                RequisitionPanelTuple(100L, u'mpepu_lab', u'infantrequisition', 'Hematology (ARV)', 'TEST', 'WB', SHOW_FORM),
                RequisitionPanelTuple(200L, u'mpepu_lab', u'infantrequisition', 'DNA PCR', 'TEST', 'WB', SHOW_FORM),
                RequisitionPanelTuple(300L, u'mpepu_lab', u'infantrequisition', 'Stool storage', 'STORAGE', 'ST', SHOW_FORM),
                ...
                RequisitionPanelTuple(900L, u'mpepu_lab', u'infantrequisition', 'PBMC Plasma (STORE ONLY)', 'STORAGE', 'WB', HIDE_FORM),
                ),
            'entries': (
                EntryTuple(10L, u'mpepu_infant', u'infantarvproph', SHOW_FORM),
                EntryTuple(20L, u'mpepu_infant', u'infantnvpadherence', SHOW_FORM),
    ...
    visit_definitions['2060'] = {
            ...
            'requisitions': (
                RequisitionPanelTuple(100L, u'mpepu_lab', u'infantrequisition', 'Hematology (ARV)', 'TEST', 'WB', SHOW_FORM),
                RequisitionPanelTuple(200L, u'mpepu_lab', u'infantrequisition', 'DNA PCR', 'TEST', 'WB', SHOW_FORM),
                RequisitionPanelTuple(300L, u'mpepu_lab', u'infantrequisition', 'PBMC Plasma (STORE ONLY)', 'STORAGE', 'WB', SHOW_FORM),
                RequisitionPanelTuple(400L, u'mpepu_lab', u'infantrequisition', 'Stool storage', 'STORAGE', 'ST', SHOW_FORM),
                RequisitionPanelTuple(500L, u'mpepu_lab', u'infantrequisition', 'Plasma and Buffy Coat Storage', 'STORAGE', 'WB', HIDE_FORM),
                RequisitionPanelTuple(600L, u'mpepu_lab', u'infantrequisition', 'ELISA', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(700L, u'mpepu_lab', u'infantrequisition', 'Bana 01 Chemistry', 'TEST', 'WB', HIDE_FORM),
    ...
    visit_definitions['2150'] = {
            ...
            'instructions': None,
            'requisitions': (
                RequisitionPanelTuple(100L, u'mpepu_lab', u'infantrequisition', 'Hematology (ARV)', 'Hematology', 'TEST', 'WB', SHOW_FORM),
                RequisitionPanelTuple(200L, u'mpepu_lab', u'infantrequisition', 'DNA PCR', 'Infant PCR', 'TEST', 'WB', SHOW_FORM),
                RequisitionPanelTuple(300L, u'mpepu_lab', u'infantrequisition', 'PBMC Plasma (STORE ONLY)', 'PBMC Plasma Storage', 'STORAGE', 'WB', SHOW_FORM),
                RequisitionPanelTuple(400L, u'mpepu_lab', u'infantrequisition', 'Plasma and Buffy Coat Storage', 'STORAGE', 'WB', HIDE_FORM),
                RequisitionPanelTuple(500L, u'mpepu_lab', u'infantrequisition', 'ELISA', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(600L, u'mpepu_lab', u'infantrequisition', 'Bana 01 Chemistry', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(700L, u'mpepu_lab', u'infantrequisition', 'Hepatitis B only', 'TEST', 'WB', HIDE_FORM),
    ...
    visit_definitions['2180'] = {
            ...
            'instructions': None,
            'requisitions': (
                RequisitionPanelTuple(100L, u'mpepu_lab', u'infantrequisition', 'PBMC Plasma (STORE ONLY)', 'PBMC Plasma Storage', 'STORAGE', 'WB', SHOW_FORM),
                RequisitionPanelTuple(200L, u'mpepu_lab', u'infantrequisition', 'ELISA', 'ELISA', 'TEST', 'WB', SHOW_FORM),
                RequisitionPanelTuple(300L, u'mpepu_lab', u'infantrequisition', 'Stool storage', 'Stool storage', 'STORAGE', 'ST', SHOW_FORM),
                RequisitionPanelTuple(400L, u'mpepu_lab', u'infantrequisition', 'DNA PCR', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(500L, u'mpepu_lab', u'infantrequisition', 'Plasma and Buffy Coat Storage', 'STORAGE', 'WB', HIDE_FORM),
                RequisitionPanelTuple(600L, u'mpepu_lab', u'infantrequisition', 'Hematology (ARV)', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(700L, u'mpepu_lab', u'infantrequisition', 'Bana 01 Chemistry', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(800L, u'mpepu_lab', u'infantrequisition', 'Hepatitis B only', 'TEST', 'WB', HIDE_FORM),
                RequisitionPanelTuple(900L, u'mpepu_lab', u'infantrequisition', 'HIV Western Blot', 'TEST', 'WB', HIDE_FORM),
                ),
