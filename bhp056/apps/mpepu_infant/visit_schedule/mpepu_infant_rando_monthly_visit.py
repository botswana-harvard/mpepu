...
class MpepuInfantRandoMonthlyVisitSchedule(VisitScheduleConfiguration):
    ...
    visit_definitions['2180'] = {
            ...
            'instructions': None,
            'requisitions': (
                RequisitionPanelTuple(100L, u'mpepu_lab', u'infantrequisition', 'PBMC Plasma (STORE ONLY)', 'STORAGE', 'WB', SHOW_FORM),
                RequisitionPanelTuple(200L, u'mpepu_lab', u'infantrequisition', 'ELISA', 'TEST', 'WB', SHOW_FORM),
                RequisitionPanelTuple(300L, u'mpepu_lab', u'infantrequisition', 'Stool storage', 'STORAGE', 'ST', SHOW_FORM),
