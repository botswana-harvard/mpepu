...
class MpepuInfantMonthlyVisitSchedule(VisitScheduleConfiguration):
    ...
    membership_forms = OrderedDict({
        'infant_eligibility': MembershipFormTuple('infant_eligibility', MaternalConsent, True),
        })

    # schedule groups
    # (name, membership_form_name, grouping_key, comment)
    schedule_groups = OrderedDict({
        'Infant Rando and F/Up': ScheduleGroupTuple('Infant Rando and F/Up', 'infant_eligibility', None, None),
        })
    ...
    visit_definitions = OrderedDict(
        ...
        {'2180': {
            ...
            'entries': (
                ...
                EntryTuple(20L, u'mpepu_infant', u'infantfuphy'),
...
site_visit_schedules.register(MpepuInfantMonthlyVisitSchedule)
