...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Producer.comment'
        db.add_column('bhp_sync_producer', 'comment', self.gf('django.db.models.fields.TextField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Producer.comment'
        db.delete_column('bhp_sync_producer', 'comment')
    ...
    models = {
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 10, 16, 30, 35, 94735)'}),
        ...
        'bhp_sync.transaction': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'producer': ('django.db.models.fields.CharField', [], {'default': "'dmc3-bhp062'", 'max_length': '25'}),
