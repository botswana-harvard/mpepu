...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IncomingTransaction.is_self'
        db.add_column('bhp_sync_incomingtransaction', 'is_self', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IncomingTransaction.is_self'
        db.delete_column('bhp_sync_incomingtransaction', 'is_self')
    ...
    models = {
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 25, 8, 11, 14, 546239)'}),
