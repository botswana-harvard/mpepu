...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('bhp_sync_incomingtransaction', ['producer', 'is_consumed', 'tx_name'], unique=False)
        db.create_index('bhp_sync_outgoingtransaction', ['producer', 'is_consumed', 'tx_name'], unique=False)
    ...
    models = {
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 0, 0)'}),
        ...
        'bhp_sync.syncimporthistorymodel': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'start_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 0, 0)'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
