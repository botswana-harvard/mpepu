...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IncomingTransaction.error'
        db.alter_column('bhp_sync_incomingtransaction', 'error', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

        # Changing field 'OutgoingTransaction.error'
        db.alter_column('bhp_sync_outgoingtransaction', 'error', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

        # Changing field 'Transaction.error'
        db.alter_column('bhp_sync_transaction', 'error', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'IncomingTransaction.error'
        db.alter_column('bhp_sync_incomingtransaction', 'error', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'OutgoingTransaction.error'
        db.alter_column('bhp_sync_outgoingtransaction', 'error', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Transaction.error'
        db.alter_column('bhp_sync_transaction', 'error', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
    ...
    models = {
        'bhp_sync.incomingtransaction': {
            ...
            'producer': ('django.db.models.fields.CharField', [], {'default': "'mac.local-bhp062_20120309'", 'max_length': '25', 'db_index': 'True'}),
        ...
        'bhp_sync.requestlog': {
            ...
            'request_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 8, 0, 38, 112681)'}),
