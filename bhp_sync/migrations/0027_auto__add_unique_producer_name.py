...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Producer', fields ['name']
        db.create_unique(u'bhp_sync_producer', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Producer', fields ['name']
        db.delete_unique(u'bhp_sync_producer', ['name'])
