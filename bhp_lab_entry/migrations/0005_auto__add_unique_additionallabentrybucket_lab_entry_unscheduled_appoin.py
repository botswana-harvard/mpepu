...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AdditionalLabEntryBucket', fields ['lab_entry_unscheduled', 'appointment']
        db.create_unique('bhp_lab_entry_additionallabentrybucket', ['lab_entry_unscheduled_id', 'appointment_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AdditionalLabEntryBucket', fields ['lab_entry_unscheduled', 'appointment']
        db.delete_unique('bhp_lab_entry_additionallabentrybucket', ['lab_entry_unscheduled_id', 'appointment_id'])
