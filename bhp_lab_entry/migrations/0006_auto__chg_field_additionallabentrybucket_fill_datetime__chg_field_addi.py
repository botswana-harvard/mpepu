...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdditionalLabEntryBucket.fill_datetime'
        db.alter_column('bhp_lab_entry_additionallabentrybucket', 'fill_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding index on 'AdditionalLabEntryBucket', fields ['hostname_created']
        db.create_index('bhp_lab_entry_additionallabentrybucket', ['hostname_created'])


        # Changing field 'AdditionalLabEntryBucket.due_datetime'
        db.alter_column('bhp_lab_entry_additionallabentrybucket', 'due_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding index on 'AdditionalLabEntryBucket', fields ['hostname_modified']
        db.create_index('bhp_lab_entry_additionallabentrybucket', ['hostname_modified'])

        # Adding index on 'AdditionalLabEntryBucket', fields ['entry_status']
        db.create_index('bhp_lab_entry_additionallabentrybucket', ['entry_status'])


        # Changing field 'ScheduledLabEntryBucket.fill_datetime'
        db.alter_column('bhp_lab_entry_scheduledlabentrybucket', 'fill_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding index on 'ScheduledLabEntryBucket', fields ['hostname_created']
        db.create_index('bhp_lab_entry_scheduledlabentrybucket', ['hostname_created'])


        # Changing field 'ScheduledLabEntryBucket.due_datetime'
        db.alter_column('bhp_lab_entry_scheduledlabentrybucket', 'due_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding index on 'ScheduledLabEntryBucket', fields ['hostname_modified']
        db.create_index('bhp_lab_entry_scheduledlabentrybucket', ['hostname_modified'])

        # Adding index on 'ScheduledLabEntryBucket', fields ['entry_status']
        db.create_index('bhp_lab_entry_scheduledlabentrybucket', ['entry_status'])

        # Adding field 'LabEntry.lab_clinic_api_panel'
        db.add_column('bhp_lab_entry_labentry', 'lab_clinic_api_panel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.Panel'], null=True),
                      keep_default=False)

        # Adding index on 'LabEntry', fields ['hostname_created']
        db.create_index('bhp_lab_entry_labentry', ['hostname_created'])

        # Adding index on 'LabEntry', fields ['hostname_modified']
        db.create_index('bhp_lab_entry_labentry', ['hostname_modified'])

        # Adding field 'LabEntryUnscheduled.lab_clinic_api_panel'
        db.add_column('bhp_lab_entry_labentryunscheduled', 'lab_clinic_api_panel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.Panel'], null=True),
                      keep_default=False)

        # Adding index on 'LabEntryUnscheduled', fields ['hostname_created']
        db.create_index('bhp_lab_entry_labentryunscheduled', ['hostname_created'])

        # Adding index on 'LabEntryUnscheduled', fields ['hostname_modified']
        db.create_index('bhp_lab_entry_labentryunscheduled', ['hostname_modified'])


    def backwards(self, orm):
        # Removing index on 'LabEntryUnscheduled', fields ['hostname_modified']
        db.delete_index('bhp_lab_entry_labentryunscheduled', ['hostname_modified'])

        # Removing index on 'LabEntryUnscheduled', fields ['hostname_created']
        db.delete_index('bhp_lab_entry_labentryunscheduled', ['hostname_created'])

        # Removing index on 'LabEntry', fields ['hostname_modified']
        db.delete_index('bhp_lab_entry_labentry', ['hostname_modified'])

        # Removing index on 'LabEntry', fields ['hostname_created']
        db.delete_index('bhp_lab_entry_labentry', ['hostname_created'])

        # Removing index on 'ScheduledLabEntryBucket', fields ['entry_status']
        db.delete_index('bhp_lab_entry_scheduledlabentrybucket', ['entry_status'])

        # Removing index on 'ScheduledLabEntryBucket', fields ['hostname_modified']
        db.delete_index('bhp_lab_entry_scheduledlabentrybucket', ['hostname_modified'])

        # Removing index on 'ScheduledLabEntryBucket', fields ['hostname_created']
        db.delete_index('bhp_lab_entry_scheduledlabentrybucket', ['hostname_created'])

        # Removing index on 'AdditionalLabEntryBucket', fields ['entry_status']
        db.delete_index('bhp_lab_entry_additionallabentrybucket', ['entry_status'])

        # Removing index on 'AdditionalLabEntryBucket', fields ['hostname_modified']
        db.delete_index('bhp_lab_entry_additionallabentrybucket', ['hostname_modified'])

        # Removing index on 'AdditionalLabEntryBucket', fields ['hostname_created']
        db.delete_index('bhp_lab_entry_additionallabentrybucket', ['hostname_created'])


        # User chose to not deal with backwards NULL issues for 'AdditionalLabEntryBucket.fill_datetime'
        raise RuntimeError("Cannot reverse this migration. 'AdditionalLabEntryBucket.fill_datetime' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AdditionalLabEntryBucket.due_datetime'
        raise RuntimeError("Cannot reverse this migration. 'AdditionalLabEntryBucket.due_datetime' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ScheduledLabEntryBucket.fill_datetime'
        raise RuntimeError("Cannot reverse this migration. 'ScheduledLabEntryBucket.fill_datetime' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ScheduledLabEntryBucket.due_datetime'
        raise RuntimeError("Cannot reverse this migration. 'ScheduledLabEntryBucket.due_datetime' and its values cannot be restored.")
        # Deleting field 'LabEntry.lab_clinic_api_panel'
        db.delete_column('bhp_lab_entry_labentry', 'lab_clinic_api_panel_id')

        # Deleting field 'LabEntryUnscheduled.lab_clinic_api_panel'
        db.delete_column('bhp_lab_entry_labentryunscheduled', 'lab_clinic_api_panel_id')
