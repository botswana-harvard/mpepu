...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdditionalLabEntryBucket.appointment'
        db.add_column('bhp_lab_entry_additionallabentrybucket', 'appointment', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.date(2011, 9, 27), related_name='+', to=orm['bhp_appointment.Appointment']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdditionalLabEntryBucket.appointment'
        db.delete_column('bhp_lab_entry_additionallabentrybucket', 'appointment_id')
