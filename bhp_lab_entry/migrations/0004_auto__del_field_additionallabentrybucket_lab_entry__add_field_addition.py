...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AdditionalLabEntryBucket.lab_entry'
        db.delete_column('bhp_lab_entry_additionallabentrybucket', 'lab_entry_id')

        # Adding field 'AdditionalLabEntryBucket.lab_entry_unscheduled'
        db.add_column('bhp_lab_entry_additionallabentrybucket', 'lab_entry_unscheduled', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_entry.LabEntryUnscheduled']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AdditionalLabEntryBucket.lab_entry'
        raise RuntimeError("Cannot reverse this migration. 'AdditionalLabEntryBucket.lab_entry' and its values cannot be restored.")

        # Deleting field 'AdditionalLabEntryBucket.lab_entry_unscheduled'
        db.delete_column('bhp_lab_entry_additionallabentrybucket', 'lab_entry_unscheduled_id')
    ...
    models = {
        ...
        'bhp_lab_entry.additionallabentrybucket': {
            'Meta': {'ordering': "['registered_subject', 'lab_entry_unscheduled__panel__name']", 'object_name': 'AdditionalLabEntryBucket'},
