# -*- coding: utf-8 -*-
#
# lab_tracker documentation build configuration file, created by
...
htmlhelp_basename = 'lab_trackerdoc'
...
latex_documents = [
  ('index', 'lab_tracker.tex', u'lab\\_tracker Documentation',
...
man_pages = [
    ('index', 'lab_tracker', u'lab_tracker Documentation',
...
texinfo_documents = [
  ('index', 'lab_tracker', u'lab_tracker Documentation',
   u'erik van widenfelt', 'lab_tracker', 'One line description of project.',
   'Miscellaneous'),
]
