...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('lab_result', ['ResultSource'])
        ...
        db.create_table('bhp_lab_core_result', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_order.Order'])),
        ...
        db.send_create_signal('lab_result', ['Result'])
    ...
    models = {
        ...
        'lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 30, 13, 11, 1, 152166)'}),
        ...
        'lab_receive.receive': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_research_protocol.Protocol']"}),
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 30, 13, 11, 1, 146401)', 'db_index': 'True'}),
