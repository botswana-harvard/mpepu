# -*- coding: utf-8 -*-
#
# mpepu_infant documentation build configuration file, created by
...
htmlhelp_basename = 'mpepu_infantdoc'
...
latex_documents = [
  ('index', 'mpepu_infant.tex', u'mpepu\\_infant Documentation',
...
man_pages = [
    ('index', 'mpepu_infant', u'mpepu_infant Documentation',
...
texinfo_documents = [
  ('index', 'mpepu_infant', u'mpepu_infant Documentation',
   u'erik van widenfelt', 'mpepu_infant', 'One line description of project.',
   'Miscellaneous'),
]
