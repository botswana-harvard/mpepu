...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestSubjectConsent.user_provided_subject_identifier'
        db.add_column('bhp_consent_testsubjectconsent', 'user_provided_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestSubjectConsent.user_provided_subject_identifier'
        db.delete_column('bhp_consent_testsubjectconsent', 'user_provided_subject_identifier')
