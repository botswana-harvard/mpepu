...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PackingList.timestamp'
        db.alter_column('mpepu_lab_packinglist', 'timestamp', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))


    def backwards(self, orm):
        
        # Changing field 'PackingList.timestamp'
        db.alter_column('mpepu_lab_packinglist', 'timestamp', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'bhp_registration.registeredsubject': {
            ...
            'salt': ('django.db.models.fields.CharField', [], {'default': "'wPYOpIXKt8O1'", 'max_length': '25'}),
        ...
        'mpepu_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 16, 34, 30, 303509)'}),
