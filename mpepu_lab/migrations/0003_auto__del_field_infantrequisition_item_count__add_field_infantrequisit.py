...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfantRequisition.item_count'
        db.delete_column('mpepu_lab_infantrequisition', 'item_count')

        # Adding field 'InfantRequisition.item_count_total'
        db.add_column('mpepu_lab_infantrequisition', 'item_count_total', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'InfantRequisitionAudit.item_count'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'item_count')

        # Adding field 'InfantRequisitionAudit.item_count_total'
        db.add_column('mpepu_lab_infantrequisition_audit', 'item_count_total', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'MaternalRequisition.item_count'
        db.delete_column('mpepu_lab_maternalrequisition', 'item_count')

        # Adding field 'MaternalRequisition.item_count_total'
        db.add_column('mpepu_lab_maternalrequisition', 'item_count_total', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'MaternalRequisitionAudit.item_count'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'item_count')

        # Adding field 'MaternalRequisitionAudit.item_count_total'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'item_count_total', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'InfantRequisition.item_count'
        db.add_column('mpepu_lab_infantrequisition', 'item_count', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'InfantRequisition.item_count_total'
        db.delete_column('mpepu_lab_infantrequisition', 'item_count_total')

        # Adding field 'InfantRequisitionAudit.item_count'
        db.add_column('mpepu_lab_infantrequisition_audit', 'item_count', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'InfantRequisitionAudit.item_count_total'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'item_count_total')

        # Adding field 'MaternalRequisition.item_count'
        db.add_column('mpepu_lab_maternalrequisition', 'item_count', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'MaternalRequisition.item_count_total'
        db.delete_column('mpepu_lab_maternalrequisition', 'item_count_total')

        # Adding field 'MaternalRequisitionAudit.item_count'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'item_count', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'MaternalRequisitionAudit.item_count_total'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'item_count_total')
