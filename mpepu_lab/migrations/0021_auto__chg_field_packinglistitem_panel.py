...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mpepu_lab_packinglistitem', 'panel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_clinic_api.Panel'], null=True))

    def backwards(self, orm):

        # Changing field 'PackingListItem.panel'
        db.alter_column('mpepu_lab_packinglistitem', 'panel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lab_panel.Panel'], null=True))
