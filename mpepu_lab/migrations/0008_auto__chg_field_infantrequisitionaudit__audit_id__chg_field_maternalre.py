...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfantRequisitionAudit._audit_id'
        db.alter_column('mpepu_lab_infantrequisition_audit', '_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))

        # Changing field 'MaternalRequisitionAudit._audit_id'
        db.alter_column('mpepu_lab_maternalrequisition_audit', '_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'InfantRequisitionAudit._audit_id'
        db.alter_column('mpepu_lab_infantrequisition_audit', '_audit_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'MaternalRequisitionAudit._audit_id'
        db.alter_column('mpepu_lab_maternalrequisition_audit', '_audit_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
    ...
    models = {
        ...
        'lab_packing.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 15, 9, 49, 42, 559683)'}),
