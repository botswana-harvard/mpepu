...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfantRequisition.aliquot_type'
        db.add_column('mpepu_lab_infantrequisition', 'aliquot_type', self.gf('django.db.models.fields.related.ForeignKey')(default=9, to=orm['lab_aliquot_list.AliquotType']), keep_default=False)

        # Deleting field 'InfantRequisitionAudit.sample_type'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'sample_type_id')

        # Adding field 'InfantRequisitionAudit.aliquot_type'
        db.add_column('mpepu_lab_infantrequisition_audit', 'aliquot_type', self.gf('django.db.models.fields.related.ForeignKey')(default=9, related_name='_audit_infantrequisition', to=orm['lab_aliquot_list.AliquotType']), keep_default=False)

        # Deleting field 'MaternalRequisition.sample_type'
        db.delete_column('mpepu_lab_maternalrequisition', 'sample_type_id')

        # Adding field 'MaternalRequisition.aliquot_type'
        db.add_column('mpepu_lab_maternalrequisition', 'aliquot_type', self.gf('django.db.models.fields.related.ForeignKey')(default=9, to=orm['lab_aliquot_list.AliquotType']), keep_default=False)

        # Deleting field 'MaternalRequisitionAudit.sample_type'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'sample_type_id')

        # Adding field 'MaternalRequisitionAudit.aliquot_type'
        db.add_column('mpepu_lab_maternalrequisition_audit', 'aliquot_type', self.gf('django.db.models.fields.related.ForeignKey')(default=9, related_name='_audit_maternalrequisition', to=orm['lab_aliquot_list.AliquotType']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InfantRequisition.sample_type'
        raise RuntimeError("Cannot reverse this migration. 'InfantRequisition.sample_type' and its values cannot be restored.")

        # Deleting field 'InfantRequisition.aliquot_type'
        db.delete_column('mpepu_lab_infantrequisition', 'aliquot_type_id')

        # User chose to not deal with backwards NULL issues for 'InfantRequisitionAudit.sample_type'
        raise RuntimeError("Cannot reverse this migration. 'InfantRequisitionAudit.sample_type' and its values cannot be restored.")

        # Deleting field 'InfantRequisitionAudit.aliquot_type'
        db.delete_column('mpepu_lab_infantrequisition_audit', 'aliquot_type_id')

        # User chose to not deal with backwards NULL issues for 'MaternalRequisition.sample_type'
        raise RuntimeError("Cannot reverse this migration. 'MaternalRequisition.sample_type' and its values cannot be restored.")

        # Deleting field 'MaternalRequisition.aliquot_type'
        db.delete_column('mpepu_lab_maternalrequisition', 'aliquot_type_id')

        # User chose to not deal with backwards NULL issues for 'MaternalRequisitionAudit.sample_type'
        raise RuntimeError("Cannot reverse this migration. 'MaternalRequisitionAudit.sample_type' and its values cannot be restored.")

        # Deleting field 'MaternalRequisitionAudit.aliquot_type'
        db.delete_column('mpepu_lab_maternalrequisition_audit', 'aliquot_type_id')
