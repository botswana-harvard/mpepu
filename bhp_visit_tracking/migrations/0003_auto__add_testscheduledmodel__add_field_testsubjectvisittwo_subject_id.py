...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestSubjectVisitTwo.subject_identifier'
        db.add_column('bhp_visit_tracking_testsubjectvisittwo', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50),
                      keep_default=False)

        # Adding field 'TestSubjectVisit.subject_identifier'
        db.add_column('bhp_visit_tracking_testsubjectvisit', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50),
                      keep_default=False)

        # Adding field 'TestSubjectVisitThree.subject_identifier'
        db.add_column('bhp_visit_tracking_testsubjectvisitthree', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TestSubjectVisitTwo.subject_identifier'
        db.delete_column('bhp_visit_tracking_testsubjectvisittwo', 'subject_identifier')

        # Deleting field 'TestSubjectVisit.subject_identifier'
        db.delete_column('bhp_visit_tracking_testsubjectvisit', 'subject_identifier')

        # Deleting field 'TestSubjectVisitThree.subject_identifier'
        db.delete_column('bhp_visit_tracking_testsubjectvisitthree', 'subject_identifier')
    ...
    models = {
        ...
        'bhp_visit_tracking.testscheduledmodel': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'test_subject_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bhp_visit_tracking.TestSubjectVisit']", 'unique': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
