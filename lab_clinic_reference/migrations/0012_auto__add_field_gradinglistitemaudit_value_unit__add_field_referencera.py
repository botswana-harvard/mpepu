...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GradingListItemAudit.value_unit'
        db.add_column('lab_clinic_reference_gradinglistitem_audit', 'value_unit',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'ReferenceRangeListItem.value_unit'
        db.add_column('lab_clinic_reference_referencerangelistitem', 'value_unit',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'ReferenceRangeListItemAudit.value_unit'
        db.add_column('lab_clinic_reference_referencerangelistitem_audit', 'value_unit',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'GradingListItem.value_unit'
        db.add_column('lab_clinic_reference_gradinglistitem', 'value_unit',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GradingListItemAudit.value_unit'
        db.delete_column('lab_clinic_reference_gradinglistitem_audit', 'value_unit')

        # Deleting field 'ReferenceRangeListItem.value_unit'
        db.delete_column('lab_clinic_reference_referencerangelistitem', 'value_unit')

        # Deleting field 'ReferenceRangeListItemAudit.value_unit'
        db.delete_column('lab_clinic_reference_referencerangelistitem_audit', 'value_unit')

        # Deleting field 'GradingListItem.value_unit'
        db.delete_column('lab_clinic_reference_gradinglistitem', 'value_unit')
