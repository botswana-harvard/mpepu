...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceRangeListItemAudit.scale'
        db.add_column('lab_clinic_reference_referencerangelistitem_audit', 'scale',
                      self.gf('django.db.models.fields.CharField')(default='increasing', max_length=25),
                      keep_default=False)

        # Adding field 'ReferenceRangeListItem.scale'
        db.add_column('lab_clinic_reference_referencerangelistitem', 'scale',
                      self.gf('django.db.models.fields.CharField')(default='increasing', max_length=25),
                      keep_default=False)

        # Adding field 'GradingListItem.scale'
        db.add_column('lab_clinic_reference_gradinglistitem', 'scale',
                      self.gf('django.db.models.fields.CharField')(default='increasing', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferenceRangeListItemAudit.scale'
        db.delete_column('lab_clinic_reference_referencerangelistitem_audit', 'scale')

        # Deleting field 'ReferenceRangeListItem.scale'
        db.delete_column('lab_clinic_reference_referencerangelistitem', 'scale')

        # Deleting field 'GradingListItem.scale'
        db.delete_column('lab_clinic_reference_gradinglistitem', 'scale')
