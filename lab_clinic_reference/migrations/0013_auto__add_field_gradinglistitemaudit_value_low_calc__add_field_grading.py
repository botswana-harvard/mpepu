...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GradingListItemAudit.value_low_calc'
        db.add_column('lab_clinic_reference_gradinglistitem_audit', 'value_low_calc',
                      self.gf('django.db.models.fields.CharField')(default='ABSOLUTE', max_length=10),
                      keep_default=False)

        # Adding field 'GradingListItemAudit.value_high_calc'
        db.add_column('lab_clinic_reference_gradinglistitem_audit', 'value_high_calc',
                      self.gf('django.db.models.fields.CharField')(default='ABSOLUTE', max_length=10),
                      keep_default=False)

        # Adding field 'GradingListItem.value_low_calc'
        db.add_column('lab_clinic_reference_gradinglistitem', 'value_low_calc',
                      self.gf('django.db.models.fields.CharField')(default='ABSOLUTE', max_length=10),
                      keep_default=False)

        # Adding field 'GradingListItem.value_high_calc'
        db.add_column('lab_clinic_reference_gradinglistitem', 'value_high_calc',
                      self.gf('django.db.models.fields.CharField')(default='ABSOLUTE', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GradingListItemAudit.value_low_calc'
        db.delete_column('lab_clinic_reference_gradinglistitem_audit', 'value_low_calc')

        # Deleting field 'GradingListItemAudit.value_high_calc'
        db.delete_column('lab_clinic_reference_gradinglistitem_audit', 'value_high_calc')

        # Deleting field 'GradingListItem.value_low_calc'
        db.delete_column('lab_clinic_reference_gradinglistitem', 'value_low_calc')

        # Deleting field 'GradingListItem.value_high_calc'
        db.delete_column('lab_clinic_reference_gradinglistitem', 'value_high_calc')
