...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceRangeListItemAudit.import_datetime'
        db.add_column('lab_clinic_reference_referencerangelistitem_audit', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ReferenceRangeListItem.import_datetime'
        db.add_column('lab_clinic_reference_referencerangelistitem', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'GradingListItem.import_datetime'
        db.add_column('lab_clinic_reference_gradinglistitem', 'import_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferenceRangeListItemAudit.import_datetime'
        db.delete_column('lab_clinic_reference_referencerangelistitem_audit', 'import_datetime')

        # Deleting field 'ReferenceRangeListItem.import_datetime'
        db.delete_column('lab_clinic_reference_referencerangelistitem', 'import_datetime')

        # Deleting field 'GradingListItem.import_datetime'
        db.delete_column('lab_clinic_reference_gradinglistitem', 'import_datetime')
