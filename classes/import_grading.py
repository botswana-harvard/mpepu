...
from lab_grading.models import GradingList as LisGradingList, GradingListItem as LisGradingListItem
from lab_clinic_reference.models import GradingList, GradingListItem
