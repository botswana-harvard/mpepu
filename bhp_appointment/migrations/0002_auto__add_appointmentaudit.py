...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_form_appointment_audit', (
            ...
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_+', to=orm['bhp_registration.RegisteredSubject'])),
            ('visit_definition', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_+', to=orm['bhp_visit.VisitDefinition'])),
            ('visit_instance', self.gf('django.db.models.fields.CharField')(default='0', max_length=1, null=True, blank=True)),
        ...
        db.send_create_signal('bhp_appointment', ['AppointmentAudit'])


    def backwards(self, orm):
        
        # Deleting model 'AppointmentAudit'
        db.delete_table('bhp_form_appointment_audit')
