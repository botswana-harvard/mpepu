...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppointmentAudit.timepoint_datetime'
        db.add_column('bhp_form_appointment_audit', 'timepoint_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding index on 'AppointmentAudit', fields ['hostname_created']
        db.create_index('bhp_form_appointment_audit', ['hostname_created'])

        # Adding index on 'AppointmentAudit', fields ['hostname_modified']
        db.create_index('bhp_form_appointment_audit', ['hostname_modified'])

        # Adding index on 'Holiday', fields ['hostname_created']
        db.create_index('bhp_appointment_holiday', ['hostname_created'])

        # Adding index on 'Holiday', fields ['hostname_modified']
        db.create_index('bhp_appointment_holiday', ['hostname_modified'])

        # Adding field 'Appointment.timepoint_datetime'
        db.add_column('bhp_form_appointment', 'timepoint_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding index on 'Appointment', fields ['hostname_created']
        db.create_index('bhp_form_appointment', ['hostname_created'])

        # Adding index on 'Appointment', fields ['hostname_modified']
        db.create_index('bhp_form_appointment', ['hostname_modified'])

        # Adding index on 'Configuration', fields ['hostname_created']
        db.create_index('bhp_appointment_configuration', ['hostname_created'])

        # Adding index on 'Configuration', fields ['hostname_modified']
        db.create_index('bhp_appointment_configuration', ['hostname_modified'])


    def backwards(self, orm):
        
        # Removing index on 'Configuration', fields ['hostname_modified']
        db.delete_index('bhp_appointment_configuration', ['hostname_modified'])

        # Removing index on 'Configuration', fields ['hostname_created']
        db.delete_index('bhp_appointment_configuration', ['hostname_created'])

        # Removing index on 'Appointment', fields ['hostname_modified']
        db.delete_index('bhp_form_appointment', ['hostname_modified'])

        # Removing index on 'Appointment', fields ['hostname_created']
        db.delete_index('bhp_form_appointment', ['hostname_created'])

        # Removing index on 'Holiday', fields ['hostname_modified']
        db.delete_index('bhp_appointment_holiday', ['hostname_modified'])

        # Removing index on 'Holiday', fields ['hostname_created']
        db.delete_index('bhp_appointment_holiday', ['hostname_created'])

        # Removing index on 'AppointmentAudit', fields ['hostname_modified']
        db.delete_index('bhp_form_appointment_audit', ['hostname_modified'])

        # Removing index on 'AppointmentAudit', fields ['hostname_created']
        db.delete_index('bhp_form_appointment_audit', ['hostname_created'])

        # Deleting field 'AppointmentAudit.timepoint_datetime'
        db.delete_column('bhp_form_appointment_audit', 'timepoint_datetime')

        # Deleting field 'Appointment.timepoint_datetime'
        db.delete_column('bhp_form_appointment', 'timepoint_datetime')
    ...
    models = {
        ...
        'bhp_appointment.appointmentaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'AppointmentAudit', 'db_table': "'bhp_form_appointment_audit'"},
