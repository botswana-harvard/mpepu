...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppointmentAudit.dashboard_type'
        db.add_column('bhp_form_appointment_audit', 'dashboard_type', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'Appointment.dashboard_type'
        db.add_column('bhp_form_appointment', 'dashboard_type', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AppointmentAudit.dashboard_type'
        db.delete_column('bhp_form_appointment_audit', 'dashboard_type')

        # Deleting field 'Appointment.dashboard_type'
        db.delete_column('bhp_form_appointment', 'dashboard_type')
