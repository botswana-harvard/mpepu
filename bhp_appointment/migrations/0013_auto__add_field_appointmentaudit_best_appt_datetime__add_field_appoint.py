...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppointmentAudit.best_appt_datetime'
        db.add_column('bhp_appointment_appointment_audit', 'best_appt_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding index on 'AppointmentAudit', fields ['visit_instance']
        db.create_index('bhp_appointment_appointment_audit', ['visit_instance'])

        # Adding index on 'AppointmentAudit', fields ['appt_datetime']
        db.create_index('bhp_appointment_appointment_audit', ['appt_datetime'])

        # Adding index on 'AppointmentAudit', fields ['dashboard_type']
        db.create_index('bhp_appointment_appointment_audit', ['dashboard_type'])

        # Adding index on 'AppointmentAudit', fields ['appt_status']
        db.create_index('bhp_appointment_appointment_audit', ['appt_status'])

        # Adding field 'Appointment.best_appt_datetime'
        db.add_column('bhp_appointment_appointment', 'best_appt_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding index on 'Appointment', fields ['visit_instance']
        db.create_index('bhp_appointment_appointment', ['visit_instance'])

        # Adding index on 'Appointment', fields ['appt_datetime']
        db.create_index('bhp_appointment_appointment', ['appt_datetime'])

        # Adding index on 'Appointment', fields ['dashboard_type']
        db.create_index('bhp_appointment_appointment', ['dashboard_type'])

        # Adding index on 'Appointment', fields ['appt_status']
        db.create_index('bhp_appointment_appointment', ['appt_status'])

        print 'When done, update new field best_appt_datetime with value from appt_datetime.'
        print 'SQL : update bhp_appointment_appointment set best_appt_datetime=appt_datetime where best_appt_datetime is null;'

    def backwards(self, orm):
        # Removing index on 'Appointment', fields ['appt_status']
        db.delete_index('bhp_appointment_appointment', ['appt_status'])

        # Removing index on 'Appointment', fields ['dashboard_type']
        db.delete_index('bhp_appointment_appointment', ['dashboard_type'])

        # Removing index on 'Appointment', fields ['appt_datetime']
        db.delete_index('bhp_appointment_appointment', ['appt_datetime'])

        # Removing index on 'Appointment', fields ['visit_instance']
        db.delete_index('bhp_appointment_appointment', ['visit_instance'])

        # Removing index on 'AppointmentAudit', fields ['appt_status']
        db.delete_index('bhp_appointment_appointment_audit', ['appt_status'])

        # Removing index on 'AppointmentAudit', fields ['dashboard_type']
        db.delete_index('bhp_appointment_appointment_audit', ['dashboard_type'])

        # Removing index on 'AppointmentAudit', fields ['appt_datetime']
        db.delete_index('bhp_appointment_appointment_audit', ['appt_datetime'])

        # Removing index on 'AppointmentAudit', fields ['visit_instance']
        db.delete_index('bhp_appointment_appointment_audit', ['visit_instance'])

        # Deleting field 'AppointmentAudit.best_appt_datetime'
        db.delete_column('bhp_appointment_appointment_audit', 'best_appt_datetime')

        # Deleting field 'Appointment.best_appt_datetime'
        db.delete_column('bhp_appointment_appointment', 'best_appt_datetime')
