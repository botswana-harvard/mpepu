...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppointmentAudit.appt_type'
        db.add_column('bhp_appointment_appointment_audit', 'appt_type',
                      self.gf('django.db.models.fields.CharField')(default='clinic', max_length=20),
                      keep_default=False)

        # Adding field 'Appointment.appt_type'
        db.add_column('bhp_appointment_appointment', 'appt_type',
                      self.gf('django.db.models.fields.CharField')(default='clinic', max_length=20),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AppointmentAudit.appt_type'
        db.delete_column('bhp_appointment_appointment_audit', 'appt_type')

        # Deleting field 'Appointment.appt_type'
        db.delete_column('bhp_appointment_appointment', 'appt_type')
    ...
    models = {
        ...
        'bhp_appointment.contactlogitem': {
