...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Configuration.use_same_weekday'
        db.alter_column('bhp_appointment_configuration', 'use_same_weekday', self.gf('django.db.models.fields.BooleanField')(max_length=3))


    def backwards(self, orm):
        
        # Changing field 'Configuration.use_same_weekday'
        db.alter_column('bhp_appointment_configuration', 'use_same_weekday', self.gf('django.db.models.fields.CharField')(max_length=3))
