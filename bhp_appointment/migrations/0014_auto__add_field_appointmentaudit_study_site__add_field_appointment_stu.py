...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppointmentAudit.study_site'
        db.add_column('bhp_appointment_appointment_audit', 'study_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_appointment', null=True, to=orm['bhp_variables.StudySite']),
                      keep_default=False)

        # Adding field 'Appointment.study_site'
        db.add_column('bhp_appointment_appointment', 'study_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_variables.StudySite'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppointmentAudit.study_site'
        db.delete_column('bhp_appointment_appointment_audit', 'study_site_id')

        # Deleting field 'Appointment.study_site'
        db.delete_column('bhp_appointment_appointment', 'study_site_id')
