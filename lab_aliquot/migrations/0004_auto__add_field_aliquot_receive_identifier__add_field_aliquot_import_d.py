...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bhp_lab_core_aliquot', 'receive_identifier',
        ...
        db.add_column('bhp_lab_core_aliquot', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bhp_lab_core_aliquot', 'receive_identifier')
        ...
        db.delete_column('bhp_lab_core_aliquot', 'subject_identifier')
