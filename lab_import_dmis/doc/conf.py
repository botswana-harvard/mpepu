# -*- coding: utf-8 -*-
#
# lab_import_dmis documentation build configuration file, created by
...
htmlhelp_basename = 'lab_import_dmisdoc'
...
latex_documents = [
  ('index', 'lab_import_dmis.tex', u'lab\\_import_dmis Documentation',
...
man_pages = [
    ('index', 'lab_import_dmis', u'lab_import_dmis Documentation',
...
texinfo_documents = [
  ('index', 'lab_import_dmis', u'lab_import_dmis Documentation',
   u'erik van widenfelt', 'lab_import_dmis', 'One line description of project.',
   'Miscellaneous'),
]
